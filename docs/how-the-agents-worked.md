...
why `tools/scope.py` exists to state what a verdict actually *covered*, and why the step audit
reports coverage gaps rather than quietly counting them as passes.
