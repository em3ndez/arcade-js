...
-- Grounding write-tap: record every write into work RAM (0x2000-0x23ff) with the writing PC, so a cell's
...
prog:install_write_tap(0x2000, 0x23ff, "groundw", function(offset, data, mask)
