 ...
 *
 * ROLE IN THE MACHINE
 *   The destination loc_20c2 (0x20c2) is the base of the animation state block: stepAnimationFrame
...
export function loadDrawSequenceBlock(m, de = m.regs.de) {
  // Copy 0x0c (12) bytes from the caller's source (DE) into the animation work slot at loc_20c2.
