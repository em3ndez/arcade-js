 ...
 *
 * WHAT IT IS
 *   When fewer than nine aliens remain, it stamps 0xfb into loc_207e (0x207e), the per-frame vertical
 ...
 *   (0x2082) — the live-alien tally countLiveAliens publishes each frame. loc_207e is the alien shot's
 ...
 *
 * LIVE-OUT: memory only, and only on the taken branch (loc_207e := 0xfb).
 */
