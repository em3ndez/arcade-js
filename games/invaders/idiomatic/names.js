...
export const ROUTINES = {
  ...
  0x1931: { name: "loc_1931", role: "shared score-record draw: unpack a four-byte record at HL (a BCD value word then its two-byte screen address) and draw the value as four BCD glyphs there (tail drawBcdWord); reached for P1 (0x20f8), P2 (0x20fc) and the high score (0x20f4)", cert: "code" },
  ...
  0x1979: { name: "loc_1979", role: "boot credit readout: clearGameActive, drawCreditCount (repaint the BCD credit tally), then drawCreditLabel (tail); memory-only live-out", cert: "code" },
