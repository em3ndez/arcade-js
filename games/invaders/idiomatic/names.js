...
export const PLAYER_SHOT_RECORD_TEMPLATE = 0x1b25;
...
export const INVADER_SCORE_TABLE = 0x1da0;
export const loc_2004 = 0x2004;
export const ALIEN_MARCH_FRAME_TOGGLE = 0x2005;
...
export const PLAYER_SHOT_RETIRE_TIMER = 0x2026;
export const loc_2029 = 0x2029;
export const loc_202a = 0x202a;
export const PLAYER_SHOT_ROW_COUNT = 0x202b;
export const PLAYER_SHOT_Y_STEP = 0x202c;
...
export const EXTRA_SHIP_AWARD_FLAG = 0x20e5;
...
export const SAUCER_RECORD_TEMPLATE = 0x1b83;
export const ALIEN_SHOT_RATE_THRESHOLDS = 0x1cb8;  // [seen]
export const SHIELD_TEMPLATE = 0x1d20;
export const SPRITE_BITMAP_TABLE = 0x1e00;
...
export const PLAYER_SHIP_X = 0x201b;
export const DEMO_SHIP_DIR = 0x201d;
...
export const ALIEN_EXPLOSION_SPRITE_DESC = 0x2062;
export const FLEET_MARCH_ENABLE = 0x2068;
export const SHIP_READY_FLAG = 0x2069;
export const LAST_ALIEN_FLAG = 0x206b;  // [seen]
export const ALIEN_SHOT_RATE_GATE0 = 0x2070;
export const ALIEN_SHOT_RATE_GATE_1 = 0x2071;
export const OBJECT_WORK_BUFFER = 0x2073;
export const loc_2074 = 0x2074;
export const loc_2075 = 0x2075;
export const ALIEN_SHOT_COLUMN_CURSOR = 0x2076;
export const ALIEN_SHOT_SPRITE_FRAME_CEILING = 0x207f;
...
export const ANIM_FRAME_COUNTER = 0x20c2;
...
export const ATTRACT_OBJECT_TABLE = 0x2050;               // anim descriptor scratch (runHandshakedAttractAnim blockCopy dst)
export const loc_2080 = 0x2080;               // runHandshakedAttractAnim seeds =2 (role ungrounded)
export const PLAYER1_SHIP_COUNT = 0x21ff;               // starting-ships latch (runAttractCycle)
...
export const TILT_BANNER_TEXT = 0x1cbc;               // tilt banner sprite-id source (typed by the tilt reset)
export const TILT_BANNER_VRAM = 0x3016;               // tilt banner screen destination
...
// ROM/screen address literals passed as draw/script args by the spine (a couple stay loc_, see names-debt.txt):
export const ATTRACT_HEADING_SCREEN_ADDR = 0x3017;
export const ATTRACT_SCREEN0_HEADING_SRC = 0x1cfa;
export const SPACE_INVADERS_TITLE_TEXT = 0x1daf;
export const ATTRACT_PLAY_HEADING_TEXT = 0x1dab;
export const ATTRACT_BODY_SCREEN_ADDR = 0x2b14;
export const ATTRACT_REVEAL_BLOCK_1 = 0x1a95;
export const loc_1bb0 = 0x1bb0;
export const loc_1fc9 = 0x1fc9;
export const ATTRACT_REVEAL_CLEAR_SCREEN_ADDR = 0x33b7;
export const SHARED_TEXT_VRAM_DEST = 0x2810;
export const SCORE_ADVANCE_TABLE_HEADER = 0x1ca3;
export const SCORE_ADVANCE_DRAW_SCRIPT = 0x1dbe;
export const loc_1dcf = 0x1dcf;
export const ATTRACT_ANIM_OBJ_TEMPLATE = 0x1bc0;
export const loc_3311 = 0x3311;
export const INSERT_COIN_SCREEN_ADDR = 0x2c11;
export const INSERT_COIN_TEXT = 0x1f90;
export const ATTRACT_INFO_DRAW_RECORD = 0x1f9c;
export const ATTRACT_EXTRA_DRAW_SCRIPT = 0x1fa0;
export const ATTRACT_REVEAL_ANIM_SEQ = 0x1fd5;
...
export const CREDIT_PUSH_PROMPT_TEXT = 0x1ff3;               // credit-screen top prompt sprite-id source
export const CREDIT_PROMPT_SCREEN_ADDR = 0x3013;               // credit-screen top prompt screen destination
export const ONE_PLAYER_PROMPT_TEXT = 0x1acf;               // one-player start prompt sprite-id source
export const TWO_PLAYER_PROMPT_TEXT = 0x1aba;               // two-player start prompt sprite-id source
export const loc_21fc = 0x21fc;               // player-1 object-record coordinate word (seeded at game start)
export const PLAYER1_ROUND_COUNTER = 0x21fe;               // player-1 object-record byte cleared at game start
export const PLAYER2_FLEET_REF_COORD = 0x22fc;               // player-2 object-record coordinate word (seeded at game start)
export const loc_22fe = 0x22fe;               // player-2 object-record byte cleared at game start
export const PLAYER2_SHIPS = 0x22ff;               // player-2 starting-ships latch (player-1 mirror PLAYER1_SHIP_COUNT)
...
export const PLAYER_SHIP_HANDLER_ADDR = 0x028e;       // [seen] record-0 player-ship handler (playerShipHandler): moves the ship X by input (PLAYER_SHIP_X), runs the ship's death/explosion animation, and on drain during play consumes a life + arms the next main-loop flow
...
export const ALIEN_SHOT_SLOT2_TEMPLATE = 0x1b30;
export const loc_1b32 = 0x1b32;
export const ALIEN_SHOT_SLOT3_TEMPLATE = 0x1b40;
export const ALIEN_SHOT_COLUMN_CURSOR_RESET = 0x1b48;
export const ALIEN_SHOT_RECORD_TEMPLATE = 0x1b50;
export const loc_1b58 = 0x1b58;
export const ALIEN_SHOT_SLOT2_RECORD = 0x2030;
export const loc_2032 = 0x2032;
export const loc_2035 = 0x2035;
export const loc_2036 = 0x2036;
export const ALIEN_SHOT2_STEP_GATE = 0x2038;
export const ALIEN_SHOT_SLOT3_RECORD = 0x2040;
export const ALIEN_SHOT_SLOT3_DESC = 0x2045;
export const loc_2046 = 0x2046;
export const loc_2056 = 0x2056;
export const ALIEN_SHOT4_COLUMN_CURSOR = 0x2058;
export const ALIEN_SHOT_SLOT3_DISABLE_FLAG = 0x206e;
export const loc_2086 = 0x2086;
export const loc_208a = 0x208a;
export const SAUCER_STEP_DX = 0x208c;
export const SAUCER_DIR_SEQ_PTR = 0x208f;
...
export const PLAYER_SHIP_DRAW_PENDING = 0x2012;               // record-0 draw-pending flag, cleared after each redraw
export const PLAYER_SHIP_SPRITE_DESC = 0x2018;               // record-0 current animation sprite descriptor (5 bytes)
export const PLAYER_SHIP_COORD_LO = 0x201a;               // record-0 animation coordinate word (low of the descriptor)
export const loc_206a = 0x206a;               // record-0 animation cursor countdown
export const WARM_RESTART_SUPPRESS = 0x206d;               // record-0 warm-restart suppress flag
export const PLAYER_SHIP_RECORD_TEMPLATE = 0x1b10;               // ROM template restored into record 0 on animation expiry
export const PLAYER_SHIP_EXPLOSION_SPRITE = 0x1c70;               // record-0 two-frame animation sprite base
...
export const ROUND_START_BANNER_TEXT = 0x1b70;               // round-start sprite-id source strip
export const ROUND_START_SPLASH_VRAM = 0x2b11;               // round-start sprite-list screen destination
export const ROUND_START_EXTRA_SPRITE_VRAM = 0x3711;               // round-start extra-sprite screen destination
export const PLAYER1_SCORE_STRIP_VRAM = 0x271c;               // round-start strip-clear screen base (player-1 select)
export const GAME_OVER_TEXT = 0x1aa6;               // typed game-over / new-round text source
export const GAME_OVER_BANNER_SCREEN_ADDR = 0x2803;               // two-player game-over text screen destination
export const GAMEOVER_PLAYER_NUM_SCREEN_ADDR = 0x3a03;               // two-player game-over player-number glyph screen slot
export const GAME_OVER_TEXT_VRAM_ADDR = 0x2d18;               // game-over field-clear text screen destination
export const ROUND_FLEET_START_TABLE = 0x1da2;               // player-index-to-field-page lookup table
export const ROUTINES = {
  ...
  0x0acf: { name: "typeAttractBlock", role: "[seen] type the 0x0f-byte block to ATTRACT_BODY_SCREEN_ADDR using the caller's source de -> typePacedSpriteRun", cert: "seen" },
  ...
  0x1815: { name: "drawScoreAdvanceTable", role: "[seen] draw the attract score-advance table: header string + SCORE_ADVANCE_DRAW_SCRIPT column script (no delay), then tail typeSecondDrawScript (typed loc_1dcf script)", cert: "seen" },
  ...
  0x0100: { name: "drawPendingAlien", role: "draw the pending marching alien: bail to tickAlienExplosionDespawn when PLAYER_SHOT_HIT is set; else if the alien at (ACTIVE_PLAYER_PAGE:ALIEN_DRAW_INDEX) is live, build its sprite from ALIEN_SPRITE_TABLE (id bit0-cleared, rotate-left-3; +0x30 alternate frame via selectAlternateSpriteFrame when ALIEN_MARCH_FRAME_TOGGLE is set) and blitShiftedSprite 16 rows at ALIEN_DRAW_ADDR; clears ALIEN_DRAW_PENDING on every non-bail path", cert: "seen" },
  ...
  0x01f8: { name: "initShieldBuffers", role: "replicate the 0x2c-byte shield template SHIELD_TEMPLATE into four consecutive shield buffers from HL; live-out HL", cert: "seen" },
  ...
  0x0550: { name: "copyRecordToWorkBuffer", role: "stash A -> ALIEN_SHOT_SPRITE_FRAME_CEILING, then blockCopy 0x0b bytes (DE)->work buffer OBJECT_WORK_BUFFER (prime an object strip)", cert: "seen" },
  0x055b: { name: "copyWorkBufferToRecord", role: "blockCopy 0x0b bytes work buffer OBJECT_WORK_BUFFER ->(HL) (restore the object strip; twin of copyRecordToWorkBuffer)", cert: "seen" },
  ...
  0x075f: { name: "copyTemplateToRecord", role: "blockCopy B bytes from ROM template SAUCER_RECORD_TEMPLATE into the caller's object record (HL)", cert: "seen" },
  ...
  0x08ff: { name: "drawSprite8x8", role: "resolve sprite id A to its 8-byte source at SPRITE_BITMAP_TABLE+8*A, latch A to port 6, blit an 8x8 sprite via drawSpriteColumn; live-out HL", cert: "seen" },
  ...
  0x0ae2: { name: "loadDrawSequenceBlock", role: "blockCopy the 12-byte draw/animation sequence from (DE) into ANIM_FRAME_COUNTER", cert: "seen" },
  ...
  0x170e: { name: "selectAlienShotRate", role: "select the alien-shot rate: scan ALIEN_SHOT_RATE_THRESHOLDS for the first entry >= the active player's score key, store the parallel ALIEN_SHOT_RATE_TABLE byte to loc_20cf (read by the shot stepper stepAlienShot)", cert: "seen" },
  ...
  0x08d8: { name: "setAlienShotStepWhenFew", role: "if ALIEN_COUNT < 9: ALIEN_SHOT_STEP = 0xfb", cert: "seen" },
  ...
  0x097c: { name: "invaderScoreEntryPtr", role: "HL = INVADER_SCORE_TABLE + clamp-index of A (offset 0 if A<2, 1 if 2<=A<4, 2 if A>=4)", cert: "seen" },
