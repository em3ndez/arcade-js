...
export const TIMER_RELOAD = 0x0600;
export const loc_1da0 = 0x1da0;
export const loc_2009 = 0x2009;
export const loc_200a = 0x200a;
export const loc_2048 = 0x2048;
export const ACTIVE_PLAYER_PAGE = 0x2067;
export const loc_207e = 0x207e;
export const ALIEN_COUNT = 0x2082;
export const loc_2083 = 0x2083;
export const loc_2091 = 0x2091;
export const SOUND_PORT3_SHADOW = 0x2094;
export const SOUND_PORT5_SHADOW = 0x2098;
export const TASK_FLAGS = 0x20c1;
export const loc_20e7 = 0x20e7;
export const GAME_ACTIVE = 0x20e9;
export const PLAYER1_OBJ_DESC = 0x20f8;
export const PLAYER2_OBJ_DESC = 0x20fc;
export const VIDEO_RAM_BASE = 0x2400;
export const PLAYFIELD_VRAM_BASE = 0x2402;
export const VIDEO_RAM_END = 0x4000;

export const ROUTINES = {
  0x1982: { name: "loc_1982", role: "store A -> TASK_FLAGS", cert: "code" },
  ...
  0x01c3: { name: "markAllAliensAlive", role: "HL-relative fill of 0x37 bytes with 0x01", cert: "code" },
  0x01d9: { name: "advanceRecordTotals", role: "record accumulate: [HL+2]+=C, [HL+3]+=[HL+1]; return 2nd total in A", cert: "code" },
  ...
  0x09d6: { name: "clearPlayfield", role: "clear the play-field framebuffer", cert: "code" },
  0x1439: { name: "drawSpriteColumn", role: "copy B bytes into B adjacent screen columns (stride 0x20 right per byte); live-out HL = HL + 0x20*B", cert: "code" },
  ...
  0x14cc: { name: "fillScreenRow", role: "fill B columns with A stepping 0x20 right from HL (a horizontal band); leave HL one stride past", cert: "code" },
  ...
  0x18fa: { name: "startSound", role: "(0x2094) |= B, mirror to sound port, A := result", cert: "code" },
  0x1910: { name: "loc_1910", role: "HL := loc_20e7 + (bit0 of ACTIVE_PLAYER_PAGE clear ? 1 : 0)", cert: "code" },
  0x19d3: { name: "loc_19d3", role: "store A -> GAME_ACTIVE (shared tail)", cert: "code" },
  0x19dc: { name: "loc_19dc", role: "SOUND_PORT3_SHADOW &= B, mirror to sound port 3, A := result", cert: "code" },
  0x1a32: { name: "blockCopy", role: "block-copy B bytes (DE)->(HL), both advancing", cert: "code" },
  0x1a3b: { name: "loadSpriteDescriptor", role: "read 5-byte descriptor at (HL) -> DE/A/C/B, then HL=C:A", cert: "code" },
  0x1a47: { name: "coordToScreenAddr", role: "HL := (HL >> 3) with H forced into the 0x2000-0x3fff video-RAM page", cert: "code" },
  0x1a5c: { name: "clearScreen", role: "zero video RAM 0x2400..0x3fff", cert: "code" },
  0x1a69: { name: "orBlitBitmap", role: "OR-merge C source bytes down each of B columns (columns 0x20 apart); advance HL and DE", cert: "code" },
};
