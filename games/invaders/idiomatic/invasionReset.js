 ...
 *   flow once the interrupt returns (never run inside the interrupt body). loc_206d is the warm-restart
 ...
 *   Mirrors decompiled ROM routines loc_1971 (sets loc_206d=1) -> loc_16e6-0x170d (the wait + teardown),
