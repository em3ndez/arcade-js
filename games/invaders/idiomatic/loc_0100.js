...
import { PRIZE_ACTIVE, ACTIVE_PLAYER_PAGE, loc_2004, loc_2005, loc_2006, loc_1c00, ALIEN_DRAW_ADDR, ALIEN_DRAW_PENDING } from "./names.js";
...
export function loc_0100(m) {
  ...
  const objAddr = (m.mem8[ACTIVE_PLAYER_PAGE] << 8) | m.mem8[loc_2006];
  if (m.mem8[objAddr] !== 0) {
    const even = m.mem8[loc_2004] & 0xfe;
    let sprite = loc_1c00 + u8((even << 3) | (even >>> 5)); // sprite id -> rotate-left-3 -> table offset
