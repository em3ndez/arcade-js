 ...
 *   ACTIVE_PLAYER_PAGE (0x2067), the sprite-id/frame state bytes loc_2004 (sprite id) and loc_2005
 ...
 *
 * ROM 0x0100-...  Grounding: [seen].  (loc_2004 / loc_2005 keep placeholder names — the pixel-axis
...
export function drawPendingAlien(m) {
  ...
  if (m.mem8[objAddr] !== 0) {
    ...
    // Two-frame walk cycle: when the alternate-frame flag loc_2005 is set, advance the pointer to the
