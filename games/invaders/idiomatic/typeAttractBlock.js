 ...
 *
 * WHAT IT IS
 *   Seats a 0x0f (15) glyph count and a fixed screen destination loc_2b14, then runs the paced typing
 ...
 *   glyphs. loc_2b14 is the fixed screen destination for this block.
 *
...
export function* typeAttractBlock(m, de) {
  // Delegate to the paced typing driver: source = de, count = 0x0f glyphs, destination = loc_2b14.
