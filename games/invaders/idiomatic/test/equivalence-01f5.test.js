...
// Memory-equivalence for loc_01f5 -- seat the player-2 shield buffer base, then delegate to
...
test("CAPTURE: real 0x01f5 dispatches -- loc_01f5 == oracle in RAM (-stack) and HL", () => {
