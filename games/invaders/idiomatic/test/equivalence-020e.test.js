...
// Memory-equivalence for loc_020e -- force save mode (1) then run the shared shield save/restore body
// against the player-2 backup buffer (DISSOLVED into a direct loc_020e -> saveOrRestorePlayer2Shields -> drawOrSaveShields).
...
test("CAPTURE: real 0x020e dispatches -- loc_020e == oracle in RAM (-stack)", () => {
...
test("TEETH: a twin that forwards the wrong mode (blit) diverges in RAM at the stored mode", () => {
  // Mutate loc_020e's OWN contribution: it forwards mode 0 (blit) instead of the forced save mode 1.
