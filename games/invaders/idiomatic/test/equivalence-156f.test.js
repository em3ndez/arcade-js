...
// Memory-equivalence for loc_156f (Y-scale) -- read the object Y cell, count the 0x10 steps to lift it to
...
test("CAPTURE: real 0x156f dispatches -- loc_156f == oracle in RAM (-stack) and H/C/A", () => {
