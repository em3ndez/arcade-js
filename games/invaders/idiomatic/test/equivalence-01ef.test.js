...
// excludes that dead scratch. Run: node --test games/invaders/idiomatic/test/equivalence-01ef.test.js
...
test("CRAFTED: four copies of the template from the player-1 base, HL past the fourth", () => {
