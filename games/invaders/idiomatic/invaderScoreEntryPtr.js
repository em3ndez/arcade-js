 ...
 *
 * WHAT IT IS
 *   Turns an invader-tier key in A into a pointer into the three-entry score table at loc_1da0. The
 ...
 *   The table itself (loc_1da0) holds the three per-tier point values.
 *
 * ROM 0x097c.  Grounding: [seen].
 *
 * LIVE-OUT: HL = loc_1da0 + {0,1,2}, the selected score-table entry (also the routine's return value).
 */
