...
/**
 * loc_1a07  (ROM 0x1A07–0x1A32) — rst 0x28 STATE-MACHINE dispatcher.
...
export function loc_1a07(m) {
  ...
  throw new NotImplemented(
    `loc_1a07 rst 0x28 dispatches to ROM 0x${target.toString(16).padStart(4, "0")} ` +
