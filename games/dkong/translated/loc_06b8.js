...
/**
 * loc_06b8  (ROM 0x06B8–0x06FD) — task 6 of the 0x0307 table: redraws the lives indicator and the level digits.
 *
 *   06b8  4f           ld   c,a
 *   06b9  cf           rst  0x08
...
export function loc_06b8(m) {
  ...
  // and MY caller is loc_06b8 -- so re-emitting that value verbatim made
  // loc_06b8 assert it about ITS caller, where it is false. A predicate that
  ...
  // erroneous `if (!loc_06b8(m)) return;` is INERT, whereas undefined is
