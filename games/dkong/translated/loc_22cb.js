...
/**
 * loc_22cb  (ROM 0x22CB–0x2302) — OBJECT VELOCITY INIT (difficulty/mode/RNG scaled).
...
export function loc_22cb(m) {
  ...
  throw new NotImplemented(
    `loc_22cb rst 0x28 dispatches to unexpected ROM 0x${target.toString(16).padStart(4, "0")}`,
  );
}
