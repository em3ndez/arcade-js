...
/**
 * loc_30bd  (ROM 0x30BD–0x30DA) — 30 bytes, 12 instructions.
 *
 ...
 * ends 0x127B), and nothing in translated src invokes loc_30bd
 *
 ...
 * pushes NOTHING, so sub_30e4's `ret` returns to loc_30bd's OWN caller. Modelled
...
export function loc_30bd(m) {
  ...
  // TAIL JUMP: no push. sub_30e4's ret returns to loc_30bd's caller.
