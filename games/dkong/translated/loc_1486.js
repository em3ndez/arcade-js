...
/**
 * loc_1486  (ROM 0x1486–0x15F6) — the (0x600A) phase-21 handler: on-board bonus item mover + its.
  ...
  for (;;) {
    switch (label) {
      ...
      case 0x15f9:
        ...
        return;
      default:
        throw new Error(`loc_1486: unreachable label 0x${label.toString(16)}`);
    }
  }
}
