...
/**
 * loc_0616  (ROM 0x0616–0x0629) — draws string 5, sets up a one-byte BCD expansion at 0x6001, and tail-jumps to loop_0583.
 *
 ...
 * 0x0583's `ret` returns to *this* routine's caller, so loc_0616 has no
