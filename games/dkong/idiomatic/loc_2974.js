 ...
 *
 * A thin front end over the object-list bounding-box search loc_2913. It fixes the
 ...
 *
 * In the ROM this is `call 0x2913 / ret` — a tail call. loc_2913 uses the shared
 ...
 *
 * LIVE-OUT: registers, left exactly as loc_2913 leaves them — A is 1 on a hit / 0 when
 ...
 *   and B straight back. No work RAM is written (loc_2913 is a leaf that only reads the
 *   records and Mario's position). This routine therefore returns nothing.
 *
 * REGISTER-ABI MARSHALLING (dissolves once loc_2913 takes honest args): loc_2913 still
 ...
 *           and loc_2913's saved base) is churn this routine dissolves. Teeth: a twin
 ...
 *           comments. loc_2913 is direct-called.
 */

import { MARIO_ACTIVE, MARIO_Y, OBJ_PAIR_6680 } from "./ram.js";
import { loc_2913 } from "./loc_2913.js"; // ROM 0x2913 — object-list bounding-box search
