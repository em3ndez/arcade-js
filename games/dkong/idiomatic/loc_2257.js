...
/**
 * loc_2257 — the "no hit" tail of the sub_2243 hit test: abort the caller as well
 ...
 * position. On a HIT it returns normally, so its caller — a sub_2207 state arm
 * (loc_2227 / loc_2259) — runs its own tail. On NO HIT it falls into (or jumps to)
 ...
 *           reachable same-subsystem ancestor (sub_2207 at ROM 0x2207), all confirm
 *           it writes no RAM and returns false. The 0x2257 dispatch itself is a
 *           gameplay-only hit-test tail (sub_2243/loc_2227/loc_2259 are never
