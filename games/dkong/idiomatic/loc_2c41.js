 ...
 *           nibble forced 0 and nonzero), proving the claim tags 0x6382 with 0x81 on the mode-1 arm
 *           and 0x80 on the mode-3 arm; + real captured 0x2C41 dispatches from an attract run (which
 ...
 *           (0x6382, 0x638F, 0x6392, BONUS_EVENT_MARK). The oracle threads a residual accumulator and
 *           flags out and its terminal pop is dead; the translated callers reload before reading back.
 ...
 *           live inside stirRandomSeed and the slot-claim cells inside the two mode entries; the
 *           request-flag scratch 0x6382 is unnamed 0x63xx engine scratch, kept hex inside those.
 */
