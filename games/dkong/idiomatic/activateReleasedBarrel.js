...
/**
 * activateReleasedBarrel — the string renderer's 0x7F terminator: reinitialise the object record it
 * was building and reload the ten-record sprite-object block.  ROM 0x2D8C.
 *
 * The renderer (advanceBarrelRelease -> stepBarrelAlongReleasePath) walks a character string, writing 4-byte sprite
