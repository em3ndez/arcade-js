...
/**
 * stepBarrelAlongReleasePath — the string renderer's per-character body: emit one 4-byte sprite record
 * for the next character of the string, or hand off to the terminator.  ROM 0x2D54.
 *
 * The renderer (advanceBarrelRelease -> loc_2d51 / loc_2d83) sets up the source-string pointer and
 ...
 * hands off to activateReleasedBarrel to close the object out (activateReleasedBarrel reads the object-record and
 ...
 *           hand-off (activateReleasedBarrel's dissolved call brackets) pushes into.
...
export function stepBarrelAlongReleasePath(m) {
  ...
  // Terminator: close the object out. activateReleasedBarrel reads the object-record and destination
