...
/**
 * loc_1654 — step 0 of the board-advance render sequence: run the intro/board spawn
 ...
 * (GAME_SUBSTATE 0x600A == 0x16), sibling to loc_1670. loc_1615 dispatches the family
 ...
 *
 *   1. loc_1708 (ROM 0x1708) — the intro/board spawn init: silence sound, seed a fixed
 ...
 *      (loc_1670) swaps the next frame in. Same pose-hold value every sibling re-arms.
 *   4. Fall through into the shared tail loc_1662 (tail_1662): advance the 0x6388 step
 ...
 *
 * Reached via loc_1615 → rst 0x28, whose dispatchGameState tail discards this handler's
 ...
 * loc_1708 (0x1708), loadSpriteObjectBlock (0x004e), loc_1662 (0x1662, the shared tail).
 *
...
export function loc_1654(m) {
  ...
  //    The oracle stages A = 0x20 first; A is dead into the tail (loc_1662 sets A = 1).
  mem.write8(SUBSTATE_TIMER, POSE_HOLD_FRAMES);

  // 4. Shared tail (the oracle falls through into tail_1662): advance the 0x6388 step
  //    selector and, on 25m only, shift the ten records' Y column by -4.
  loc_1662(m); // ROM 0x1662
}
