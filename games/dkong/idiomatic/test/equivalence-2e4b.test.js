 ...
 *   4. REALISM (captured) — attract never reaches entry_2e04's object loop. Nudge the 10
...
// Attract never reaches entry_2e04's object loop. Nudge all 10 objects active + non-4 state
...
test("REALISM: real captured 0x2e4b dispatches — loc_2e4b matches the oracle", () => {
  ...
  assert.equal(caps.length, 10, "the steered full-loop entry_2e04 should dispatch 0x2e4b once per object (10)");
