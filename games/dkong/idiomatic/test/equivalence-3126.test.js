 ...
 *
 *   3. REALISM + PURITY (crafted entries) — the family is reached only through loc_30fa's
...
import { guard_3126 as oracle } from "../../translated/guard_3126.js";
...
test("REACHABILITY: 0x3126 is NOT dispatched during attract (family reached only via loc_30fa's untranslated table)", () => {
  let count = 0;
