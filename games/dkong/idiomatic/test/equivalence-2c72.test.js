 ...
 *      allocator's dispatch), clone the machine at each true dispatch, and confirm loc_2c72
...
import { entry_2c72 as oracle } from "../../translated/entry_2c72.js";
...
test("EQUAL (exhaustive): loc_2c72 == oracle across all 256 starting bytes", () => {
  const base = new Machine(ROM).clone();
  const { mismatch, count } = fullSweep(base, loc_2c72);
...
test("REALISM: real captured 0x2C72 dispatches — loc_2c72 matches oracle RAM", () => {
