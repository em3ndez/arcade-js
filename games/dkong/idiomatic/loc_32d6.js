 ...
 *         loc_330f (same exit as the step-to-zero branch).
 ...
 * both exit fields", loc_330B "tick loc_330f") are written inline where reached.
 *
 ...
 * GATE:     crafted-entry. 0x32D6 is on the (untranslated) entry_3202 chain and is
 *           never dispatched during attract (0 in 2500 frames), so the gate is a
 *           real attract-base machine with surgical pokes covering all five exit
 *           paths, crossed with loc_330f's own timer/random arms. Teeth: a twin that
 ...
 *           (the record layout is not yet named) — reported for the lead. loc_330f
...
import { loc_330f } from "./loc_330f.js"; // ROM 0x330F — tick the object's periodic timer

// Object-record field offsets (relative to the live-in record pointer). Unnamed in
// ram.js; kept as local offsets, mirroring loc_330f's TIMER/STATE.
