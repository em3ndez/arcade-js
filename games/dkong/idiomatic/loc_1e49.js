...
/**
 * loc_1e49 — the idle (do-nothing) arm of sub_1dbd's EFFECT_STATE (0x6340) router.  ROM 0x1E49.
 *
 ...
 * router is a no-op that frame. 0x6340 is now named EFFECT_STATE in ram.js (the effect
 * subsystem's 4-way router); this arm's ROLE within that effect sequence is still not
 * pinned, so the routine keeps its neutral loc_ name: the MECHANICS are certain (a pure
 * ret) but the ROLE is not.
 *
