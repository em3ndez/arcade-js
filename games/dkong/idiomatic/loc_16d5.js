...
/**
 * loc_16d5 — drive sub_25f2's object #1, then slide its 10-sprite group one step along X.  ROM 0x16d5.
 *
 * The tail of the loc_16bb / loc_16d0 / loc_16e1 substate family that animates a
 ...
 *      step-direction sign on underflow), REPUBLISH its signed per-frame step into 0x63A3
 *      (0 on even frames, 0xFF/0x01 by sign on odd frames), and every 32nd frame advance
 *      its mirrored sprite-animation pair at 0x69E4.
 *   2. Take that freshly-published step (0x63A3) as the shift amount C.
 ...
 * name for the same reason (the sprite-record trap), and the publish cell 0x63A3 stays hex
 * — so this routine keeps the neutral loc_16d5 name; a reviewer who promotes loc_2602 can
 ...
 *           sub_25f2 object cascade it drives runs only in real gameplay; loc_16d5's own
 ...
 * LIVE-OUT: memory-only. loc_16d5 is the tail of the loc_16bb substate family, dispatched
 ...
 *           (byte +0) is shifted. The publish cell 0x63A3 and object #1's state bytes stay
