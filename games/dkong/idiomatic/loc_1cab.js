 ...
 *     place around its four-value ring by loc_3009: with this routine's ring selector the
 ...
 *
 * OFF-RING GUARD, deliberately absent. loc_3009 scans a packed table for a field matching
 ...
 *           every MARIO_WALK_ANIM value on which loc_3009 terminates — on 25m and on a
 ...
 *           advanceMarioWalkX (ROM 0x1CD2), loc_3009 (ROM 0x3009) and beginWalkStep
...
import { loc_3009 } from "./loc_3009.js";                   // ROM 0x3009
...
// Ring selector handed to loc_3009: picks the packed table whose fields step
...
export function loc_1cab(m) {
  ...
  const nextAnim = loc_3009(LEFT_WALK_RING, mem.read8(MARIO_WALK_ANIM)).a;
