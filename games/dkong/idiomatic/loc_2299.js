...
/**
 * loc_2299 — advance a board object to its next state, on a randomised pacing gate.  ROM 0x2299.
 *
 * One arm of the four-state update machine that sub_2207 runs for a board object.
 ...
 *           naturally dispatched in attract — sub_2207 runs every frame there but its
 ...
 *           of sub_2207's per-object dispatch; nothing downstream consumes a register or
 ...
 * @returns {void}
 */
export function loc_2299(m, recordBase) {
  const { mem } = m;
