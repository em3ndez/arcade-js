...
/**
 * spawnInterludeHeart — board/intro spawn init: silence sound, seed a fixed 4-byte sprite
 ...
 *
 * Called at board load (begin50mKongRecaptureInterlude) and the intro-cutscene spawn (beginKongRecaptureInterlude); both
 * callers label it "spawn". The neutral spawnInterludeHeart name reflects that the individual
 ...
 *           exercised here (its callers begin50mKongRecaptureInterlude board-load and beginKongRecaptureInterlude intro-spawn
 ...
 *           register or flag this leaves (begin50mKongRecaptureInterlude `ld a,(0x6910)`; beginKongRecaptureInterlude
