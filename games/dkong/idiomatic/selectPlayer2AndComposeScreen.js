 ...
 * PLAYER_SLOT_RECORDS (0x611C) for an active player slot. loc_141E first clears its two-byte
 * "player index" (CURRENT_PLAYER 0x600D and ACTIVE_PLAYER_INDEX 0x600E) to 0, then:
 ...
 *      (score awards, context slot, etc. all key off it). ACTIVE_PLAYER_INDEX (0x600E)
 *      is written in lockstep (loc_141E cleared both, each arm rewrites both).
 ...
 * LIVE-OUT: memory + the 0x7D82 flip-screen latch. Memory: CURRENT_PLAYER (0x600D) and
 *           ACTIVE_PLAYER_INDEX (0x600E) set to 1, plus (via the callee) SUBSTATE_TIMER (0x6009),
