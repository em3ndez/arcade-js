...
/**
 * drawLadder — stamp a kind-2 slope-band run across the tilemap for a board-layout record.
 *
 * WHAT IT ACTUALLY DRAWS, because the export name points the wrong way: THIS IS THE GIRDER
 * DRAWER. Blanking the writes made here removes every sloped platform on the board and not
 * one ladder pixel. That is also why the foot-contact check reads the tiles this arm stamps.
 * The short vertical runs — the ladders — are laid by the board-layout walk's OTHER drawer.
 *
