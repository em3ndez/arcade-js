...
/**
 * drawLadder — fill a board-layout segment's body run with the uniform tile 0xC0,
 * then draw its end cap.
 *
 * WHAT IT LAYS DOWN IS LADDER, and that is measured rather than read off the code:
 * blanking its tile writes and diffing the frame removes 616 px, and they are the
 * ladders — the two full-height ones beside Kong plus eight shorter segments. Not one
 * girder pixel changes.
 *
