...
/**
 * climbKongFigureAndBreakHeart — one animation-gated step of the board-advance render sequence.  ROM 0x1732.
 *
 ...
 *      the render-sequence step selector (0x6388) so dispatchBoardClearedInterlude moves on to step 4 (0x1757).
 *
 ...
 *
 * NAME: kept as climbKongFigureAndBreakHeart — the mechanics are understood but the exact visual the animation
 * depicts is not independently confirmed, and the whole sibling family stayed address-named
 * (advanceInterludeStepAndLiftKongFigure / stageNextKongPoseWhenHoldExpires).
 *
 ...
 *           the board-advance render-sequence step, same one advanceInterludeStepAndLiftKongFigure/1670 advance) from
