...
| 6600 | objArray66 | THE ELEVATOR PLATFORMS. Object array, stride 0x10, 6 records; 75m only. Each drifts one pixel vertically per service toward its limit - bit 3 of the state field picks the direction, a riser lands at row 96 with X snapped to column 119, a faller deactivates at row 248. "Elevators" is inferred from behaviour |
...
| 6980 | actorSprites | 10 sprite records (stride 4) at 6980-69a7, mirroring the X and Y of the 6500 object array |
