...
/**
 * Equivalence tests for loc_1087 (board-3 (75m/elevators) sprite-and-object setup — rst-0x28 table entry, the
...
import { loc_1087 as translated_1087 } from "../../translated/state0.js";
import { loc_1087 as optimized_1087 } from "../loc_1087.js";
...
function captureEntry() {
  ...
  if (entry === null) throw new Error("loc_0fd7 never entered — cannot craft a loc_1087 entry");
  return entry;
}
const ENTRY = ROM_PRESENT ? captureEntry() : null;

function broken_1087(m) {
  ...
  try { return optimized_1087(m); } finally { m.mem.write8 = realWrite; }
}

function runBoth(optFn = optimized_1087) {
  const a = ENTRY.clone();
  const b = ENTRY.clone();
  translated_1087(a);
  optFn(b);
...
test("EQUAL (crafted entry): loc_1087 matches translated in state + registers", () => {
