...
export const ROUTINES = {
  ...
  0x0430: { name: "holdStartLampsThenAdvanceSequence", role: "[code] loc_03f2 sub-state slot 1: tick countdown 0x4019, and while it stays nonzero keep the start-button lamps in step with credits (driveStartButtonLamps); on its zero-cross advance SEQUENCE_STATE (0x400a) and clear the 128-byte flag-bits block.", cert: "code" },
