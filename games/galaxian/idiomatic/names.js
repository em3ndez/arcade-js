...
export const ROUTINES = {
  ...
  0x13e1: { name: "chooseNextAttackerDirection", role: "[code] Sets the shared attacker launch/curve direction flag loc_4215 (0 or 1): the 16-bit formation anchor loc_420e's sign picks which FORMATION_X_BOUNDS (0x4210) edge to measure the 8-bit gap against; within 28px of that edge the flag is forced away from the edge (0 near the high bound, 1 near the low bound), otherwise a fresh random bit (advanceRandomSeed & 1). Consumed by the spawner launchAttackerFromFormation (seeds a new attacker's direction field record+6) and loc_140c (left/right column scan).", cert: "code" },
