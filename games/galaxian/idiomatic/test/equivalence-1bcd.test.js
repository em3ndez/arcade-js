...
/**
 * dispatchSelfTestMode — memory-equivalent to the frozen self-test mode dispatch at ROM 0x1bcd. It routes on the self-test
...
import { dispatchSelfTestMode as cand } from "../dispatchSelfTestMode.js";
...
const alwaysMode3 = (m) => fillObjRamTestRamp(m, m.mem8[RNG_SEED]);

test("EQUAL: dispatchSelfTestMode == oracle on mode 1, 2, 3", { skip }, () => {
  ...
  console.log("  EQUAL: dispatchSelfTestMode == oracle on modes 1/2/3");
});
