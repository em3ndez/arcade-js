...
/**
 * renderFrogAnimArm3 — frog-animation arm 3. Loads its row-advance/count/column from the
 * lane-parameter block (the arm-3 triple at ACTIVE_LANE_PARAM_BLOCK + 9), points the destination +
...
export function renderFrogAnimArm3(m) {
  ...
  return (m.regs.a = rowAdvance), (m.regs.b = rowCount), (m.regs.c = columnIndex), (m.regs.hl = destPtr), (m.regs.de = FROG_ANIM_ARM3_SRC_BASE), (m.regs.ix = LANE_OBJLIST_811B), (m.regs.iy = LANE_OBJLIST_811B), m.call(FROG_ANIM_RENDER_LOOP);
}
