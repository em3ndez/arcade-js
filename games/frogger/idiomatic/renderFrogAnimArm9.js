...
/**
 * renderFrogAnimArm9 — frog-animation arm 9 (sibling of arm 0). Loads its row-advance/count/column from
 * the lane-parameter block (the arm-9 triple at ACTIVE_LANE_PARAM_BLOCK + 27), points the destination +
...
export function renderFrogAnimArm9(m) {
  ...
  return (m.regs.a = rowAdvance), (m.regs.b = rowCount), (m.regs.c = columnIndex), (m.regs.hl = destPtr), (m.regs.de = FROG_ANIM_ARM9_SRC_BASE), (m.regs.ix = LANE_OBJLIST_8151), (m.regs.iy = LANE_OBJLIST_8151), m.call(FROG_ANIM_RENDER_LOOP);
}
