...
/**
 * awardHomeBay3Goal — memory-equivalent to the frozen oracle loc_1e29 (ROM 0x1E29), the bay-3 home
...
import { awardHomeBay3Goal as cand } from "../awardHomeBayGoal.js";
import { loc_1e29 as oracle } from "../../translated/loc_1dd8.js";

const skip = romsPresent() ? false : "ROM images are gitignored; none assembled";
const GATE_P1 = 0x8260, GATE_P2 = 0x8265, COUNT_P1 = 0x825c;
...
const awardMatch = () => craft((mem) => { base(mem); mem[KEY] = 0x03; });
const collision = () => craft((mem) => { base(mem); mem[COLLISION] = 1; });
const player2 = () => craft((mem) => { base(mem); mem[PLAYER] = 2; });

test("EQUAL (crafted): awardHomeBay3Goal == oracle over every branch", { skip }, () => {
  ...
  assert.equal(a.mem8[GATE_P1], 1, "positive control: award did not set the bay-3 gate");
  console.log("  EQUAL: done/reject/miss/match/collision/player2; bay-3 gate 0->1 non-vacuous");
});
