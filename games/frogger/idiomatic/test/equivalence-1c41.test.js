...
/**
 * beginFrogHopRight — memory-equivalent to the frozen oracle at ROM 0x1C41.
 * GATE: crafted-entry. The RIGHT begin guards on frog Y and frog X, and on a fresh hop emits the hop
 * sound + stamps the rest sprite, primes the hop counter, then falls into the RIGHT (horizontal) advance.
...
import { beginFrogHopRight as cand } from "../animateFrogHop.js";
import { loc_1c41 as oracle } from "../../translated/loc_1c41.js";

const skip = romsPresent() ? false : "ROM images are gitignored; none assembled";
const REST_CODE = 0xa1;
...
const freshSpriteSet = () => craft((mem) => { base(mem); mem[COUNTER[2]] = 0; mem[FROG_SPRITE] = REST_CODE; });
...
test("EQUAL (crafted): beginFrogHopRight == oracle on guards/fresh/re-prime/in-progress/wrap", { skip }, () => {
