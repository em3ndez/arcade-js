 ...
 * toward/away/turn drift to the frog X (0x8014). Live-in IX/IY (preserved) + RAM; LIVE-OUT memory-only.
 * NOTE: links once names.js exports loc_8014 (frog X), added in the naming pass.
 */
...
const TURN = { [o(6)]: 1, [GATE]: 0, [o(9)]: 1, [s(3)]: 0x20, [o(5)]: 0, [o(0)]: 0x40, [FROG_X]: 0x60, [s(0)]: 0x08, [s(4)]: 0x33, [s(1)]: 0x11, [o(7)]: 0 };
...
function brokenSkipArm(m) { // does the turn but forgets the (ix+7)=1 arm
  ...
  const fx = m.mem.read8(FROG_X), an = m.mem.read8(ix + 0);
  if (fx < an) return;
...
test("EQUAL (crafted): steerSpriteObjectTowardFrog == oracle on every path", { skip }, () => {
  const entries = [
    ...
    entry({ [o(6)]: 1, [GATE]: 0, [o(9)]: 1, [s(3)]: 0x20, [o(5)]: 0, [o(0)]: 0x50, [FROG_X]: 0x40, [o(7)]: 0 }), // above, hold
    entry(TURN), // above facing0, reached -> turn
    entry({ [o(6)]: 1, [GATE]: 0, [o(9)]: 1, [s(3)]: 0x20, [o(5)]: 0, [o(0)]: 0x40, [FROG_X]: 0x44, [s(0)]: 0x10, [o(2)]: 5, [o(7)]: 0 }), // step toward
    entry({ [o(6)]: 1, [GATE]: 0, [o(9)]: 1, [s(3)]: 0x20, [o(5)]: 0x80, [o(1)]: 0x40, [FROG_X]: 0x44, [s(0)]: 0x10, [s(4)]: 0x33, [s(1)]: 0x11, [o(7)]: 0 }), // facing1 turn
