...
/**
 * commitRiverLane3Arrival — memory-equivalent to the frozen oracle at ROM 0x1CD5.
 * GATE: crafted-entry. The lane-3 (horizontal) commit guards on arrival, ticks the ride counter down and
 * either marks arrival (home sprite) or carries the frog FROG_X -= the horizontal delta + moving sprite.
 * From a captured post-boot state the lane-3 cells are poked to drive the three branches. Live-out is
...
import { commitRiverLane3Arrival as cand } from "../rideRiverLaneAndCommitArrival.js";
import { loc_1cd5 as oracle } from "../../translated/loc_1c41.js";

const skip = romsPresent() ? false : "ROM images are gitignored; none assembled";

const arrival = () => craft((mem) => { mem[ARRIVAL[3]] = 0; mem[COUNTER[3]] = 1; mem[DIR[3]] = 1; mem[FROG_SPRITE] = 0x00; });
const carry = () => craft((mem) => { mem[ARRIVAL[3]] = 0; mem[COUNTER[3]] = 2; mem[HDELTA] = 3; mem[FROG_X] = 0x60; });
const guarded = () => craft((mem) => { mem[ARRIVAL[3]] = 0x77; });

test("EQUAL (crafted): commitRiverLane3Arrival == oracle on guard/arrival/carry", { skip }, () => {
