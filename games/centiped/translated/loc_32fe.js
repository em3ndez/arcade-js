...
export function loc_32fe(m) {
  ...
  m.push16(0x330f); m.step(0x3310, 6); m.call(0x384f);                                                  // 330d jsr $384f
  regs.a = mem.read8(0x00aa); regs.setNZ(regs.a); m.step(0x3312, 3);                  // 3310 lda $aa
  m.push16(0x3314); m.step(0x3315, 6); m.call(0x384f);                                                  // 3312 jsr $384f
  regs.a = mem.read8(0x00a8); regs.setNZ(regs.a); m.step(0x3317, 3);                  // 3315 lda $a8
  regs.clc(); m.step(0x3318, 2);
  m.push16(0x331a); m.step(0x331b, 6); m.call(0x384f);                                                  // 3318 jsr $384f
  ...
  if (regs.fZ) {
    ...
    m.push16(0x3331); m.step(0x3332, 6); m.call(0x384f);                                                // 332f jsr $384f
    regs.a = mem.read8(0x00ab); regs.setNZ(regs.a); m.step(0x3334, 3);               // 3332 lda $ab
    m.push16(0x3336); m.step(0x3337, 6); m.call(0x384f);                                                // 3334 jsr $384f
    regs.a = mem.read8(0x00a9); regs.setNZ(regs.a); m.step(0x3339, 3);               // 3337 lda $a9
    regs.clc(); m.step(0x333a, 2);
    m.push16(0x333c); m.step(0x333d, 6); m.call(0x384f);                                                // 333a jsr $384f
  }
  ...
  m.push16(0x334e); m.step(0x334f, 6); m.call(0x384f);                                                  // 334c jsr $384f
  regs.a = mem.read8(0x0003); regs.setNZ(regs.a); m.step(0x3351, 3);                  // 334f lda $03
  m.push16(0x3353); m.step(0x3354, 6); m.call(0x384f);                                                  // 3351 jsr $384f
