...
/**
 * loc_29ad — per-frame driver for the dig/carve object.  ROM 0x29ad.
 *
...
export function loc_29ad(m) {
  ...
  if (spawn === 2) {
    ...
    mem8[CLIMB_GATE] = boxOverlap(mem8[OBJ_X], mem8[OBJ_Y], mem8[STAGED_TARGET_X], mem8[STAGED_TARGET_Y]);
  }
