...
/**
 * dockManAndDispatchRoundBoundary — round/state-boundary dispatcher: dock the active player's man count,
 ...
 * own return carries dockManAndDispatchRoundBoundary's caller.
 *
 ...
 *           are now idiomatic (resetStateAndShowSetup / stepRoundSubPhaseAndBranch / setUpRoundAndHoldIntro / submitHighScoresAndReset),
...
export function* dockManAndDispatchRoundBoundary(m) {
  ...
  mem8[PLAYER2_MEN_BACKUP] = 0; // the other player's backup man count
