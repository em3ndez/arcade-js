...
/**
 * advanceObjectMovers — the per-frame object-pair mover pass: drive object 1 through the
 * shared move/collision driver, stage its sprite record, then hand off object 2.  ROM 0x312d.
 *
...
export function advanceObjectMovers(m) {
  const { mem8 } = m;
