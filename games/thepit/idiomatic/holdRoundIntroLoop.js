 ...
 * round-loop setup (initRoundAndEnterMainLoop, 0x031a) is kept as an m.call boundary: initRoundAndEnterMainLoop falls into the
 ...
 *
 * NAME kept holdRoundIntroLoop: which round boundary this intro belongs to (new game vs. new level
