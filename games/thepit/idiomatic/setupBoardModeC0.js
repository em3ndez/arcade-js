...
/**
 * setupBoardModeC0 — stow the 0xC0 board-mode byte, then run the shared display-setup body.  ROM 0x4b3c.
 *
 ...
 *
 * PURPOSE [guess]: which situation 0xC0 means; "C0" is the hex selector byte. (0x00 door is the already-named blankScreen.)
 */
