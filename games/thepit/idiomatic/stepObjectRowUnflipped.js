 ...
 * leaves no register for its caller to read. It stays stepObjectRowUnflipped: its main callee locateActorCellCheckGoal
 * and its axis sibling stepObjectRowFlipped are themselves still neutrally named (the row/goal
