...
/**
 * Equivalence gate for loc_06ac (ROM 0x06ac) — the cell-animation countdown at
 * 0x805c plus the per-frame recolour of the one fixed screen cell it selects.
 *
 * loc_06ac READS the countdown 0x805c and the selected cell's video-RAM glyph, and
...
import { loc_06ac as idiomatic } from "../loc_06ac.js";
...
test("EQUAL: loc_06ac leaves the same state as the oracle over real captured attract states", () => {
