...
/**
 * Memory-equivalence gate for setBgSpriteFrame (ROM 0x2fd9, The Pit) — commit the chosen
 ...
 *
 *   1. setBgSpriteFrame is NEVER dispatched during attract — its whole background-flip
 ...
 *      a difference between them — only setBgSpriteFrame's own behaviour can.
 *
...
import { setBgSpriteFrame as idiomatic } from "../setBgSpriteFrame.js";
...
const TARGET = 0x2fd9; // setBgSpriteFrame
...
const TILE_CELL = 0x80dc; // the background-animation tile cell setBgSpriteFrame writes
 ...
 * the tail stub in its registry so setBgSpriteFrame can be run on clones of it. The sibling
...
// setBgSpriteFrame is unreached in attract, so a makeMachine wrapper forces a real dispatch:
