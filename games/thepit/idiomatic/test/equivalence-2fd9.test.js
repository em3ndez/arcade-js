...
/**
 * Memory-equivalence gate for loc_2fd9 (ROM 0x2fd9, The Pit) — commit the chosen
 ...
 *
 *   1. loc_2fd9 is NEVER dispatched during attract — its whole background-flip
 ...
 *      a difference between them — only loc_2fd9's own behaviour can.
 *
...
import { loc_2fd9 as idiomatic } from "../loc_2fd9.js";
...
const TILE_CELL = 0x80dc; // the background-animation tile cell loc_2fd9 writes
 ...
 * the tail stub in its registry so loc_2fd9 can be run on clones of it. The sibling
...
// loc_2fd9 is unreached in attract, so a makeMachine wrapper forces a real dispatch:
