 ...
 * command index. This one requests command 17: it hands that index to the shared
 ...
 * neighbours at the adjacent addresses request command 16 and command 18.
 *
 * Which real effect command 17 selects is not yet identified, so the name states the
 * command it requests, not the noise that plays.
 *
 * Memory-equivalent to the frozen oracle — equivalence-4c93.test.js.
 * GATE:     crafted-entry — attract never requests command 17, so the gate runs this
