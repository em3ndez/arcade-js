 ...
 * game loop — so this is a tail hand-off (loc_01f9, kept as an m.call boundary because it
 ...
 *           arms run the REAL reset handler loc_01f9, whose flag-clear path re-enters play
 *           and falls into the never-returning main loop; one shared watchdog hook drives
 *           the thirty setup-screen frame-waits (and loc_01f9's own paints) and stops both
 ...
 * NAMES:    GAME_MODE (0x8001), GAME_STATE2 (0x8002) from ram.js. loc_01f9 is the reset
