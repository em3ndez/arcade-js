...
/**
 * loc_3458 — tick a per-object state countdown; blink its sprite while it runs and
 ...
 *
 * Reached only from the per-object move driver (loc_319d), as its "arrived / caught"
 ...
 *           The expiry branch runs the real round/state-boundary transition (loc_0278),
 ...
 * NAMES:    ANIM_RAND (0x808b, serving here as the state countdown), ACTOR_STATE
