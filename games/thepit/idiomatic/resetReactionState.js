...
import { REACTION_OBJ_X, REACTION_OBJ_Y, REACTION_STATE, REACTION_TIMER, REACTION_OBJ_ATTR, REACTION_PERIOD, LASER_STATE, REACTION_RESET_COMPANION_SEED } from "./names.js";
...
export function resetReactionState(m) {
  ...
  mem8[REACTION_RESET_COMPANION_SEED] = 1;
