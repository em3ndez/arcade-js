 ...
 * command index. This one requests command 13: it hands that index to the shared
 ...
 * neighbours at the adjacent addresses request command 12 and the next command up.
 *
 * Which real effect command 13 selects is not yet identified, so the name states the
 * command it requests, not the noise that plays.
 *
 * Memory-equivalent to the frozen oracle — equivalence-4c83.test.js.
 * GATE:     crafted-entry — attract never requests command 13, so the gate runs this
