...
/**
 * loc_2c91 — flag whether the freshly-placed target cell coincides with the tracked
 ...
 * CLIMB_GATE, then continues into building the cell's 4-byte record.
 *
 ...
 * LIVE-OUT: memory (CLIMB_GATE) + whatever the record-build tail returns, passed
 ...
 *           CLIMB_GATE (the published flag). Stays loc_ — the flag's downstream effect
 *           is only weakly grounded (CLIMB_GATE is a weak name and the oracle tags the
