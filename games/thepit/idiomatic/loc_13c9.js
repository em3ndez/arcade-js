...
/**
 * loc_13c9 — per-frame head of the object/state dispatcher, gated by the state-lockout timer.  ROM 0x13c9.
 *
 ...
 *     dispatcher (loc_0278); any other value routes to the next-level advance (advanceToNextLevel).
 *
...
export function loc_13c9(m) {
  ...
  if (mem8[POST_TIMER_MODE] === 0) return loc_0278(m);
