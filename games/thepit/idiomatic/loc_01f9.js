...
/**
 * loc_01f9 — the boot/restart state entry: re-arm the machine, then fork on the credit
 ...
 * round init (loc_031a) that falls into the main loop — so each is kept as an m.call boundary
 ...
 * NAMES:    GAME_MODE (0x8001), GAME_STATE2 (0x8002), and the credit count CREDIT_COUNT
...
import { GAME_MODE, GAME_STATE2, CREDIT_COUNT } from "./ram.js";
