...
/**
 * requestSound3 — ask the sound driver to play sound-command 3. One of a fan of ~20
 * tiny sound-trigger stubs, each hard-wired to a single sound-command index; this one
 * hands index 3 to the shared sound-ring enqueue, which drops it into the next free
 * ring slot (marked pending) for the driver to pick up later. Which effect command 3
