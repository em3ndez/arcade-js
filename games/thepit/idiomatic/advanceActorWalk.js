 ...
 * cycle; this one carries the OBJ_Y accumulator and simply toggles the mirror every two
 * units.
 *
 ...
 * NAMES:    OBJ_Y from ram.js. The per-frame step 0x806d stays hex — its role (the OBJ_Y
...
const STEP = 0x806d; // per-frame amount carried onto the OBJ_Y position accumulator
