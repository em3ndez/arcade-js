...
sparse crystals and diamonds scattered in the dirt — and then **climb back up to your
ship** to escape. The final stretch of the climb is the **"Pit"** crossing.
...
against that evidence. Project: <https://github.com/qarl/arcade-js>.
