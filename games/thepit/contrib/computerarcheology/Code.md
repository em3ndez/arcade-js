...
0067: D9              EXX
0068: 3E 00           LD      A,$00
006A: 32 00 B0        LD      ($B000),A           ; {hard.mainLatch} acknowledge the interrupt so a second vblank cannot re-enter
006D: 3A 00 80        LD      A,($8000)           ; {ram.creditCount} read the banked credit count
...
0075: 47              LD      B,A
0076: 3A 1C 80        LD      A,($801C)           ; {ram.creditMirrorA} read the first redundant credit copy
...
007D: 3A 2C 81        LD      A,($812C)           ; {ram.creditMirrorB} read the second redundant credit copy
0080: B8              CP      B
0081: C2 A4 01        JP      NZ,$01A4            ; {code.coldBootInit} second copy disagrees, cold-reset
0084: 3A 1F 80        LD      A,($801F)           ; {ram.soundTail} read the sound ring read index
0087: 5F              LD      E,A
0088: 3A 1E 80        LD      A,($801E)           ; {ram.soundHead} read the sound ring enqueue head
008B: BB              CP      E
008C: 28 17           JR      Z,$00A5             ; read index caught the head, ring empty this frame
008E: 7B              LD      A,E
008F: 3C              INC     A
0090: E6 07           AND     $07                 ; wrap the read index around the eight-slot ring
0092: 32 1F 80        LD      ($801F),A           ; {ram.soundTail} store the advanced read index
0095: 21 20 80        LD      HL,$8020            ; {ram.soundRing} point at the sound ring base
0098: 16 00           LD      D,$00
...
00A0: 28 03           JR      Z,$00A5             ; no pending marker, skip firing
00A2: 32 00 B8        LD      ($B800),A           ; {hard.soundLatch} fire the queued command to the sound board

loc_00a5:
00A5: 11 40 98        LD      DE,$9840            ; {hard.spriteRam} point at hardware sprite RAM
00A8: 21 20 82        LD      HL,$8220            ; {ram.spriteStagingBase} point at the sprite staging block
00AB: 01 20 00        LD      BC,$0020            ; copy thirty-two bytes, eight sprites
00AE: ED B0           LDIR                        ; blit the staged sprites into sprite RAM
00B0: 3A 09 80        LD      A,($8009)           ; {ram.frameWaitCountdown} read the frame-wait countdown
00B3: 3D              DEC     A                   ; tick it down one frame
00B4: 32 09 80        LD      ($8009),A           ; {ram.frameWaitCountdown} store the countdown the pacer polls
00B7: 3A 06 80        LD      A,($8006)           ; read the first one-second divider
00BA: 3D              DEC     A
00BB: 32 06 80        LD      ($8006),A
00BE: 20 0C           JR      NZ,$00CC            ; not yet a full second, skip the reload
00C0: 3A 0F 80        LD      A,($800F)           ; borrow from the counter beneath the divider
00C3: 3D              DEC     A
00C4: 32 0F 80        LD      ($800F),A
00C7: 3E 3C           LD      A,$3C               ; reload sixty frames
00C9: 32 06 80        LD      ($8006),A           ; restart the first one-second divider

loc_00cc:
00CC: 3A 07 80        LD      A,($8007)           ; {ram.frameCounterPrescaler} read the second one-second divider
00CF: 3D              DEC     A
00D0: 32 07 80        LD      ($8007),A           ; {ram.frameCounterPrescaler}
00D3: 20 0C           JR      NZ,$00E1            ; not a full second yet, skip
00D5: 3A 10 80        LD      A,($8010)           ; {ram.playPhaseCounter} read the play-phase counter
00D8: 3C              INC     A                   ; advance it once per second
00D9: 32 10 80        LD      ($8010),A           ; {ram.playPhaseCounter} store the play-phase counter
00DC: 3E 3C           LD      A,$3C               ; reload sixty frames
00DE: 32 07 80        LD      ($8007),A           ; {ram.frameCounterPrescaler} restart the second divider

loc_00e1:
00E1: 3A 16 80        LD      A,($8016)           ; {ram.in1Prev} read the previous coin/start sample
00E4: 47              LD      B,A
00E5: 3A 00 A8        LD      A,($A800)           ; {hard.in1} read the coin/start input port
00E8: B8              CP      B                   ; did two reads in a row agree?
00E9: 20 03           JR      NZ,$00EE            ; unsettled, do not latch yet
00EB: 32 15 80        LD      ($8015),A           ; {ram.in1Debounced} latch the settled coin/start value

loc_00ee:
00EE: 32 16 80        LD      ($8016),A           ; {ram.in1Prev} roll the coin/start sample forward
00F1: 3A 19 80        LD      A,($8019)           ; {ram.in0Prev} read the previous joystick sample
00F4: 47              LD      B,A
00F5: 3A 00 A0        LD      A,($A000)           ; {hard.in0} read the joystick/dig port
00F8: B8              CP      B                   ; did two joystick reads agree?
00F9: 20 03           JR      NZ,$00FE            ; unsettled, do not latch yet
00FB: 32 18 80        LD      ($8018),A           ; {ram.in0Debounced} latch the settled joystick value

loc_00fe:
00FE: 32 19 80        LD      ($8019),A           ; {ram.in0Prev} roll the joystick sample forward
0101: 3A 15 80        LD      A,($8015)           ; {ram.in1Debounced} read the settled coin/start switches
0104: 4F              LD      C,A
0105: 21 03 80        LD      HL,$8003            ; {ram.coinSwAccum} point at the coin-line detector
0108: CB 41           BIT     0,C                 ; test the coin-slot-1 switch line
010A: 28 04           JR      Z,$0110             ; line idle, check for a completed pulse
010C: 36 55           LD      (HL),$55            ; line asserted, arm the coin detector
010E: 18 32           JR      $0142               ; no bank this frame, on to the start slots
...
0115: 20 2B           JR      NZ,$0142            ; no completed pulse, skip banking
0117: 3A 00 80        LD      A,($8000)           ; {ram.creditCount} read the banked credit count
011A: 3C              INC     A                   ; bank one credit
011B: FE 0A           CP      $0A                 ; compare against the cap of ten
011D: 38 02           JR      C,$0121
011F: 3E 09           LD      A,$09               ; clamp the credit count to nine

loc_0121:
0121: 32 00 80        LD      ($8000),A           ; {ram.creditCount} store the new credit count
0124: 32 1C 80        LD      ($801C),A           ; {ram.creditMirrorA} update the first redundant copy
0127: 32 2C 81        LD      ($812C),A           ; {ram.creditMirrorB} update the second redundant copy
012A: 3A 48 80        LD      A,($8048)           ; {ram.variant} read the variant override
012D: B7              OR      A
012E: 20 09           JR      NZ,$0139            ; variant set, always show the credit screen
0130: 3A 01 80        LD      A,($8001)           ; {ram.gameState} read the game mode
0133: 3D              DEC     A
0134: FE 02           CP      $02
0136: DA 9C 01        JP      C,$019C             ; a game is already in play, suppress the action
...
loc_0142:
0142: 3A 48 80        LD      A,($8048)           ; {ram.variant} read the variant override
0145: B7              OR      A
0146: 20 08           JR      NZ,$0150            ; variant set, service the start slots
0148: 3A 01 80        LD      A,($8001)           ; {ram.gameState} read the game mode
014B: 3D              DEC     A
014C: FE 02           CP      $02
014E: 38 4C           JR      C,$019C             ; a game is in play, do not service start slots

loc_0150:
0150: 3A 4C 80        LD      A,($804C)           ; {ram.coinsPerCreditA} read start-slot 1's coins-per-credit cost
0153: 57              LD      D,A
0154: 1E 01           LD      E,$01               ; select player 1 as the starting mode
0156: 21 04 80        LD      HL,$8004            ; {ram.start1SwAccum} point at the start-1 detector
0159: CB 51           BIT     2,C                 ; test the start-slot-1 switch line
015B: 20 04           JR      NZ,$0161            ; line asserted, check for a completed pulse
015D: 36 AA           LD      (HL),$AA            ; idle, arm the start-1 detector
015F: 18 07           JR      $0168               ; move on to start slot 2
...
0166: 28 18           JR      Z,$0180             ; completed pulse, try to pay for a 1-player start

loc_0168:
0168: 3A 4D 80        LD      A,($804D)           ; {ram.coinsPerCreditB} read start-slot 2's coins-per-credit cost
016B: 57              LD      D,A
016C: 1E 02           LD      E,$02               ; select player 2 as the starting mode
016E: 21 05 80        LD      HL,$8005            ; {ram.start2SwAccum} point at the start-2 detector
0171: CB 49           BIT     1,C                 ; test the start-slot-2 switch line
0173: 20 04           JR      NZ,$0179            ; line asserted, check for a completed pulse
0175: 36 AA           LD      (HL),$AA            ; idle, arm the start-2 detector
0177: 18 23           JR      $019C               ; no start this frame, re-arm and return
...
017E: 20 1C           JR      NZ,$019C            ; no completed pulse, re-arm and return

loc_0180:
0180: 3A 00 80        LD      A,($8000)           ; {ram.creditCount} read the banked credit count
0183: 92              SUB     D                   ; deduct the coins-per-credit cost
0184: 38 16           JR      C,$019C             ; not enough credits banked, re-arm and return
0186: 32 00 80        LD      ($8000),A           ; {ram.creditCount} store the reduced credit count
0189: 32 1C 80        LD      ($801C),A           ; {ram.creditMirrorA} update the first redundant copy
018C: 32 2C 81        LD      ($812C),A           ; {ram.creditMirrorB} update the second redundant copy
018F: 7B              LD      A,E
0190: 32 01 80        LD      ($8001),A           ; {ram.gameState} record the chosen player count as the game mode
0193: 32 1D 80        LD      ($801D),A           ; mirror the game mode
0196: 32 2D 81        LD      ($812D),A           ; mirror the game mode again
0199: C3 2D 02        JP      $022D               ; {code.startGame} start a fresh game

loc_019c:
019C: 3E 01           LD      A,$01
019E: 32 00 B0        LD      ($B000),A           ; {hard.mainLatch} re-arm the interrupt for the next frame
...
01AD: 3E 00           LD      A,$00
01AF: 32 00 80        LD      ($8000),A           ; {ram.creditCount} clear the credit count
01B2: 32 1C 80        LD      ($801C),A           ; {ram.creditMirrorA} clear the first redundant credit copy
01B5: 32 2C 81        LD      ($812C),A           ; {ram.creditMirrorB} clear the second redundant credit copy
01B8: 32 01 80        LD      ($8001),A           ; {ram.gameState} clear the game mode
01BB: 3E 06           LD      A,$06
01BD: 32 15 80        LD      ($8015),A           ; {ram.in1Debounced} seed the coin/start debounce latch
01C0: 32 16 80        LD      ($8016),A           ; {ram.in1Prev} seed the coin/start rolling sample
01C3: 3E 55           LD      A,$55
01C5: 32 04 80        LD      ($8004),A           ; {ram.start1SwAccum} idle the start-1 detector
01C8: 32 05 80        LD      ($8005),A           ; {ram.start2SwAccum} idle the start-2 detector
01CB: 07              RLCA                        ; rotate the idle pattern for the coin line
01CC: 32 03 80        LD      ($8003),A           ; {ram.coinSwAccum} idle the coin detector
...
01E1: 3E 01           LD      A,$01
01E3: 32 02 80        LD      ($8002),A           ; {ram.activePlayer} arm the secondary game-state byte
01E6: CD 55 4B        CALL    $4B55               ; {code.applyDipSwitches} decode the cabinet dip switches
01E9: 01 00 00        LD      BC,$0000

loc_01ec:
01EC: 10 FE           DJNZ    $01EC               ; burn a long start-up settle delay
01EE: 0D              DEC     C
01EF: 20 FB           JR      NZ,$01EC            ; keep settling until the delay expires
...
01FF: 3E 01           LD      A,$01
0201: 32 02 80        LD      ($8002),A           ; {ram.activePlayer} arm the secondary game-state byte
0204: CD 55 4B        CALL    $4B55               ; {code.applyDipSwitches} commit the cabinet dip settings
0207: 3A 00 80        LD      A,($8000)           ; {ram.creditCount} read the banked credit count
020A: B7              OR      A
...
0211: 3E 00           LD      A,$00
0213: 32 01 80        LD      ($8001),A           ; {ram.gameState} clear the game mode
...
showCreditScreen:
021C: 3E 03           LD      A,$03
021E: 32 01 80        LD      ($8001),A           ; {ram.gameState} arm the credit-standby game mode
...
0230: 3E 00           LD      A,$00
0232: 32 48 80        LD      ($8048),A           ; {ram.variant} clear the round-variant selector
...
0247: 3A 4E 80        LD      A,($804E)           ; {ram.loopDelayBase} read the loop-pacing base
024A: 32 11 80        LD      ($8011),A           ; {ram.mainLoopDelay} seed the main-loop pacing delay
024D: 3E 01           LD      A,$01
024F: 32 28 80        LD      ($8028),A           ; {ram.level} start at level 1
0252: 3A 53 80        LD      A,($8053)           ; {ram.startingMen} read the starting-lives dip value
0255: 32 2B 80        LD      ($802B),A           ; {ram.menLeft} seed the men-left count
0258: 3E 01           LD      A,$01
025A: 32 02 80        LD      ($8002),A           ; {ram.activePlayer} select player 1's record
025D: CD 32 46        CALL    $4632               ; {code.saveActivePlayerRecord} prime player 1's saved record
0260: 3E 02           LD      A,$02
0262: 32 02 80        LD      ($8002),A           ; {ram.activePlayer} select player 2's record
0265: CD 32 46        CALL    $4632               ; {code.saveActivePlayerRecord} prime player 2's saved record
0268: 3A 01 80        LD      A,($8001)           ; {ram.gameState} read the chosen starting player
026B: 32 02 80        LD      ($8002),A           ; {ram.activePlayer} select the starting player's record
026E: CD 44 46        CALL    $4644               ; {code.loadPlayerState} load the starting player into the live slot
0271: 3A 2B 80        LD      A,($802B)           ; {ram.menLeft} read the men-left count
0274: 3C              INC     A                   ; count the man about to play
0275: 32 2B 80        LD      ($802B),A           ; {ram.menLeft} store the men-left total
...
0278: 3A 01 80        LD      A,($8001)           ; {ram.gameState} read the game mode
027B: FE 03           CP      $03
027D: D2 AC 03        JP      NC,$03AC            ; {code.resetStateAndShowSetup} no live round, hand off to the reset epilogue
0280: 3A 2B 80        LD      A,($802B)           ; {ram.menLeft} read the active player's men-left count
0283: 3D              DEC     A                   ; dock one man, the death path
0284: 32 2B 80        LD      ($802B),A           ; {ram.menLeft} store the reduced men-left count
0287: CD 32 46        CALL    $4632               ; {code.saveActivePlayerRecord} persist the player's record so progress survives
028A: 3A 01 80        LD      A,($8001)           ; {ram.gameState} read the game mode again
028D: 3D              DEC     A
028E: 20 11           JR      NZ,$02A1            ; {code.stepRoundSubPhaseAndBranch} second leg, defer to the phase sequencer
0290: 32 2D 80        LD      ($802D),A           ; clear the other player's backup man count
0293: 3C              INC     A
0294: 32 02 80        LD      ($8002),A           ; {ram.activePlayer} select player 1
0297: 3A 2C 80        LD      A,($802C)           ; read this player's reserve man count
029A: A7              AND     A
...
02A1: 3A 02 80        LD      A,($8002)           ; {ram.activePlayer} read the round sub-phase
02A4: FE 01           CP      $01
02A6: 20 0B           JR      NZ,$02B3            ; not sub-phase 1, take the reset arm
02A8: 3C              INC     A
02A9: 32 02 80        LD      ($8002),A           ; {ram.activePlayer} advance the sub-phase to 2
02AC: 3A 2D 80        LD      A,($802D)           ; read the advance-select flag
02AF: A7              AND     A
02B0: C2 CA 02        JP      NZ,$02CA            ; {code.setUpRoundAndHoldIntro} flag set, go straight to round setup

loc_02b3:
02B3: 3E 01           LD      A,$01
02B5: 32 02 80        LD      ($8002),A           ; {ram.activePlayer} reset the sub-phase to 1
02B8: 3A 2C 80        LD      A,($802C)           ; read the reset-select flag
02BB: A7              AND     A
02BC: 20 0C           JR      NZ,$02CA            ; {code.setUpRoundAndHoldIntro} flag set, route to round setup
02BE: 3E 02           LD      A,$02
02C0: 32 02 80        LD      ($8002),A           ; {ram.activePlayer} advance the sub-phase to 2
02C3: 3A 2D 80        LD      A,($802D)           ; read the advance-select flag
02C6: A7              AND     A
...
02D9: 3E 08           LD      A,$08
02DB: 32 0A 80        LD      ($800A),A           ; {ram.loopCounter} arm the intro for eight passes
...
02F1: 3A 0A 80        LD      A,($800A)           ; {ram.loopCounter} read the intro pass count
02F4: 3D              DEC     A                   ; count down one intro pass
02F5: 32 0A 80        LD      ($800A),A           ; {ram.loopCounter} store the pass count
...
advanceToNextLevel:
02FD: 3A 01 80        LD      A,($8001)           ; {ram.gameState} read the game mode
0300: FE 03           CP      $03
0302: D2 AC 03        JP      NC,$03AC            ; {code.resetStateAndShowSetup} no live game, hand off to the reset epilogue
0305: 3A 28 80        LD      A,($8028)           ; {ram.level} read the level counter
0308: 3C              INC     A                   ; count this level cleared
0309: 32 28 80        LD      ($8028),A           ; {ram.level} store the higher level
...
0323: 3A 01 80        LD      A,($8001)           ; {ram.gameState} read the game mode
0326: 3D              DEC     A
0327: FE 02           CP      $02
...
0335: 3A 28 80        LD      A,($8028)           ; {ram.level} read the current level
0338: 47              LD      B,A
0339: 3A 4E 80        LD      A,($804E)           ; {ram.loopDelayBase} read the pacing base
033C: 90              SUB     B                   ; subtract the level so higher levels pace faster
033D: 32 11 80        LD      ($8011),A           ; {ram.mainLoopDelay} store the main-loop idle delay
0340: 3E 00           LD      A,$00
0342: 32 20 80        LD      ($8020),A           ; {ram.soundRing} clear the first sound slot
0345: 32 10 80        LD      ($8010),A           ; {ram.playPhaseCounter} clear the play-phase counter
...
034B: 3A 00 B8        LD      A,($B800)           ; {hard.watchdog} pet the watchdog so the board does not reset
034E: CD 14 4B        CALL    $4B14               ; {code.enableNmi} re-arm the vblank interrupt for the frame
0351: 3A 01 80        LD      A,($8001)           ; {ram.gameState} read the game mode
0354: FE 04           CP      $04
...
0365: 3A 11 80        LD      A,($8011)           ; {ram.mainLoopDelay} read the level-scaled frame delay
0368: 06 00           LD      B,$00

loc_036a:
036A: 10 FE           DJNZ    $036A               ; burn the inner pacing delay
036C: 3D              DEC     A
036D: 20 FB           JR      NZ,$036A            ; keep pacing until the delay expires
...
0377: 3A 01 80        LD      A,($8001)           ; {ram.gameState} read the player-count byte
037A: 3D              DEC     A
037B: FE 02           CP      $02
...
0389: 3E 01           LD      A,$01
038B: 32 02 80        LD      ($8002),A           ; {ram.activePlayer} select player 1 to finish first
038E: CD BF 4C        CALL    $4CBF               ; {code.submitPlayerHighScore} offer player 1's score to the table
0391: 3A 48 80        LD      A,($8048)           ; {ram.variant} read the rank the score placed at
0394: B7              OR      A
0395: C4 F8 4D        CALL    NZ,$4DF8            ; {code.runHighScoreInitialsEntry} if it placed, run initials entry
0398: 3A 01 80        LD      A,($8001)           ; {ram.gameState} read the player-count byte
039B: 32 02 80        LD      ($8002),A           ; {ram.activePlayer} select player 2
039E: FE 02           CP      $02
...
03A5: 3A 48 80        LD      A,($8048)           ; {ram.variant} read the rank the score placed at
03A8: B7              OR      A
...
03AC: 3E 00           LD      A,$00
03AE: 32 01 80        LD      ($8001),A           ; {ram.gameState} clear the game mode for a fresh attract pass
03B1: 3C              INC     A
03B2: 32 02 80        LD      ($8002),A           ; {ram.activePlayer} no active player, arm the secondary state
...
enterPlayMode:
03BE: 3E 04           LD      A,$04
03C0: 32 01 80        LD      ($8001),A           ; {ram.gameState} flip the game mode to active play
03C3: 3E 01           LD      A,$01
03C5: 32 1B 80        LD      ($801B),A           ; {ram.demoSteerDir} seed the demo's starting steering heading
03C8: 32 02 80        LD      ($8002),A           ; {ram.activePlayer} arm the secondary game-state byte
03CB: 3E 03           LD      A,$03
03CD: 32 29 80        LD      ($8029),A           ; seed the demo to run at level 3
...
03D6: 3E 0C           LD      A,$0C
03D8: 32 4E 80        LD      ($804E),A           ; {ram.loopDelayBase} set the loop-pacing base
03DB: 3E 01           LD      A,$01
03DD: 32 0B 80        LD      ($800B),A           ; seed the gameplay-tick countdown
03E0: 3E 00           LD      A,$00
03E2: 32 0C 80        LD      ($800C),A           ; reset the gameplay-tick phase index
...
steerDemoPlayer:
03E8: 3A 10 80        LD      A,($8010)           ; {ram.playPhaseCounter} read the free-running frame counter
03EB: A7              AND     A
03EC: CC 94 48        CALL    Z,$4894             ; {code.drawCreditsDisplay} on wrap to zero, repaint the hud panel
03EF: 3A 0B 80        LD      A,($800B)           ; read the 30-frame service countdown
03F2: 3D              DEC     A                   ; tick it down one frame
03F3: 32 0B 80        LD      ($800B),A           ; store the countdown
03F6: 20 11           JR      NZ,$0409            ; not yet, skip the periodic chores
03F8: 3E 1E           LD      A,$1E
03FA: 32 0B 80        LD      ($800B),A           ; reload the 30-frame countdown
03FD: 3A 7C 80        LD      A,($807C)           ; {ram.transitionTimer} read the object's state-lockout timer
0400: A7              AND     A
0401: C0              RET     NZ                  ; object mid-sequence, give up the frame
0402: 3A 7B 80        LD      A,($807B)           ; {ram.boardEndPhase} read the board-end phase
0405: A7              AND     A
0406: CC C4 48        CALL    Z,$48C4             ; {code.cyclePanelColumnColour} not mid-spawn, step one column's color

loc_0409:
0409: 3A 79 80        LD      A,($8079)           ; {ram.playerActive} is the tracked object live this frame?
040C: A7              AND     A
040D: C8              RET     Z                   ; no live object, leave the last move standing
040E: 3A 68 80        LD      A,($8068)           ; {ram.playerY} read the object's Y position
0411: C6 03           ADD     A,$03               ; offset to the probe point inside its box
0413: 47              LD      B,A
0414: 3A 6B 80        LD      A,($806B)           ; {ram.playerX} read the object's X position
0417: C6 05           ADD     A,$05               ; offset to the probe point inside its box
0419: 4F              LD      C,A
041A: 3A 0C 80        LD      A,($800C)           ; read the cached maze-band hint
041D: FE 07           CP      $07
041F: 38 17           JR      C,$0438             ; hint in the top band, scan it
0421: FE 0A           CP      $0A
0423: DA EE 04        JP      C,$04EE             ; hint in band 7, scan there
0426: FE 0E           CP      $0E
0428: DA 1D 05        JP      C,$051D             ; hint in band 10, scan there
042B: FE 17           CP      $17
042D: DA 5A 05        JP      C,$055A             ; hint in band 14, scan there
0430: FE 1E           CP      $1E
0432: DA DD 05        JP      C,$05DD             ; hint in band 23, scan there
0435: C3 40 06        JP      $0640               ; hint in the last band, scan there

loc_0438:
0438: 3E 30           LD      A,$30               ; wall line at 0x30
043A: B8              CP      B
043B: 20 09           JR      NZ,$0446
043D: 3E 37           LD      A,$37               ; split at 0x37
043F: B9              CP      C
0440: D2 69 06        JP      NC,$0669            ; steer dir 4
0443: C3 65 06        JP      $0665               ; else steer dir 2

loc_0446:
0446: 3E 38           LD      A,$38               ; wall line at 0x38
0448: B9              CP      C
0449: 20 09           JR      NZ,$0454
044B: 3E 57           LD      A,$57               ; split at 0x57
044D: B8              CP      B
044E: D2 65 06        JP      NC,$0665            ; steer dir 2
0451: C3 69 06        JP      $0669               ; else steer dir 4

loc_0454:
0454: 3E 58           LD      A,$58               ; wall line at 0x58
0456: B8              CP      B
0457: 20 09           JR      NZ,$0462
0459: 3E 3F           LD      A,$3F               ; split at 0x3f
045B: B9              CP      C
045C: D2 69 06        JP      NC,$0669            ; steer dir 4
045F: C3 65 06        JP      $0665               ; else steer dir 2

loc_0462:
0462: 3E 40           LD      A,$40               ; wall line at 0x40
0464: B9              CP      C
0465: 20 09           JR      NZ,$0470
0467: 3E 67           LD      A,$67               ; split at 0x67
0469: B8              CP      B
046A: D2 65 06        JP      NC,$0665            ; steer dir 2
046D: C3 69 06        JP      $0669               ; else steer dir 4

loc_0470:
0470: 3E 68           LD      A,$68               ; wall line at 0x68
0472: B8              CP      B
0473: 20 09           JR      NZ,$047E
0475: 3E 53           LD      A,$53               ; split at 0x53
0477: B9              CP      C
0478: D2 69 06        JP      NC,$0669            ; steer dir 4
047B: C3 65 06        JP      $0665               ; else steer dir 2

loc_047e:
047E: 3E 54           LD      A,$54               ; wall line at 0x54
0480: B9              CP      C
0481: 20 09           JR      NZ,$048C
0483: 3E 8F           LD      A,$8F               ; split at 0x8f
0485: B8              CP      B
0486: D2 65 06        JP      NC,$0665            ; steer dir 2
0489: C3 69 06        JP      $0669               ; else steer dir 4

loc_048c:
048C: 3E 90           LD      A,$90               ; wall line at 0x90
048E: B8              CP      B
048F: 20 09           JR      NZ,$049A
0491: 3E 7F           LD      A,$7F               ; split at 0x7f
0493: B9              CP      C
0494: D2 69 06        JP      NC,$0669            ; steer dir 4
0497: C3 65 06        JP      $0665               ; else steer dir 2

loc_049a:
049A: 3E 80           LD      A,$80               ; wall line at 0x80
049C: B9              CP      C
049D: 20 09           JR      NZ,$04A8
049F: 3E BF           LD      A,$BF               ; split at 0xbf
04A1: B8              CP      B
04A2: D2 65 06        JP      NC,$0665            ; steer dir 2
04A5: C3 69 06        JP      $0669               ; else steer dir 4

loc_04a8:
04A8: 3E C0           LD      A,$C0               ; wall line at 0xc0
04AA: B8              CP      B
04AB: 20 09           JR      NZ,$04B6
04AD: 3E 9F           LD      A,$9F               ; split at 0x9f
04AF: B9              CP      C
04B0: D2 69 06        JP      NC,$0669            ; steer dir 4
04B3: C3 65 06        JP      $0665               ; else steer dir 2

loc_04b6:
04B6: 3E A0           LD      A,$A0               ; wall line at 0xa0
04B8: B9              CP      C
04B9: 20 09           JR      NZ,$04C4
04BB: 3E C7           LD      A,$C7               ; split at 0xc7
04BD: B8              CP      B
04BE: D2 65 06        JP      NC,$0665            ; steer dir 2
04C1: C3 69 06        JP      $0669               ; else steer dir 4

loc_04c4:
04C4: 3E C8           LD      A,$C8               ; wall line at 0xc8
04C6: B8              CP      B
04C7: 20 09           JR      NZ,$04D2
04C9: 3E BF           LD      A,$BF               ; split at 0xbf
04CB: B9              CP      C
04CC: D2 69 06        JP      NC,$0669            ; steer dir 4
04CF: C3 65 06        JP      $0665               ; else steer dir 2

loc_04d2:
04D2: 3E C0           LD      A,$C0               ; wall line at 0xc0
04D4: B9              CP      C
04D5: 20 09           JR      NZ,$04E0
04D7: 3E DF           LD      A,$DF               ; split at 0xdf
04D9: B8              CP      B
04DA: D2 65 06        JP      NC,$0665            ; steer dir 2
04DD: C3 69 06        JP      $0669               ; else steer dir 4

loc_04e0:
04E0: 3E E0           LD      A,$E0               ; wall line at 0xe0, bottom of the top band
04E2: B8              CP      B
04E3: 20 09           JR      NZ,$04EE            ; no top-band wall matched, fall into band 7
04E5: 3E D7           LD      A,$D7               ; split at 0xd7
04E7: B9              CP      C
04E8: D2 69 06        JP      NC,$0669            ; steer dir 4
04EB: C3 61 06        JP      $0661               ; else steer dir 1
...
04F5: B9              CP      C
04F6: 20 09           JR      NZ,$0501
04F8: 3E B0           LD      A,$B0               ; split at 0xb0
04FA: B8              CP      B
04FB: DA 61 06        JP      C,$0661             ; steer dir 1
04FE: C3 69 06        JP      $0669               ; else steer dir 4

loc_0501:
0501: 3E B0           LD      A,$B0               ; wall line at 0xb0
0503: B8              CP      B
0504: 20 09           JR      NZ,$050F
0506: 3E E7           LD      A,$E7               ; split at 0xe7
0508: B9              CP      C
0509: D2 69 06        JP      NC,$0669            ; steer dir 4
050C: C3 61 06        JP      $0661               ; else steer dir 1

loc_050f:
050F: 3E E8           LD      A,$E8               ; wall line at 0xe8
0511: B9              CP      C
0512: 20 09           JR      NZ,$051D            ; no band-7 wall matched, fall into band 10
0514: 3E A8           LD      A,$A8               ; split at 0xa8
0516: B8              CP      B
0517: DA 61 06        JP      C,$0661             ; steer dir 1
051A: C3 6D 06        JP      $066D               ; else steer dir 8
...
0524: B8              CP      B
0525: 20 09           JR      NZ,$0530
0527: 3E D8           LD      A,$D8               ; split at 0xd8
0529: B9              CP      C
052A: DA 6D 06        JP      C,$066D             ; steer dir 8
052D: C3 61 06        JP      $0661               ; else steer dir 1

loc_0530:
0530: 3E D8           LD      A,$D8               ; wall line at 0xd8
0532: B9              CP      C
0533: 20 09           JR      NZ,$053E
0535: 3E 48           LD      A,$48               ; split at 0x48
0537: B8              CP      B
0538: DA 61 06        JP      C,$0661             ; steer dir 1
053B: C3 69 06        JP      $0669               ; else steer dir 4

loc_053e:
053E: 3E 48           LD      A,$48               ; wall line at 0x48
0540: B8              CP      B
0541: 20 09           JR      NZ,$054C
0543: 3E DF           LD      A,$DF               ; split at 0xdf
0545: B9              CP      C
0546: D2 69 06        JP      NC,$0669            ; steer dir 4
0549: C3 61 06        JP      $0661               ; else steer dir 1

loc_054c:
054C: 3E E0           LD      A,$E0               ; wall line at 0xe0
054E: B9              CP      C
054F: 20 09           JR      NZ,$055A            ; no band-10 wall matched, fall into band 14
0551: 3E 18           LD      A,$18               ; split at 0x18
0553: B8              CP      B
0554: DA 61 06        JP      C,$0661             ; steer dir 1
0557: C3 6D 06        JP      $066D               ; else steer dir 8
...
0561: B8              CP      B
0562: 20 09           JR      NZ,$056D
0564: 3E C0           LD      A,$C0               ; split at 0xc0
0566: B9              CP      C
0567: DA 6D 06        JP      C,$066D             ; steer dir 8
056A: C3 65 06        JP      $0665               ; else steer dir 2

loc_056d:
056D: 3E C0           LD      A,$C0               ; wall line at 0xc0
056F: B9              CP      C
0570: 20 09           JR      NZ,$057B
0572: 3E 2F           LD      A,$2F               ; split at 0x2f
0574: B8              CP      B
0575: D2 65 06        JP      NC,$0665            ; steer dir 2
0578: C3 6D 06        JP      $066D               ; else steer dir 8

loc_057b:
057B: 3E 30           LD      A,$30               ; wall line at 0x30
057D: B8              CP      B
057E: 20 09           JR      NZ,$0589
0580: 3E A8           LD      A,$A8               ; split at 0xa8
0582: B9              CP      C
0583: DA 6D 06        JP      C,$066D             ; steer dir 8
0586: C3 65 06        JP      $0665               ; else steer dir 2

loc_0589:
0589: 3E A8           LD      A,$A8               ; wall line at 0xa8
058B: B9              CP      C
058C: 20 09           JR      NZ,$0597
058E: 3E 47           LD      A,$47               ; split at 0x47
0590: B8              CP      B
0591: D2 65 06        JP      NC,$0665            ; steer dir 2
0594: C3 6D 06        JP      $066D               ; else steer dir 8

loc_0597:
0597: 3E 48           LD      A,$48               ; wall line at 0x48
0599: B8              CP      B
059A: 20 09           JR      NZ,$05A5
059C: 3E A0           LD      A,$A0               ; split at 0xa0
059E: B9              CP      C
059F: DA 6D 06        JP      C,$066D             ; steer dir 8
05A2: C3 65 06        JP      $0665               ; else steer dir 2

loc_05a5:
05A5: 3E A0           LD      A,$A0               ; wall line at 0xa0
05A7: B9              CP      C
05A8: 20 09           JR      NZ,$05B3
05AA: 3E 57           LD      A,$57               ; split at 0x57
05AC: B8              CP      B
05AD: D2 65 06        JP      NC,$0665            ; steer dir 2
05B0: C3 6D 06        JP      $066D               ; else steer dir 8

loc_05b3:
05B3: 3E 58           LD      A,$58               ; wall line at 0x58
05B5: B8              CP      B
05B6: 20 09           JR      NZ,$05C1
05B8: 3E 80           LD      A,$80               ; split at 0x80
05BA: B9              CP      C
05BB: DA 6D 06        JP      C,$066D             ; steer dir 8
05BE: C3 65 06        JP      $0665               ; else steer dir 2

loc_05c1:
05C1: 3E 80           LD      A,$80               ; wall line at 0x80
05C3: B9              CP      C
05C4: 20 09           JR      NZ,$05CF
05C6: 3E 5F           LD      A,$5F               ; split at 0x5f
05C8: B8              CP      B
05C9: D2 65 06        JP      NC,$0665            ; steer dir 2
05CC: C3 6D 06        JP      $066D               ; else steer dir 8

loc_05cf:
05CF: 3E 60           LD      A,$60               ; wall line at 0x60
05D1: B8              CP      B
05D2: 20 09           JR      NZ,$05DD            ; no band-14 wall matched, fall into band 23
05D4: 3E 6C           LD      A,$6C               ; split at 0x6c
05D6: B9              CP      C
05D7: DA 6D 06        JP      C,$066D             ; steer dir 8
05DA: C3 61 06        JP      $0661               ; else steer dir 1
...
05E4: B9              CP      C
05E5: 20 09           JR      NZ,$05F0
05E7: 3E 58           LD      A,$58               ; split at 0x58
05E9: B8              CP      B
05EA: DA 61 06        JP      C,$0661             ; steer dir 1
05ED: C3 6D 06        JP      $066D               ; else steer dir 8

loc_05f0:
05F0: 3E 58           LD      A,$58               ; wall line at 0x58
05F2: B8              CP      B
05F3: 20 09           JR      NZ,$05FE
05F5: 3E 5C           LD      A,$5C               ; split at 0x5c
05F7: B9              CP      C
05F8: DA 6D 06        JP      C,$066D             ; steer dir 8
05FB: C3 61 06        JP      $0661               ; else steer dir 1

loc_05fe:
05FE: 3E 5C           LD      A,$5C               ; wall line at 0x5c
0600: B9              CP      C
0601: 20 09           JR      NZ,$060C
0603: 3E 50           LD      A,$50               ; split at 0x50
0605: B8              CP      B
0606: DA 61 06        JP      C,$0661             ; steer dir 1
0609: C3 6D 06        JP      $066D               ; else steer dir 8

loc_060c:
060C: 3E 50           LD      A,$50               ; wall line at 0x50
060E: B8              CP      B
060F: 20 09           JR      NZ,$061A
0611: 3E 58           LD      A,$58               ; split at 0x58
0613: B9              CP      C
0614: DA 6D 06        JP      C,$066D             ; steer dir 8
0617: C3 61 06        JP      $0661               ; else steer dir 1

loc_061a:
061A: 3E 58           LD      A,$58               ; wall line at 0x58
061C: B9              CP      C
061D: 20 09           JR      NZ,$0628
061F: 3E 28           LD      A,$28               ; split at 0x28
0621: B8              CP      B
0622: DA 61 06        JP      C,$0661             ; steer dir 1
0625: C3 6D 06        JP      $066D               ; else steer dir 8

loc_0628:
0628: 3E 28           LD      A,$28               ; wall line at 0x28
062A: B8              CP      B
062B: 20 07           JR      NZ,$0634
062D: 3E 48           LD      A,$48               ; split at 0x48
062F: B9              CP      C
0630: 38 3B           JR      C,$066D             ; steer dir 8
0632: 18 2D           JR      $0661               ; else steer dir 1

loc_0634:
0634: 3E 48           LD      A,$48               ; wall line at 0x48
0636: B9              CP      C
0637: 20 07           JR      NZ,$0640            ; no band-23 wall matched, fall into band 30
0639: 3E 18           LD      A,$18               ; split at 0x18
063B: B8              CP      B
063C: 38 23           JR      C,$0661             ; steer dir 1
063E: 18 2D           JR      $066D               ; else steer dir 8
...
0647: B8              CP      B
0648: 20 07           JR      NZ,$0651
064A: 3E 38           LD      A,$38               ; split at 0x38
064C: B9              CP      C
064D: 38 1E           JR      C,$066D             ; steer dir 8
064F: 18 14           JR      $0665               ; else steer dir 2
...
0658: B8              CP      B
0659: 30 0A           JR      NC,$0665            ; steer dir 2

loc_065b:
065B: 18 10           JR      $066D               ; last band always resolves, steer dir 8
...
loc_066f:
066F: 32 1B 80        LD      ($801B),A           ; {ram.demoSteerDir} hand the move to the mover as the demo joystick
...
0678: 11 00 90        LD      DE,$9000            ; {hard.videoRam} target the tilemap the display reads
067B: 21 62 07        LD      HL,$0762            ; default to the first tile image
067E: 3A 28 80        LD      A,($8028)           ; {ram.level} read the display-mode byte
0681: CB 47           BIT     0,A                 ; test which screen variant to paint
0683: 20 03           JR      NZ,$0688            ; mode bit set, keep the first tile image
...
06A6: 3E 01           LD      A,$01
06A8: 32 5C 80        LD      ($805C),A           ; {ram.glitterCountdown} arm the gem-glitter counter
06AB: C9              RET
...
1362: 3E 00           LD      A,$00
1364: 32 68 80        LD      ($8068),A           ; {ram.playerY} reset the explorer to its start spot
1367: 3E 23           LD      A,$23
1369: 32 6B 80        LD      ($806B),A           ; {ram.playerX} set the explorer's start column
136C: 3E 19           LD      A,$19
136E: 32 73 80        LD      ($8073),A           ; {ram.playerTileRow} start tile row near the top
1371: 3E 05           LD      A,$05
1373: 32 71 80        LD      ($8071),A           ; {ram.playerTileCol} start tile column
1376: 3E 02           LD      A,$02
1378: 32 6A 80        LD      ($806A),A           ; {ram.playerSpriteAttr} default explorer sprite
137B: 3E 01           LD      A,$01
137D: 32 6C 80        LD      ($806C),A           ; {ram.playerStepY} seed the vertical step pacing
1380: 32 6D 80        LD      ($806D),A           ; {ram.playerStepX} seed the horizontal step pacing
1383: 3E 32           LD      A,$32
1385: 32 69 80        LD      ($8069),A           ; {ram.playerFacing} default facing sprite
1388: 3E 01           LD      A,$01
138A: 32 70 80        LD      ($8070),A           ; seed a pacing counter
138D: 3E 00           LD      A,$00
138F: 32 1A 80        LD      ($801A),A           ; {ram.playerAnimPhase} clear the walk animation phase
1392: 32 75 80        LD      ($8075),A           ; clear the motion marker
1395: 32 A2 80        LD      ($80A2),A           ; {ram.reactionState} clear the collision reaction
1398: 32 A4 80        LD      ($80A4),A           ; {ram.reactionTimer} clear the reaction timer
139B: 32 A7 80        LD      ($80A7),A           ; {ram.expectedTile} clear the expected-tile scratch
139E: 32 A8 80        LD      ($80A8),A           ; {ram.nextTile} clear the tile-ahead scratch
13A1: 32 76 80        LD      ($8076),A           ; {ram.prizeGate} clear the prize gate
13A4: 32 77 80        LD      ($8077),A           ; {ram.pitCrossActive} clear the goal-cross flag
13A7: 32 78 80        LD      ($8078),A           ; {ram.treasureCollected} clear the treasure-collected flag
13AA: 32 7A 80        LD      ($807A),A           ; clear the busy-this-frame flag
13AD: 32 79 80        LD      ($8079),A           ; {ram.playerActive} explorer starts inactive until spawned
13B0: 32 7E 80        LD      ($807E),A           ; {ram.carveSeamLeft} clear the left dig-seam flag
13B3: 32 7F 80        LD      ($807F),A           ; {ram.carveSeamRight} clear the right dig-seam flag
13B6: 32 80 80        LD      ($8080),A           ; {ram.moveBlockFlag} clear the push-block flag
13B9: 32 7C 80        LD      ($807C),A           ; {ram.transitionTimer} clear the state-lockout timer
13BC: 32 7B 80        LD      ($807B),A           ; {ram.boardEndPhase} clear the board-end phase
13BF: 32 7D 80        LD      ($807D),A           ; {ram.postTransitionMode} clear the post-timer mode
13C2: 32 81 80        LD      ($8081),A           ; {ram.crystalCount} reset the crystal count
13C5: 32 82 80        LD      ($8082),A           ; {ram.diamondCount} reset the diamond count
13C8: C9              RET
...
13C9: 3A 7C 80        LD      A,($807C)           ; {ram.transitionTimer} read the state-lockout timer
13CC: A7              AND     A
...
13D0: 32 7C 80        LD      ($807C),A           ; {ram.transitionTimer} store the ticked timer
13D3: C0              RET     NZ                  ; still running, hold locked this frame
13D4: 3A 7D 80        LD      A,($807D)           ; {ram.postTransitionMode} expired, read the post-timer mode
13D7: A7              AND     A
...
13DE: 3A 7A 80        LD      A,($807A)           ; read the busy-this-frame flag
13E1: B7              OR      A
13E2: C2 5B 1B        JP      NZ,$1B5B            ; {code.stageObjectSpriteRecord} mid-work, restage its record and stop
13E5: 3A 79 80        LD      A,($8079)           ; {ram.playerActive} read the explorer-active flag
13E8: A7              AND     A
13E9: C8              RET     Z                   ; no live explorer, nothing to advance
13EA: 3A 7B 80        LD      A,($807B)           ; {ram.boardEndPhase} read the board-end phase
13ED: A7              AND     A
13EE: C0              RET     NZ                  ; board ending, skip the move
13EF: 3A 6C 80        LD      A,($806C)           ; {ram.playerStepY} load the vertical move delta
13F2: 5F              LD      E,A
13F3: 3A 6D 80        LD      A,($806D)           ; {ram.playerStepX} load the horizontal move delta
13F6: 57              LD      D,A
13F7: 3A C1 80        LD      A,($80C1)           ; {ram.digCollisionState} read the dig-collision state
13FA: 3D              DEC     A
...
1402: 3A 75 80        LD      A,($8075)           ; read the motion marker
1405: A7              AND     A
...
140C: 3A E7 80        LD      A,($80E7)           ; {ram.goalTileLatch} read the goal-reached latch
140F: A7              AND     A
1410: 28 0E           JR      Z,$1420             ; {code.stepObjectFromControl} goal not reached, step from control input
1412: 3A 77 80        LD      A,($8077)           ; {ram.pitCrossActive} goal crossing recorded
...
1419: 3A E6 80        LD      A,($80E6)           ; {ram.pitFloorRevealCursor} read the pit-floor reveal cursor
141C: A7              AND     A
...
1420: 3A A2 80        LD      A,($80A2)           ; {ram.reactionState} read the collision-reaction state
1423: A7              AND     A
1424: C2 5B 1B        JP      NZ,$1B5B            ; {code.stageObjectSpriteRecord} reaction owns the frame, defer the move
1427: 3A 01 80        LD      A,($8001)           ; {ram.gameState} read the game mode
142A: FE 03           CP      $03                 ; attract-demo mode or higher
142C: 3A 1B 80        LD      A,($801B)           ; {ram.demoSteerDir} load the demo steering
142F: 30 03           JR      NC,$1434            ; {code.advanceObjectFrame} in demo, steer from the demo stream
1431: 3A 18 80        LD      A,($8018)           ; {ram.in0Debounced} in play, read the debounced joystick

; Advance the player one animation frame.
advanceObjectFrame:
1434: 6F              LD      L,A                 ; hold the move command
1435: 3A 75 80        LD      A,($8075)           ; read the object mode byte
1438: A7              AND     A
...
145B: 32 1A 80        LD      ($801A),A           ; {ram.playerAnimPhase} standing still, reset the walk phase
145E: 3A E7 80        LD      A,($80E7)           ; {ram.goalTileLatch} read the goal-reached latch
1461: A7              AND     A
...
windUpObjectMove:
1468: 3A 1A 80        LD      A,($801A)           ; {ram.playerAnimPhase} read the wind-up phase byte
146B: BD              CP      L                   ; already settled on this command
146C: 28 1D           JR      Z,$148B             ; yes, dispatch the move now
146E: A7              AND     A
146F: 20 08           JR      NZ,$1479            ; nothing armed yet
1471: 7D              LD      A,L
1472: F6 C0           OR      $C0                 ; arm the wind-up high, keep the command
1474: 32 1A 80        LD      ($801A),A           ; {ram.playerAnimPhase} store the armed phase
1477: 18 12           JR      $148B               ; then dispatch the move

loc_1479:
1479: D6 20           SUB     $20                 ; step the wind-up down one notch
147B: 32 1A 80        LD      ($801A),A           ; {ram.playerAnimPhase} store the stepped phase
...
1484: 7D              LD      A,L
1485: 32 1A 80        LD      ($801A),A           ; {ram.playerAnimPhase} wind-up done, snap to the command
...
1493: 3A 7E 80        LD      A,($807E)           ; {ram.carveSeamLeft} read the busy/defer flag
1496: A7              AND     A
1497: C2 5B 1B        JP      NZ,$1B5B            ; {code.stageObjectSpriteRecord} held off, restage the record
149A: 3E B2           LD      A,$B2
149C: 32 69 80        LD      ($8069),A           ; {ram.playerFacing} force the step sprite
149F: 3A 68 80        LD      A,($8068)           ; {ram.playerY} read the explorer position
...
14AF: 32 73 80        LD      ($8073),A           ; {ram.playerTileRow} store the explorer tile row
14B2: 67              LD      H,A
14B3: FE 16           CP      $16                 ; is this the boundary row
14B5: 20 16           JR      NZ,$14CD            ; {code.locateObjectCellCheckGoal} no, locate the cell
14B7: 3A 76 80        LD      A,($8076)           ; {ram.prizeGate} boundary row, is the dig latch pending
14BA: B7              OR      A
14BB: 28 10           JR      Z,$14CD             ; {code.locateObjectCellCheckGoal} not pending, locate the cell
14BD: 3E 00           LD      A,$00
14BF: 32 76 80        LD      ($8076),A           ; {ram.prizeGate} consume the dig latch
14C2: 32 BD 80        LD      ($80BD),A           ; {ram.hazardActiveCount} clear the pending dig spawn
14C5: 3E 09           LD      A,$09
14C7: 32 AA 80        LD      ($80AA),A           ; {ram.hazardState} arm the dig target phase
...
14CD: 3A 6B 80        LD      A,($806B)           ; {ram.playerX} read the explorer column position
14D0: C6 05           ADD     A,$05               ; add the rounding bias
14D2: 57              LD      D,A
14D3: CB 3F           SRL     A                   ; reduce to the tile column
14D5: CB 3F           SRL     A
14D7: CB 3F           SRL     A
14D9: 32 71 80        LD      ($8071),A           ; {ram.playerTileCol} store the tile column
14DC: 4F              LD      C,A
14DD: 3E 00           LD      A,$00
14DF: 47              LD      B,A
...
14EB: 01 00 90        LD      BC,$9000            ; {hard.videoRam} tilemap base
14EE: 09              ADD     HL,BC               ; form the cell address
14EF: 22 6E 80        LD      ($806E),HL          ; {ram.playerCellPtr} store the explorer's cell pointer
14F2: DD 2A 6E 80     LD      IX,($806E)          ; {ram.playerCellPtr} point at that cell
14F6: 3E 00           LD      A,$00
14F8: 32 A8 80        LD      ($80A8),A           ; {ram.nextTile} clear the tile-ahead scratch
...
1502: 3A 68 80        LD      A,($8068)           ; {ram.playerY} read the explorer's cross-axis position
...
150B: 3C              INC     A
150C: 32 E7 80        LD      ($80E7),A           ; {ram.goalTileLatch} reached the goal, latch it
150F: 32 77 80        LD      ($8077),A           ; {ram.pitCrossActive} mark the goal crossing active
...
1518: 32 A5 80        LD      ($80A5),A           ; {ram.curTile} save it as the current tile
151B: 32 A7 80        LD      ($80A7),A           ; {ram.expectedTile} seed the expected tile
151E: 47              LD      B,A
151F: 7A              LD      A,D
...
1527: 20 0C           JR      NZ,$1535            ; no, check for diamond loot
1529: CD 7B 46        CALL    $467B               ; {code.awardTenPoints} score the crystal
152C: 3A 81 80        LD      A,($8081)           ; {ram.crystalCount} read the crystal count
152F: 3C              INC     A
1530: 32 81 80        LD      ($8081),A           ; {ram.crystalCount} count the crystal
1533: 18 27           JR      $155C               ; blank the cell and walk on

loc_1535:
1535: 78              LD      A,B
1536: FE 3B           CP      $3B                 ; diamond tile
1538: 28 08           JR      Z,$1542
153A: FE 3C           CP      $3C                 ; another diamond tile
153C: 28 04           JR      Z,$1542
153E: FE 3D           CP      $3D                 ; another diamond tile
1540: 20 26           JR      NZ,$1568            ; {code.resolveObjectTerrainStep} not loot, resolve the terrain

loc_1542:
1542: 3A 78 80        LD      A,($8078)           ; {ram.treasureCollected} read the diamond one-shot latch
1545: B7              OR      A
1546: 20 0A           JR      NZ,$1552            ; latch armed, always score
1548: 3A BD 80        LD      A,($80BD)           ; {ram.hazardActiveCount} a dig spawn is active
154B: B7              OR      A
154C: 20 1A           JR      NZ,$1568            ; {code.resolveObjectTerrainStep} blocked, resolve the terrain instead
154E: 3C              INC     A
154F: 32 78 80        LD      ($8078),A           ; {ram.treasureCollected} arm the diamond latch

loc_1552:
1552: CD 83 46        CALL    $4683               ; {code.awardTwentyPoints} score the diamond
1555: 3A 82 80        LD      A,($8082)           ; {ram.diamondCount} read the diamond count
1558: 3C              INC     A
1559: 32 82 80        LD      ($8082),A           ; {ram.diamondCount} count the diamond

loc_155c:
155C: DD 2A 6E 80     LD      IX,($806E)          ; {ram.playerCellPtr} point back at the collected cell
1560: 3E 70           LD      A,$70
...
156B: 20 03           JR      NZ,$1570
156D: 32 76 80        LD      ($8076),A           ; {ram.prizeGate} latch the prize gate

loc_1570:
1570: 78              LD      A,B
1571: FE 27           CP      $27                 ; sitting on the goal tile
1573: 20 03           JR      NZ,$1578
1575: 32 E7 80        LD      ($80E7),A           ; {ram.goalTileLatch} latch the goal
...
1593: 28 0D           JR      Z,$15A2             ; passable only when the offset bit is set
1595: FE 96           CP      $96
1597: 38 0E           JR      C,$15A7             ; below the solid band, keep testing
1599: FE 9A           CP      $9A
159B: DA 5B 1B        JP      C,$1B5B             ; {code.stageObjectSpriteRecord} solid band, hold
159E: FE 9E           CP      $9E
15A0: 30 43           JR      NC,$15E5            ; above the band, settle
...
loc_15a7:
15A7: FE 71           CP      $71
15A9: 38 3A           JR      C,$15E5             ; below the pushable band, settle
15AB: FE 9E           CP      $9E
15AD: 30 36           JR      NC,$15E5            ; above the pushable band, settle
15AF: 5F              LD      E,A
...
15C7: 32 A7 80        LD      ($80A7),A           ; {ram.expectedTile} save the expected tile
15CA: BB              CP      E                   ; does the terrain match expected
15CB: 28 18           JR      Z,$15E5             ; match, settle
15CD: 7A              LD      A,D
15CE: E6 07           AND     $07                 ; is the step grid-aligned
15D0: 20 18           JR      NZ,$15EA            ; off-grid, look at the tile ahead
15D2: 3A A3 80        LD      A,($80A3)           ; aligned, a pushable block met head-on
15D5: 32 A4 80        LD      ($80A4),A           ; {ram.reactionTimer} load the push-reaction timer
15D8: 3E 01           LD      A,$01
15DA: 32 A2 80        LD      ($80A2),A           ; {ram.reactionState} arm the push reaction
15DD: 3E B5           LD      A,$B5
15DF: 32 69 80        LD      ($8069),A           ; {ram.playerFacing} show the push sprite
...
15ED: 32 A6 80        LD      ($80A6),A           ; save the raw ahead tile
...
1601: 28 0D           JR      Z,$1610
1603: FE 95           CP      $95                 ; solid ahead
1605: CA 5B 1B        JP      Z,$1B5B             ; {code.stageObjectSpriteRecord} hold in place
1608: FE 96           CP      $96
160A: 38 0A           JR      C,$1616             ; below the band, keep testing ahead
160C: FE 9A           CP      $9A
160E: 30 3F           JR      NC,$164F            ; above the band, settle on the under tile
...
loc_1616:
1616: FE 71           CP      $71
1618: 38 35           JR      C,$164F             ; below the pushable band, settle on under
161A: FE 9E           CP      $9E
161C: 30 31           JR      NC,$164F            ; above the pushable band, settle on under
161E: 5F              LD      E,A
...
1636: 32 A8 80        LD      ($80A8),A           ; {ram.nextTile} save the tile-ahead expectation
1639: BB              CP      E                   ; does the ahead tile match expected
163A: 28 13           JR      Z,$164F             ; match, settle on the under tile

loc_163c:
163C: 3A A3 80        LD      A,($80A3)           ; mismatch, a pushable block ahead
163F: 32 A4 80        LD      ($80A4),A           ; {ram.reactionTimer} load the push-reaction timer
1642: 3E 01           LD      A,$01
1644: 32 A2 80        LD      ($80A2),A           ; {ram.reactionState} arm the push reaction
1647: 3E B5           LD      A,$B5
1649: 32 69 80        LD      ($8069),A           ; {ram.playerFacing} show the push sprite
164C: C3 5B 1B        JP      $1B5B               ; {code.stageObjectSpriteRecord} restage the record

loc_164f:
164F: 3A A5 80        LD      A,($80A5)           ; {ram.curTile} read the saved current tile
1652: 5F              LD      E,A
1653: 3A A7 80        LD      A,($80A7)           ; {ram.expectedTile} read the expected under tile
1656: BB              CP      E                   ; did the terrain change beneath it
1657: 20 E3           JR      NZ,$163C            ; yes, arm the push, else walk on

; Advance the player's walk animation frame.
advanceObjectWalkFrame:
1659: 3A 6C 80        LD      A,($806C)           ; {ram.playerStepY} read the moving reference point
165C: 5F              LD      E,A
165D: 3A 68 80        LD      A,($8068)           ; {ram.playerY} read the explorer position
1660: 93              SUB     E                   ; offset from the reference
1661: 32 68 80        LD      ($8068),A           ; {ram.playerY} store the new offset
1664: C6 03           ADD     A,$03               ; add the walk rounding bias
1666: E6 07           AND     $07                 ; the eight-step walk phase
1668: 5F              LD      E,A
1669: 28 02           JR      Z,$166D             ; phase 0 is the rest point
166B: 3E FF           LD      A,$FF               ; in motion, set the marker

loc_166d:
166D: 32 75 80        LD      ($8075),A           ; store the motion marker
1670: 7B              LD      A,E
1671: E6 02           AND     $02                 ; which half of the walk
1673: 3E B2           LD      A,$B2               ; even walk sprite
1675: 28 02           JR      Z,$1679
1677: 3E B3           LD      A,$B3               ; odd walk sprite

loc_1679:
1679: 32 69 80        LD      ($8069),A           ; {ram.playerFacing} set the walk sprite frame
...
167F: 3A 7F 80        LD      A,($807F)           ; {ram.carveSeamRight} read the overlap/defer flag
1682: A7              AND     A
1683: C2 5B 1B        JP      NZ,$1B5B            ; {code.stageObjectSpriteRecord} held off, restage the record
1686: 3E 32           LD      A,$32
1688: 32 69 80        LD      ($8069),A           ; {ram.playerFacing} pre-load the step sprite
168B: 3A 68 80        LD      A,($8068)           ; {ram.playerY} read the explorer position
...
169B: 32 73 80        LD      ($8073),A           ; {ram.playerTileRow} store the explorer tile row
169E: 67              LD      H,A
169F: FE 07           CP      $07                 ; is this the trigger row
16A1: 20 16           JR      NZ,$16B9            ; {code.locateActorCellCheckGoal} no, route the horizontal step
16A3: 3A 76 80        LD      A,($8076)           ; {ram.prizeGate} trigger row, is the dig latch pending
16A6: B7              OR      A
16A7: 28 10           JR      Z,$16B9             ; {code.locateActorCellCheckGoal} not pending, route the step
16A9: 3E 00           LD      A,$00
16AB: 32 76 80        LD      ($8076),A           ; {ram.prizeGate} consume the dig latch
16AE: 32 BD 80        LD      ($80BD),A           ; {ram.hazardActiveCount} clear the pending dig spawn
16B1: 3E 09           LD      A,$09
16B3: 32 AA 80        LD      ($80AA),A           ; {ram.hazardState} arm the dig target phase
...
16B9: 3A E7 80        LD      A,($80E7)           ; {ram.goalTileLatch} read the goal-reached latch
16BC: A7              AND     A
16BD: 28 05           JR      Z,$16C4             ; not latched, locate the cell
16BF: 7D              LD      A,L
16C0: FE 17           CP      $17                 ; sprite says already on the goal
16C2: 28 37           JR      Z,$16FB             ; yes, latch the crossing

loc_16c4:
16C4: 3A 6B 80        LD      A,($806B)           ; {ram.playerX} read the explorer column position
16C7: C6 05           ADD     A,$05               ; add the rounding bias
16C9: 57              LD      D,A
16CA: CB 3F           SRL     A                   ; reduce to the tile column
16CC: CB 3F           SRL     A
16CE: CB 3F           SRL     A
16D0: 32 71 80        LD      ($8071),A           ; {ram.playerTileCol} store the tile column
16D3: 4F              LD      C,A
16D4: 3E 00           LD      A,$00
16D6: 47              LD      B,A
...
16E2: 01 00 90        LD      BC,$9000            ; {hard.videoRam} tilemap base
16E5: 09              ADD     HL,BC               ; form the cell address
16E6: 22 6E 80        LD      ($806E),HL          ; {ram.playerCellPtr} store the explorer's cell pointer
16E9: DD 2A 6E 80     LD      IX,($806E)          ; {ram.playerCellPtr} point at that cell
16ED: DD 7E 01        LD      A,(IX+$01)          ; peek the cell one step ahead
16F0: FE 27           CP      $27                 ; is it the goal tile
16F2: 28 07           JR      Z,$16FB             ; yes, latch the crossing
...
loc_16fb:
16FB: 32 E7 80        LD      ($80E7),A           ; {ram.goalTileLatch} latch the goal
16FE: 32 77 80        LD      ($8077),A           ; {ram.pitCrossActive} mark the goal crossing active
...
1704: 3E 00           LD      A,$00
1706: 32 A8 80        LD      ($80A8),A           ; {ram.nextTile} clear the tile-ahead slot
1709: DD 7E 00        LD      A,(IX+$00)          ; read the tile the actor steps onto
170C: 32 A5 80        LD      ($80A5),A           ; {ram.curTile} publish it as the current tile
170F: 32 A7 80        LD      ($80A7),A           ; {ram.expectedTile} save a second copy of that tile
1712: 47              LD      B,A
1713: 7A              LD      A,D
1714: E6 07           AND     $07                 ; isolate the sub-cell grid alignment
1716: 20 43           JR      NZ,$175B            ; off the grid -> skip loot, classify terrain
1718: 78              LD      A,B
1719: FE 3A           CP      $3A                 ; tile 58 = a 10-point crystal?
171B: 20 0C           JR      NZ,$1729            ; not a crystal -> check diamonds
171D: CD 7B 46        CALL    $467B               ; {code.awardTenPoints} award 10 points and its sound
1720: 3A 81 80        LD      A,($8081)           ; {ram.crystalCount} read the crystal pickup count
1723: 3C              INC     A                   ; bump it
1724: 32 81 80        LD      ($8081),A           ; {ram.crystalCount} store the crystal count
1727: 18 26           JR      $174F               ; blank the cell and walk on

loc_1729:
1729: FE 3B           CP      $3B                 ; tile 59 = a 20-point diamond?
172B: 28 08           JR      Z,$1735             ; yes -> the diamond band
172D: FE 3C           CP      $3C                 ; tile 60 = diamond?
172F: 28 04           JR      Z,$1735             ; yes -> the diamond band
1731: FE 3D           CP      $3D                 ; tile 61 = diamond?
1733: 20 26           JR      NZ,$175B            ; not loot -> classify terrain

loc_1735:
1735: 3A 78 80        LD      A,($8078)           ; {ram.treasureCollected} read the diamond-award latch
1738: B7              OR      A
1739: 20 0A           JR      NZ,$1745            ; latch already open -> award
173B: 3A BD 80        LD      A,($80BD)           ; {ram.hazardActiveCount} read the spawn-in-progress guard
173E: B7              OR      A
173F: 20 1A           JR      NZ,$175B            ; guard set this frame -> classify instead
1741: 3C              INC     A
1742: 32 78 80        LD      ($8078),A           ; {ram.treasureCollected} first open: arm the diamond latch

loc_1745:
1745: CD 83 46        CALL    $4683               ; {code.awardTwentyPoints} award 20 points and its sound
1748: 3A 82 80        LD      A,($8082)           ; {ram.diamondCount} read the diamond pickup count
174B: 3C              INC     A                   ; bump it
174C: 32 82 80        LD      ($8082),A           ; {ram.diamondCount} store the diamond count

loc_174f:
174F: DD 2A 6E 80     LD      IX,($806E)          ; {ram.playerCellPtr} point at the actor's cell
1753: 3E 70           LD      A,$70
...
175E: 20 03           JR      NZ,$1763
1760: 32 76 80        LD      ($8076),A           ; {ram.prizeGate} latch it so the diamond gate opens next frame
...
1784: 28 0D           JR      Z,$1793             ; yes -> test the diagonal bit
1786: FE 96           CP      $96                 ; below tile 150?
1788: 38 0E           JR      C,$1798             ; yes -> walkable-band check
...
1791: 30 43           JR      NC,$17D6            ; 158+ passable -> tile-ahead phase
...
179A: 38 3A           JR      C,$17D6             ; below the band -> tile-ahead phase
179C: FE 9E           CP      $9E                 ; tile 158?
179E: 30 36           JR      NC,$17D6            ; above the band -> tile-ahead phase
17A0: 5F              LD      E,A
...
17B8: 32 A7 80        LD      ($80A7),A           ; {ram.expectedTile} publish the expected tile
17BB: BB              CP      E                   ; does it match the actual tile?
17BC: 28 18           JR      Z,$17D6             ; match -> tile-ahead phase
17BE: 7A              LD      A,D
17BF: E6 07           AND     $07                 ; on a grid step?
17C1: 20 18           JR      NZ,$17DB            ; off grid -> carry the mismatch forward
17C3: 3A A3 80        LD      A,($80A3)           ; load the reaction period
17C6: 32 A4 80        LD      ($80A4),A           ; {ram.reactionTimer} arm the bump-reaction timer
17C9: 3E 02           LD      A,$02
17CB: 32 A2 80        LD      ($80A2),A           ; {ram.reactionState} set the bump reaction
17CE: 3E 35           LD      A,$35
17D0: 32 69 80        LD      ($8069),A           ; {ram.playerFacing} show the bump-reaction sprite
...
17DE: 32 A6 80        LD      ($80A6),A           ; record the raw tile ahead
...
17F2: 28 0D           JR      Z,$1801             ; yes -> step heading, test bit 2
17F4: FE 95           CP      $95                 ; tile 149 solid ahead?
17F6: CA 5B 1B        JP      Z,$1B5B             ; {code.stageObjectSpriteRecord} hold
17F9: FE 96           CP      $96                 ; tile 150?
17FB: 38 0A           JR      C,$1807             ; below 150 -> tile-ahead table check
17FD: FE 9A           CP      $9A                 ; tile 154?
17FF: 30 3F           JR      NC,$1840            ; 154+ passable ahead -> final check
...
1809: 38 35           JR      C,$1840             ; below band -> final check
180B: FE 9E           CP      $9E                 ; tile 158?
180D: 30 31           JR      NC,$1840            ; above band -> final check
180F: 5F              LD      E,A
...
1827: 32 A8 80        LD      ($80A8),A           ; {ram.nextTile} publish the tile-ahead expectation
182A: BB              CP      E                   ; does it match the actual tile ahead?
182B: 28 13           JR      Z,$1840             ; match -> final check

loc_182d:
182D: 3A A3 80        LD      A,($80A3)           ; load the reaction period
1830: 32 A4 80        LD      ($80A4),A           ; {ram.reactionTimer} arm the bump-reaction timer
1833: 3E 02           LD      A,$02
1835: 32 A2 80        LD      ($80A2),A           ; {ram.reactionState} set the bump reaction
1838: 3E 35           LD      A,$35
183A: 32 69 80        LD      ($8069),A           ; {ram.playerFacing} show the bump-reaction sprite
183D: C3 5B 1B        JP      $1B5B               ; {code.stageObjectSpriteRecord} hold and rebuild the record

loc_1840:
1840: 3A A5 80        LD      A,($80A5)           ; {ram.curTile} reload the actual current tile
1843: 5F              LD      E,A
1844: 3A A7 80        LD      A,($80A7)           ; {ram.expectedTile} reload the expected-tile scratch
1847: BB              CP      E                   ; did the current-tile check leave a mismatch?
1848: 20 E3           JR      NZ,$182D            ; mismatch -> bump-react instead of walking

; Commit the player's per-frame walk step.
walkActor:
184A: 3A 6C 80        LD      A,($806C)           ; {ram.playerStepY} read the per-frame walk step
184D: 5F              LD      E,A
184E: 3A 68 80        LD      A,($8068)           ; {ram.playerY} read the walk position accumulator
1851: 83              ADD     A,E                 ; advance it by the step
1852: 32 68 80        LD      ($8068),A           ; {ram.playerY} store the advanced position (wraps in a byte)
1855: C6 03           ADD     A,$03               ; bias the position by 3
1857: E6 07           AND     $07                 ; take the low-3-bit walk phase
1859: 32 75 80        LD      ($8075),A           ; store the walk phase
185C: E6 02           AND     $02                 ; test the phase bit that alternates frames
185E: 3E 32           LD      A,$32               ; first walk frame
1860: 28 02           JR      Z,$1864             ; first half of the stride -> keep it
1862: 3E 33           LD      A,$33               ; second walk frame

loc_1864:
1864: 32 69 80        LD      ($8069),A           ; {ram.playerFacing} commit the two-frame walk sprite
...
186A: 3E 34           LD      A,$34
186C: 32 69 80        LD      ($8069),A           ; {ram.playerFacing} stamp the default animation frame

; Resolve the tile under the player.
resolveObjectTile:
186F: 3A 68 80        LD      A,($8068)           ; {ram.playerY} read the object's vertical position
...
187E: 32 73 80        LD      ($8073),A           ; {ram.playerTileRow} store the map row
1881: 67              LD      H,A
1882: 3A 6B 80        LD      A,($806B)           ; {ram.playerX} read the object's horizontal position
...
188B: CB 3F           SRL     A
188D: CB 3F           SRL     A
188F: 32 71 80        LD      ($8071),A           ; {ram.playerTileCol} store the map column
1892: 4F              LD      C,A
1893: 3E 00           LD      A,$00
1895: 47              LD      B,A
1896: CB 3C           SRL     H
...
189F: 6F              LD      L,A
18A0: 09              ADD     HL,BC
18A1: 01 00 90        LD      BC,$9000            ; {hard.videoRam} write into video RAM (tilemap)
18A4: 09              ADD     HL,BC               ; form the cell's video address
18A5: 22 6E 80        LD      ($806E),HL          ; {ram.playerCellPtr} publish the cell pointer
18A8: DD 2A 6E 80     LD      IX,($806E)          ; {ram.playerCellPtr}
18AC: 3E 00           LD      A,$00
18AE: 32 A8 80        LD      ($80A8),A           ; {ram.nextTile} clear the tile-ahead slot
18B1: DD 7E 00        LD      A,(IX+$00)          ; read the tile under the object
18B4: 32 A5 80        LD      ($80A5),A           ; {ram.curTile} publish it as the current tile
18B7: 32 A7 80        LD      ($80A7),A           ; {ram.expectedTile} save a second copy
18BA: 47              LD      B,A
18BB: FE 27           CP      $27                 ; tile 39 = the goal ship tile?
18BD: 20 10           JR      NZ,$18CF            ; {code.collectLootTile} not the goal -> collect or dig
18BF: 32 E7 80        LD      ($80E7),A           ; {ram.goalTileLatch} latch that the goal was reached
18C2: 3A 6B 80        LD      A,($806B)           ; {ram.playerX} read the horizontal position
...
18C9: 32 77 80        LD      ($8077),A           ; {ram.pitCrossActive} record where the actor crossed
...
18D8: 20 0C           JR      NZ,$18E6            ; no -> check diamonds
18DA: CD 7B 46        CALL    $467B               ; {code.awardTenPoints} award 10 points and its sound
18DD: 3A 81 80        LD      A,($8081)           ; {ram.crystalCount} read the crystal count
18E0: 3C              INC     A                   ; bump it
18E1: 32 81 80        LD      ($8081),A           ; {ram.crystalCount} store the crystal count
18E4: 18 2D           JR      $1913               ; blank the cell and keep moving

loc_18e6:
18E6: 3A 76 80        LD      A,($8076)           ; {ram.prizeGate} read the diamond-feature enable
18E9: A7              AND     A
18EA: 28 33           JR      Z,$191F             ; {code.triggerDigReaction} diamond feature off -> dig-arm
18EC: 78              LD      A,B
18ED: FE 3B           CP      $3B                 ; tile 59 = a diamond?
18EF: 28 08           JR      Z,$18F9             ; yes -> the diamond award
18F1: FE 3C           CP      $3C                 ; tile 60 = diamond?
18F3: 28 04           JR      Z,$18F9             ; yes -> the diamond award
18F5: FE 3D           CP      $3D                 ; tile 61 = diamond?
18F7: 20 26           JR      NZ,$191F            ; {code.triggerDigReaction} not a diamond -> dig-arm

loc_18f9:
18F9: 3A 78 80        LD      A,($8078)           ; {ram.treasureCollected} read the diamond-award latch
18FC: B7              OR      A
18FD: 20 0A           JR      NZ,$1909            ; latch open -> award
18FF: 3A BD 80        LD      A,($80BD)           ; {ram.hazardActiveCount} read the spawn-in-progress guard
1902: B7              OR      A
1903: 20 1A           JR      NZ,$191F            ; {code.triggerDigReaction} guard set -> defer to the dig-arm
1905: 3C              INC     A
1906: 32 78 80        LD      ($8078),A           ; {ram.treasureCollected} first open: arm the diamond latch

loc_1909:
1909: CD 83 46        CALL    $4683               ; {code.awardTwentyPoints} award 20 points and its sound
190C: 3A 82 80        LD      A,($8082)           ; {ram.diamondCount} read the diamond count
190F: 3C              INC     A                   ; bump it
1910: 32 82 80        LD      ($8082),A           ; {ram.diamondCount} store the diamond count

loc_1913:
1913: DD 2A 6E 80     LD      IX,($806E)          ; {ram.playerCellPtr} point at the actor's cell
1917: 3E 70           LD      A,$70
...
1922: 38 05           JR      C,$1929             ; below 54 -> classify
...
192B: CA B9 19        JP      Z,$19B9             ; arm the reaction
192E: FE 2B           CP      $2B                 ; tile 43?
1930: CA B9 19        JP      Z,$19B9             ; arm the reaction
1933: FE 41           CP      $41                 ; tile 65?
1935: CA B9 19        JP      Z,$19B9             ; arm the reaction
1938: FE C1           CP      $C1                 ; tile 193?
193A: CA B9 19        JP      Z,$19B9             ; arm the reaction
193D: FE 95           CP      $95                 ; tile 149?
193F: CA B9 19        JP      Z,$19B9             ; arm the reaction
1942: FE C4           CP      $C4                 ; tile 196 = conditional hit?
1944: 28 09           JR      Z,$194F             ; yes -> test the bit-2 gate
1946: FE 96           CP      $96                 ; tile 150?
1948: 38 0A           JR      C,$1954             ; below 150 -> diggable test
...
1951: C2 B9 19        JP      NZ,$19B9            ; gate open -> arm the reaction
...
1976: 32 A7 80        LD      ($80A7),A           ; {ram.expectedTile} record the expected tile
1979: BA              CP      D                   ; matches the actual tile?
197A: 28 54           JR      Z,$19D0             ; {code.advanceActorWalk} match -> nothing carved, keep moving
197C: 3A A3 80        LD      A,($80A3)           ; load the reaction period
197F: 32 A4 80        LD      ($80A4),A           ; {ram.reactionTimer} reload the carve-reaction timer
1982: 3E 03           LD      A,$03
1984: 32 A2 80        LD      ($80A2),A           ; {ram.reactionState} set the dig reaction
1987: 3E 36           LD      A,$36
1989: 32 69 80        LD      ($8069),A           ; {ram.playerFacing} show the carve sprite
198C: 7B              LD      A,E
198D: E6 07           AND     $07                 ; exactly on a cell boundary?
198F: 28 28           JR      Z,$19B9             ; boundary -> no adjacent cell, arm reaction
1991: DD 7E 01        LD      A,(IX+$01)          ; read the adjacent cell's tile
1994: 32 A6 80        LD      ($80A6),A           ; record the adjacent tile
1997: FE 71           CP      $71                 ; adjacent tile diggable?
1999: 38 1E           JR      C,$19B9             ; no -> arm the reaction
199B: FE 9A           CP      $9A                 ; tile 154?
199D: 30 1A           JR      NC,$19B9            ; above diggable -> arm the reaction
...
19B6: 32 A8 80        LD      ($80A8),A           ; {ram.nextTile} record the tile-ahead expectation

loc_19b9:
19B9: 3A C1 80        LD      A,($80C1)           ; {ram.digCollisionState} read the actor's dig-arm state
19BC: A7              AND     A
19BD: CA 5B 1B        JP      Z,$1B5B             ; {code.stageObjectSpriteRecord} not armed -> just build the record
19C0: 3E 02           LD      A,$02
19C2: 32 C1 80        LD      ($80C1),A           ; {ram.digCollisionState} advance the dig-collision state
19C5: 3E 40           LD      A,$40
19C7: 32 B1 80        LD      ($80B1),A           ; {ram.digObjTimer} arm the dig timer
...
advanceActorWalk:
19D0: 3A 6D 80        LD      A,($806D)           ; {ram.playerStepX} read the per-frame horizontal step
19D3: 5F              LD      E,A
19D4: 3A 6B 80        LD      A,($806B)           ; {ram.playerX} read the horizontal position
19D7: 83              ADD     A,E                 ; advance it by the step
19D8: 32 6B 80        LD      ($806B),A           ; {ram.playerX} store the advanced position (wraps in a byte)
...
drawActorWalkFrame:
19E3: 32 69 80        LD      ($8069),A           ; {ram.playerFacing} commit the walk frame
19E6: 3A 77 80        LD      A,($8077)           ; {ram.pitCrossActive} read the goal-crossing latch
19E9: A7              AND     A
19EA: CA 5B 1B        JP      Z,$1B5B             ; {code.stageObjectSpriteRecord} not crossing -> build the record
19ED: 3A 6B 80        LD      A,($806B)           ; {ram.playerX} read the horizontal position
...
19F5: 3E B4           LD      A,$B4
19F7: 32 7C 80        LD      ($807C),A           ; {ram.transitionTimer} arm the state-lockout timer
19FA: 3E 00           LD      A,$00
19FC: 32 68 80        LD      ($8068),A           ; {ram.playerY} reset the vertical coordinate after crossing
...
1A02: 3A 80 80        LD      A,($8080)           ; {ram.moveBlockFlag} read the climb blocker flag
1A05: A7              AND     A
1A06: C2 5B 1B        JP      NZ,$1B5B            ; {code.stageObjectSpriteRecord} blocked by a falling hazard -> defer the frame
1A09: 3E B4           LD      A,$B4
1A0B: 32 69 80        LD      ($8069),A           ; {ram.playerFacing} set the default climb sprite
1A0E: 3A 68 80        LD      A,($8068)           ; {ram.playerY} read the vertical position
...
1A1D: 32 73 80        LD      ($8073),A           ; {ram.playerTileRow} store the map row
1A20: 67              LD      H,A
1A21: 3A 6B 80        LD      A,($806B)           ; {ram.playerX} read the climb-axis position
1A24: FE 23           CP      $23                 ; top-rung column (35)?
1A26: 20 0F           JR      NZ,$1A37            ; not at the top -> continue
1A28: 3A 78 80        LD      A,($8078)           ; {ram.treasureCollected} read whether a diamond is in hand
1A2B: A7              AND     A
1A2C: CA 5B 1B        JP      Z,$1B5B             ; {code.stageObjectSpriteRecord} no diamond yet -> defer the frame
1A2F: 3E 01           LD      A,$01
1A31: 32 7B 80        LD      ($807B),A           ; {ram.boardEndPhase} at the top rung with a diamond -> board complete
1A34: C3 5B 1B        JP      $1B5B               ; {code.stageObjectSpriteRecord} defer this frame

loc_1a37:
1A37: FE 53           CP      $53                 ; below the crossing column (83)?
1A39: 30 08           JR      NC,$1A43            ; above it -> continue
1A3B: 3E 00           LD      A,$00
1A3D: 32 E7 80        LD      ($80E7),A           ; {ram.goalTileLatch} retreated below crossing -> clear the goal latch
1A40: 3A 6B 80        LD      A,($806B)           ; {ram.playerX} reload the climb position
...
1A49: CB 3F           SRL     A
1A4B: CB 3F           SRL     A
1A4D: 32 71 80        LD      ($8071),A           ; {ram.playerTileCol} store the map column
1A50: 4F              LD      C,A
1A51: 3E 00           LD      A,$00
1A53: 47              LD      B,A
1A54: CB 3C           SRL     H
...
1A5D: 6F              LD      L,A
1A5E: 09              ADD     HL,BC
1A5F: 01 00 90        LD      BC,$9000            ; {hard.videoRam} tile-map base
1A62: 09              ADD     HL,BC               ; form the cell's video address
1A63: 22 6E 80        LD      ($806E),HL          ; {ram.playerCellPtr} publish the cell pointer
1A66: DD 2A 6E 80     LD      IX,($806E)          ; {ram.playerCellPtr}
1A6A: 3E 00           LD      A,$00
1A6C: 32 A8 80        LD      ($80A8),A           ; {ram.nextTile} clear the tile-ahead slot
1A6F: DD 7E 00        LD      A,(IX+$00)          ; read the tile under the object
1A72: 32 A5 80        LD      ($80A5),A           ; {ram.curTile} publish it as the current tile
1A75: 32 A7 80        LD      ($80A7),A           ; {ram.expectedTile} save a second copy
1A78: 47              LD      B,A
1A79: 7B              LD      A,E
1A7A: E6 07           AND     $07                 ; at a cell boundary?
1A7C: 20 36           JR      NZ,$1AB4            ; off the boundary -> classify terrain
1A7E: 78              LD      A,B
1A7F: FE 3A           CP      $3A                 ; tile 58 = a 10-point crystal?
1A81: 20 0C           JR      NZ,$1A8F            ; no -> check diamonds
1A83: CD 7B 46        CALL    $467B               ; {code.awardTenPoints} award 10 points and its sound
1A86: 3A 81 80        LD      A,($8081)           ; {ram.crystalCount} read the crystal count
1A89: 3C              INC     A
1A8A: 32 81 80        LD      ($8081),A           ; {ram.crystalCount} store the bumped crystal count
1A8D: 18 19           JR      $1AA8               ; blank the cell and step down

loc_1a8f:
1A8F: FE 3B           CP      $3B                 ; tile 59 = a diamond?
1A91: 28 08           JR      Z,$1A9B             ; yes -> collect the diamond
1A93: FE 3C           CP      $3C                 ; tile 60 = diamond?
1A95: 28 04           JR      Z,$1A9B             ; yes -> collect the diamond
1A97: FE 3D           CP      $3D                 ; tile 61 = diamond?
1A99: 20 19           JR      NZ,$1AB4            ; not loot -> classify terrain

loc_1a9b:
1A9B: 32 78 80        LD      ($8078),A           ; {ram.treasureCollected} record the diamond code (grants board-complete)
1A9E: CD 83 46        CALL    $4683               ; {code.awardTwentyPoints} award 20 points and its sound
1AA1: 3A 82 80        LD      A,($8082)           ; {ram.diamondCount} read the diamond count
1AA4: 3C              INC     A
1AA5: 32 82 80        LD      ($8082),A           ; {ram.diamondCount} store the bumped diamond count

loc_1aa8:
1AA8: DD 2A 6E 80     LD      IX,($806E)          ; {ram.playerCellPtr}
1AAC: 3E 70           LD      A,$70
1AAE: DD 77 00        LD      (IX+$00),A          ; blank the collected cell
1AB1: C3 45 1B        JP      $1B45               ; step down and build the record
...
1AC6: 28 0D           JR      Z,$1AD5             ; yes -> test the phase gate
1AC8: FE 95           CP      $95                 ; tile 149?
1ACA: 38 10           JR      C,$1ADC             ; below 149 -> diggable test
...
1AFE: 32 A7 80        LD      ($80A7),A           ; {ram.expectedTile} record the expected terrain
1B01: BA              CP      D                   ; matches the actual tile?
1B02: 28 41           JR      Z,$1B45             ; match -> pass through, step down
1B04: 3A A3 80        LD      A,($80A3)           ; load the reaction period
1B07: 32 A4 80        LD      ($80A4),A           ; {ram.reactionTimer} reload the carve-reaction timer
1B0A: 3E 04           LD      A,$04
1B0C: 32 A2 80        LD      ($80A2),A           ; {ram.reactionState} set the carve reaction
1B0F: 3E F6           LD      A,$F6
1B11: 32 69 80        LD      ($8069),A           ; {ram.playerFacing} show the carve sprite
1B14: 7B              LD      A,E
1B15: 3C              INC     A
...
1B1D: 32 A6 80        LD      ($80A6),A           ; record the adjacent tile
...
1B40: 32 A8 80        LD      ($80A8),A           ; {ram.nextTile} record the tile-ahead expectation
1B43: 18 16           JR      $1B5B               ; {code.stageObjectSpriteRecord} build the display record

loc_1b45:
1B45: 3A 6D 80        LD      A,($806D)           ; {ram.playerStepX} read the per-step climb delta
1B48: 57              LD      D,A
1B49: 3A 6B 80        LD      A,($806B)           ; {ram.playerX} read the climb-axis position
1B4C: 92              SUB     D                   ; step one row along the column
1B4D: 32 6B 80        LD      ($806B),A           ; {ram.playerX} store the stepped position
1B50: E6 02           AND     $02                 ; test bit 1 to alternate the walk frame
1B52: 3E B4           LD      A,$B4               ; walk frame
1B54: 28 02           JR      Z,$1B58             ; even -> keep this frame
1B56: 3E 34           LD      A,$34               ; alternate walk frame

loc_1b58:
1B58: 32 69 80        LD      ($8069),A           ; {ram.playerFacing} commit the walk sprite

; Stage the player's sprite record into the sprite-staging buffer.
stageObjectSpriteRecord:
1B5B: 21 20 82        LD      HL,$8220            ; {ram.spriteStagingBase} point at the object's 4-byte sprite record slot
1B5E: 3A 51 80        LD      A,($8051)           ; {ram.spriteCoordBias} load the coordinate end-bias from the parameter block
1B61: 47              LD      B,A
1B62: 3A 68 80        LD      A,($8068)           ; {ram.playerY} read the object's Y coordinate
1B65: 90              SUB     B                   ; subtract bias for the leading record byte
1B66: 77              LD      (HL),A              ; store the biased leading byte into the record
1B67: 23              INC     HL
1B68: 3A 69 80        LD      A,($8069)           ; {ram.playerFacing} read the object's sprite/animation code
1B6B: 77              LD      (HL),A              ; store the sprite code into the record
1B6C: 23              INC     HL
1B6D: 3A 6A 80        LD      A,($806A)           ; {ram.playerSpriteAttr} read the object's attribute byte
1B70: 77              LD      (HL),A              ; store the attribute into the record
1B71: 23              INC     HL
1B72: 3A 6B 80        LD      A,($806B)           ; {ram.playerX} read the object's X coordinate
...
seedMountainErosion:
23E8: 21 04 91        LD      HL,$9104            ; {hard.videoRam} write into video RAM (tilemap)
23EB: 22 65 80        LD      ($8065),HL          ; {ram.mountainErodePtr} seed the mountain-erosion write cursor into the tilemap
23EE: 3A 28 80        LD      A,($8028)           ; {ram.level} read the current level
23F1: CB 27           SLA     A
23F3: CB 27           SLA     A                   ; level times four so erosion speeds up per level
23F5: 47              LD      B,A
23F6: 3A 4F 80        LD      A,($804F)           ; {ram.stepTimerBase} read the base erosion step delay
23F9: 90              SUB     B                   ; subtract four per level so erosion runs faster each level
23FA: 32 67 80        LD      ($8067),A           ; {ram.mountainErodeTimer} seed the erosion step countdown
23FD: DD 21 64 92     LD      IX,$9264            ; {hard.videoRam} point at the erosion marker cell
...
2409: DD 21 E4 90     LD      IX,$90E4            ; {hard.videoRam} point at the mountain head cell
...
erodeMountain:
241C: 3A 10 80        LD      A,($8010)           ; {ram.playPhaseCounter} read the round-startup frame ramp
241F: FE 0A           CP      $0A                 ; erosion stays dormant below frame 10
2421: D8              RET     C                   ; wait until the ramp passes 10
2422: 3A 67 80        LD      A,($8067)           ; {ram.mountainErodeTimer} read the erosion step countdown
2425: 3D              DEC     A                   ; tick the countdown
2426: 28 04           JR      Z,$242C             ; run a step only on the final tick
2428: 32 67 80        LD      ($8067),A           ; {ram.mountainErodeTimer} store the decremented countdown
242B: C0              RET     NZ                  ; wait for the next frame

loc_242c:
242C: CD 8B 4C        CALL    $4C8B               ; {code.requestSound15} cue the erosion step sound
242F: DD 2A 65 80     LD      IX,($8065)          ; {ram.mountainErodePtr} load the erosion write cursor
2433: DD 7E E0        LD      A,(IX-$20)          ; read the cell one row above the cursor
2436: FE AE           CP      $AE
2438: 20 0A           JR      NZ,$2444            ; cell above is not the marker - clear it instead
...
244B: FE 24           CP      $24
244D: 28 44           JR      Z,$2493             ; empty tile - extend the fill column down
244F: FE 33           CP      $33
2451: 28 40           JR      Z,$2493             ; solid-edge tile - extend the fill column down
2453: FE 32           CP      $32
2455: 28 3C           JR      Z,$2493             ; trigger tile - extend the fill column down
2457: FE 30           CP      $30
2459: 28 07           JR      Z,$2462             ; wall tile - handle the wall case
...
2465: FE 24           CP      $24
2467: 28 11           JR      Z,$247A             ; left cell already empty - check the column below
...
247D: FE 24           CP      $24
247F: 28 12           JR      Z,$2493             ; still open below - keep extending the fill down
2481: DD 7E 40        LD      A,(IX+$40)          ; read two rows below the cursor
2484: FE 24           CP      $24
2486: 28 0B           JR      Z,$2493             ; still open - keep extending the fill down
...
loc_2493:
2493: 2A 65 80        LD      HL,($8065)          ; {ram.mountainErodePtr} reload the erosion write cursor
2496: 11 C0 93        LD      DE,$93C0            ; {hard.videoRam} load the bottom-row boundary cell
2499: 7A              LD      A,D
249A: BC              CP      H
...
24A2: 22 65 80        LD      ($8065),HL          ; {ram.mountainErodePtr} store the advanced cursor
24A5: 11 A4 92        LD      DE,$92A4            ; {hard.videoRam} load the spawn trigger cell address
24A8: 7B              LD      A,E
24A9: BD              CP      L
24AA: C0              RET     NZ                  ; not the trigger cell - wait for the next frame
24AB: 7A              LD      A,D
24AC: BC              CP      H
24AD: 28 01           JR      Z,$24B0             ; trigger cell reached - finalise the spawn
24AF: C9              RET

loc_24b0:
24B0: 3A 7B 80        LD      A,($807B)           ; {ram.boardEndPhase} read the board-end spawn phase
24B3: A7              AND     A
24B4: 28 11           JR      Z,$24C7             ; phase 0 - mark the spawn reached
24B6: FE 02           CP      $02
24B8: D0              RET     NC                  ; already past the first phase - nothing to do
24B9: 3A 0D 81        LD      A,($810D)           ; {ram.enemy3Y} read enemy-3 rescue-ship height
24BC: FE 17           CP      $17
24BE: D8              RET     C                   ; enemy-3 not sunk far enough yet
24BF: 3E 16           LD      A,$16
24C1: 32 0D 81        LD      ($810D),A           ; {ram.enemy3Y} re-top enemy-3 / the rescue ship
24C4: 32 1E 81        LD      ($811E),A           ; {ram.enemy3TwinY} re-top its twin mirror

loc_24c7:
24C7: 3E 02           LD      A,$02
24C9: 32 7B 80        LD      ($807B),A           ; {ram.boardEndPhase} mark the mountain-gone spawn phase reached
24CC: C3 6B 4C        JP      $4C6B               ; {code.requestSound7} cue the finalise / rescue sound

; Reset the shared reaction / laser sprite slot.
resetReactionState:
24CF: 3E 03           LD      A,$03
24D1: 32 96 80        LD      ($8096),A           ; {ram.reactionObjAttr} seed the reaction sprite attribute
24D4: 3E 00           LD      A,$00
24D6: 32 94 80        LD      ($8094),A           ; {ram.reactionObjX} clear the reaction object column
24D9: 32 97 80        LD      ($8097),A           ; {ram.reactionObjY} clear the reaction object row
24DC: 32 A2 80        LD      ($80A2),A           ; {ram.reactionState} idle - no reaction armed
24DF: 32 A4 80        LD      ($80A4),A           ; {ram.reactionTimer} clear the reaction step timer
24E2: 3C              INC     A
24E3: 32 A1 80        LD      ($80A1),A           ; {ram.laserState} reset the laser/scroll step to rest
24E6: 3E 18           LD      A,$18
24E8: 32 A3 80        LD      ($80A3),A           ; set the reaction step period
24EB: 3E 01           LD      A,$01
24ED: 32 9C 80        LD      ($809C),A           ; seed a companion control byte
...
advancePlayerLaser:
24F3: 3A 77 80        LD      A,($8077)           ; {ram.pitCrossActive} is a goal/pit crossing active
24F6: A7              AND     A
24F7: 20 06           JR      NZ,$24FF            ; crossing owns the frame
24F9: 3A C1 80        LD      A,($80C1)           ; {ram.digCollisionState} is an armed dig object present
24FC: A7              AND     A
24FD: 28 08           JR      Z,$2507             ; neither active - run the laser/reaction

loc_24ff:
24FF: 3E 09           LD      A,$09
2501: 32 95 80        LD      ($8095),A           ; {ram.reactionObjCode} force the rest sprite
2504: C3 77 26        JP      $2677               ; publish the sprite record

loc_2507:
2507: 3A A1 80        LD      A,($80A1)           ; {ram.laserState} read the horizontal-scroll step
250A: E6 08           AND     $08
250C: C2 2D 27        JP      NZ,$272D            ; a scroll in progress - advance it
250F: 3A BD 80        LD      A,($80BD)           ; {ram.hazardActiveCount} read the edge-collision flag
2512: FE 02           CP      $02
2514: CA 96 26        JP      Z,$2696             ; edge collision - maybe start a scroll
2517: 3A A4 80        LD      A,($80A4)           ; {ram.reactionTimer} read the reaction timer
251A: FE 18           CP      $18
251C: CC 73 4C        CALL    Z,$4C73             ; {code.requestSound9} cue the reaction sound as the timer passes 24
251F: 3A A2 80        LD      A,($80A2)           ; {ram.reactionState} read the active reaction phase
2522: 3D              DEC     A
2523: 28 0F           JR      Z,$2534             ; phase 1 - dig left
2525: 3D              DEC     A
2526: CA 87 25        JP      Z,$2587             ; phase 2 - dig right
2529: 3D              DEC     A
252A: CA DA 25        JP      Z,$25DA             ; phase 3 - dig down
252D: 3D              DEC     A
252E: CA 28 26        JP      Z,$2628             ; phase 4 - dig up
2531: C3 96 26        JP      $2696               ; idle - the edge-collision arm

loc_2534:
2534: 3E A8           LD      A,$A8
2536: 32 95 80        LD      ($8095),A           ; {ram.reactionObjCode} phase-1 dig-left animating sprite
2539: 3A A4 80        LD      A,($80A4)           ; {ram.reactionTimer}
253C: 3D              DEC     A
253D: 32 A4 80        LD      ($80A4),A           ; {ram.reactionTimer} tick the phase timer
2540: 20 2B           JR      NZ,$256D            ; still animating - slide the object
2542: 3E 09           LD      A,$09
2544: 32 95 80        LD      ($8095),A           ; {ram.reactionObjCode} settle to the rest sprite
2547: DD 2A 6E 80     LD      IX,($806E)          ; {ram.playerCellPtr} point at the actor's map cell
254B: 3A A7 80        LD      A,($80A7)           ; {ram.expectedTile} read the first resolved tile
254E: A7              AND     A
254F: 28 03           JR      Z,$2554             ; skip if no first tile
2551: DD 77 00        LD      (IX+$00),A          ; write the resolved tile into the cell

loc_2554:
2554: 3A A8 80        LD      A,($80A8)           ; {ram.nextTile} read the second resolved tile
2557: A7              AND     A
2558: 28 03           JR      Z,$255D             ; skip if no second tile
255A: DD 77 01        LD      (IX+$01),A          ; write the second tile into the next cell

loc_255d:
255D: 3E B2           LD      A,$B2
255F: 32 69 80        LD      ($8069),A           ; {ram.playerFacing} publish the dig-left facing code
2562: CD AB 28        CALL    $28AB               ; {code.spawnDigEntity} spawn the dug entity
2565: 3E 00           LD      A,$00
2567: 32 A2 80        LD      ($80A2),A           ; {ram.reactionState} end the reaction
256A: C3 77 26        JP      $2677               ; publish the sprite record

loc_256d:
256D: 3A 68 80        LD      A,($8068)           ; {ram.playerY} track the object Y
2570: D6 08           SUB     $08                 ; offset eight pixels left
2572: 32 94 80        LD      ($8094),A           ; {ram.reactionObjX} place the reaction object column
2575: 3A 6B 80        LD      A,($806B)           ; {ram.playerX}
2578: 32 97 80        LD      ($8097),A           ; {ram.reactionObjY} set the reaction object row
...
2584: C3 77 26        JP      $2677               ; publish the sprite record

loc_2587:
2587: 3E 28           LD      A,$28
2589: 32 95 80        LD      ($8095),A           ; {ram.reactionObjCode} phase-2 dig-right animating sprite
258C: 3A A4 80        LD      A,($80A4)           ; {ram.reactionTimer}
258F: 3D              DEC     A
2590: 32 A4 80        LD      ($80A4),A           ; {ram.reactionTimer} tick the phase timer
2593: 20 2B           JR      NZ,$25C0            ; still animating - slide the object
2595: 3E 00           LD      A,$00
2597: 32 A2 80        LD      ($80A2),A           ; {ram.reactionState} end the reaction
259A: 3E 09           LD      A,$09
259C: 32 95 80        LD      ($8095),A           ; {ram.reactionObjCode} settle to the rest sprite
259F: DD 2A 6E 80     LD      IX,($806E)          ; {ram.playerCellPtr} point at the actor's map cell
25A3: 3A A7 80        LD      A,($80A7)           ; {ram.expectedTile} read the first resolved tile
25A6: A7              AND     A
25A7: 28 03           JR      Z,$25AC
25A9: DD 77 00        LD      (IX+$00),A          ; write the resolved tile into the cell

loc_25ac:
25AC: 3A A8 80        LD      A,($80A8)           ; {ram.nextTile} read the second resolved tile
25AF: A7              AND     A
25B0: 28 03           JR      Z,$25B5
25B2: DD 77 01        LD      (IX+$01),A          ; write the second tile into the next cell

loc_25b5:
25B5: 3E 32           LD      A,$32
25B7: 32 69 80        LD      ($8069),A           ; {ram.playerFacing} publish the dig-right facing code
25BA: CD AB 28        CALL    $28AB               ; {code.spawnDigEntity} spawn the dug entity
25BD: C3 77 26        JP      $2677               ; publish the sprite record

loc_25c0:
25C0: 3A 68 80        LD      A,($8068)           ; {ram.playerY} track the object Y
25C3: C6 08           ADD     A,$08               ; offset eight pixels right
25C5: 32 94 80        LD      ($8094),A           ; {ram.reactionObjX} place the reaction object column
25C8: 3A 6B 80        LD      A,($806B)           ; {ram.playerX}
25CB: 32 97 80        LD      ($8097),A           ; {ram.reactionObjY} set the reaction object row
...
25D7: C3 77 26        JP      $2677               ; publish the sprite record

loc_25da:
25DA: 3E 29           LD      A,$29
25DC: 32 95 80        LD      ($8095),A           ; {ram.reactionObjCode} phase-3 dig-down animating sprite
25DF: 3A A4 80        LD      A,($80A4)           ; {ram.reactionTimer}
25E2: 3D              DEC     A
25E3: 32 A4 80        LD      ($80A4),A           ; {ram.reactionTimer} tick the phase timer
25E6: 20 27           JR      NZ,$260F            ; still animating - slide the object
25E8: 3E 00           LD      A,$00
25EA: 32 A2 80        LD      ($80A2),A           ; {ram.reactionState} end the reaction
25ED: 3E 09           LD      A,$09
25EF: 32 95 80        LD      ($8095),A           ; {ram.reactionObjCode} settle to the rest sprite
25F2: DD 2A 6E 80     LD      IX,($806E)          ; {ram.playerCellPtr} point at the actor's map cell
25F6: 3A A7 80        LD      A,($80A7)           ; {ram.expectedTile} read the first resolved tile
25F9: A7              AND     A
25FA: 28 03           JR      Z,$25FF
25FC: DD 77 00        LD      (IX+$00),A          ; write the resolved tile into the cell

loc_25ff:
25FF: 3A A8 80        LD      A,($80A8)           ; {ram.nextTile} read the second resolved tile
2602: A7              AND     A
2603: 28 03           JR      Z,$2608
2605: DD 77 01        LD      (IX+$01),A          ; write the second tile into the next cell

loc_2608:
2608: 3E 34           LD      A,$34
260A: 32 69 80        LD      ($8069),A           ; {ram.playerFacing} publish the dig-down facing code
260D: 18 68           JR      $2677               ; publish the record - phase 3 spawns nothing

loc_260f:
260F: 3A 68 80        LD      A,($8068)           ; {ram.playerY} track the object Y
2612: 32 94 80        LD      ($8094),A           ; {ram.reactionObjX} place the reaction object column
2615: 3A 6B 80        LD      A,($806B)           ; {ram.playerX}
2618: C6 08           ADD     A,$08               ; offset eight pixels down
261A: 32 97 80        LD      ($8097),A           ; {ram.reactionObjY} set the reaction object row
...
2626: 18 4F           JR      $2677               ; publish the sprite record

loc_2628:
2628: 3E 69           LD      A,$69
262A: 32 95 80        LD      ($8095),A           ; {ram.reactionObjCode} phase-4 dig-up animating sprite
262D: 3A A4 80        LD      A,($80A4)           ; {ram.reactionTimer}
2630: 3D              DEC     A
2631: 32 A4 80        LD      ($80A4),A           ; {ram.reactionTimer} tick the phase timer
2634: 20 2A           JR      NZ,$2660            ; still animating - slide the object
2636: 3E 09           LD      A,$09
2638: 32 95 80        LD      ($8095),A           ; {ram.reactionObjCode} settle to the rest sprite
263B: DD 2A 6E 80     LD      IX,($806E)          ; {ram.playerCellPtr} point at the actor's map cell
263F: 3A A7 80        LD      A,($80A7)           ; {ram.expectedTile} read the first resolved tile
2642: A7              AND     A
2643: 28 03           JR      Z,$2648
2645: DD 77 00        LD      (IX+$00),A          ; write the resolved tile into the cell

loc_2648:
2648: 3A A8 80        LD      A,($80A8)           ; {ram.nextTile} read the second resolved tile
264B: A7              AND     A
264C: 28 03           JR      Z,$2651
264E: DD 77 FF        LD      (IX-$01),A          ; write the second tile into the cell before it

loc_2651:
2651: 3E B4           LD      A,$B4
2653: 32 69 80        LD      ($8069),A           ; {ram.playerFacing} publish the dig-up facing code
2656: CD AB 28        CALL    $28AB               ; {code.spawnDigEntity} spawn the dug entity
2659: 3E 00           LD      A,$00
265B: 32 A2 80        LD      ($80A2),A           ; {ram.reactionState} end the reaction
265E: 18 17           JR      $2677               ; publish the sprite record

loc_2660:
2660: 3A 68 80        LD      A,($8068)           ; {ram.playerY} track the object Y
2663: 32 94 80        LD      ($8094),A           ; {ram.reactionObjX} place the reaction object column
2666: 3A 6B 80        LD      A,($806B)           ; {ram.playerX}
2669: D6 08           SUB     $08                 ; offset eight pixels up
266B: 32 97 80        LD      ($8097),A           ; {ram.reactionObjY} set the reaction object row
...
267A: 3A 51 80        LD      A,($8051)           ; {ram.spriteCoordBias} load the sprite coordinate bias
267D: 47              LD      B,A
...
2683: 23              INC     HL
2684: 3A 95 80        LD      A,($8095)           ; {ram.reactionObjCode} read the reaction sprite code
2687: 77              LD      (HL),A              ; write the sprite code into the record
2688: 23              INC     HL
2689: 3A 96 80        LD      A,($8096)           ; {ram.reactionObjAttr} read the reaction attribute
268C: 77              LD      (HL),A              ; write the attribute into the record
268D: 23              INC     HL
268E: 3A 97 80        LD      A,($8097)           ; {ram.reactionObjY} read the reaction object row
...
loc_2696:
2696: 3A 79 80        LD      A,($8079)           ; {ram.playerActive} is the player active
2699: B7              OR      A
269A: 28 1F           JR      Z,$26BB             ; player inactive - hand to the dig-object driver
269C: 3A 7B 80        LD      A,($807B)           ; {ram.boardEndPhase} read the board-end phase
269F: B7              OR      A
26A0: 20 19           JR      NZ,$26BB            ; board ending - hand off
26A2: 3A E7 80        LD      A,($80E7)           ; {ram.goalTileLatch} read the goal-tile latch
26A5: B7              OR      A
26A6: 20 13           JR      NZ,$26BB            ; goal latched - hand off
26A8: 3A 18 80        LD      A,($8018)           ; {ram.in0Debounced} read the debounced input
26AB: 47              LD      B,A
26AC: 3A A1 80        LD      A,($80A1)           ; {ram.laserState} read the scroll step
26AF: B7              OR      A
26B0: 28 0C           JR      Z,$26BE             ; no scroll set - maybe start one
26B2: CB 60           BIT     4,B                 ; dig button still held
26B4: 20 05           JR      NZ,$26BB            ; held - leave the scroll mode as is
26B6: 3E 00           LD      A,$00
26B8: 32 A1 80        LD      ($80A1),A           ; {ram.laserState} clear the scroll mode
...
26C0: 28 F9           JR      Z,$26BB             ; not held - nothing to start
26C2: 0E F8           LD      C,$F8               ; leftward scroll step
26C4: 3A 69 80        LD      A,($8069)           ; {ram.playerFacing} read the object facing
26C7: FE B2           CP      $B2
26C9: 28 0E           JR      Z,$26D9             ; dig-left facing - seed a left scroll
26CB: FE B3           CP      $B3
26CD: 28 0A           JR      Z,$26D9             ; dig-left facing - seed a left scroll
26CF: 0E 08           LD      C,$08               ; rightward scroll step
26D1: FE 32           CP      $32
26D3: 28 04           JR      Z,$26D9             ; dig-right facing - seed a right scroll
26D5: FE 33           CP      $33
26D7: 20 E2           JR      NZ,$26BB            ; not scroll-capable - hand off

loc_26d9:
26D9: 79              LD      A,C
26DA: 32 A1 80        LD      ($80A1),A           ; {ram.laserState} latch the horizontal scroll step
26DD: CD 7F 4C        CALL    $4C7F               ; {code.requestSound12} cue the scroll sound
26E0: 3E 03           LD      A,$03
26E2: 32 96 80        LD      ($8096),A           ; {ram.reactionObjAttr} reset the object attribute
26E5: 3E 3A           LD      A,$3A
26E7: 32 95 80        LD      ($8095),A           ; {ram.reactionObjCode} the scroll-seeding sprite
26EA: 3A 68 80        LD      A,($8068)           ; {ram.playerY} read the object Y
26ED: 32 94 80        LD      ($8094),A           ; {ram.reactionObjX} place the object at the tracked column
26F0: C6 03           ADD     A,$03
26F2: CB 3F           SRL     A
26F4: CB 3F           SRL     A
26F6: CB 3F           SRL     A
...
26FC: 67              LD      H,A
26FD: 3A 6B 80        LD      A,($806B)           ; {ram.playerX} read the object X
2700: 32 97 80        LD      ($8097),A           ; {ram.reactionObjY} set the object row
2703: C6 05           ADD     A,$05
2705: 06 00           LD      B,$00
2707: CB 3F           SRL     A
2709: CB 18           RR      B
...
2713: 4F              LD      C,A
2714: 78              LD      A,B
2715: 32 9E 80        LD      ($809E),A           ; {ram.scrollSubphase} store the sub-tile column phase
2718: 3E 00           LD      A,$00
271A: 47              LD      B,A
271B: CB 3C           SRL     H
271D: 1F              RRA
...
2726: 01 00 90        LD      BC,$9000            ; {hard.videoRam} load the tilemap base
2729: 09              ADD     HL,BC               ; resolve the tilemap window cell
272A: 22 9A 80        LD      ($809A),HL          ; {ram.laserScanPtr} store the scroll window pointer

loc_272d:
272D: 3A A1 80        LD      A,($80A1)           ; {ram.laserState} read the scroll step
2730: 4F              LD      C,A
2731: 11 20 00        LD      DE,$0020            ; one tilemap row down
2734: CB 79           BIT     7,C                 ; scroll direction bit
2736: 20 03           JR      NZ,$273B
...
273F: 32 94 80        LD      ($8094),A           ; {ram.reactionObjX} store the object column
2742: 2A 9A 80        LD      HL,($809A)          ; {ram.laserScanPtr} load the scroll window pointer
2745: 19              ADD     HL,DE               ; move the window one row along
2746: 22 9A 80        LD      ($809A),HL          ; {ram.laserScanPtr} store the window pointer
2749: DD 2A 9A 80     LD      IX,($809A)          ; {ram.laserScanPtr} point at the window cell
274D: 3A 9E 80        LD      A,($809E)           ; {ram.scrollSubphase} read the sub-tile phase
2750: 5F              LD      E,A
2751: FE A0           CP      $A0                 ; past the mid-column seam
2753: DD 7E 00        LD      A,(IX+$00)          ; sample the tile at the window cell
2756: 38 03           JR      C,$275B
...
2766: C2 77 26        JP      NZ,$2677            ; no stop tile hit - publish the record
2769: 3E 00           LD      A,$00
276B: 32 94 80        LD      ($8094),A           ; {ram.reactionObjX} reached a wall - park the object
276E: 3C              INC     A
276F: 32 A1 80        LD      ($80A1),A           ; {ram.laserState} end the scroll
2772: 3E 09           LD      A,$09
2774: 32 95 80        LD      ($8095),A           ; {ram.reactionObjCode} settle to the rest sprite
2777: C3 77 26        JP      $2677               ; publish the sprite record
...
seedDigObjectBlock:
287A: 3E 30           LD      A,$30
287C: 32 AA 80        LD      ($80AA),A           ; {ram.hazardState} set the dig-object carving-phase state code
287F: 3E 07           LD      A,$07
2881: 32 AB 80        LD      ($80AB),A           ; {ram.hazardType} resting hazard type = arrow
2884: 3E 00           LD      A,$00
2886: 32 A9 80        LD      ($80A9),A           ; {ram.hazardX} clear the captured target column
2889: 32 AC 80        LD      ($80AC),A           ; {ram.hazardY} clear the captured target row
288C: 32 B1 80        LD      ($80B1),A           ; {ram.digObjTimer} clear the dig-object timer
288F: 32 BD 80        LD      ($80BD),A           ; {ram.hazardActiveCount} idle - a fresh spawn is permitted
2892: 32 C1 80        LD      ($80C1),A           ; {ram.digCollisionState} clear the collision state
2895: 32 C0 80        LD      ($80C0),A           ; {ram.digObjSubtype} clear the dig-object sub-type
2898: 11 C3 80        LD      DE,$80C3            ; {ram.dropQueue} destination of the column-position table
...
28A3: 3E 20           LD      A,$20
28A5: 32 C2 80        LD      ($80C2),A           ; set the table header / count byte
28A8: C3 2F 2F        JP      $2F2F               ; {code.seedChamberCreature} hand off to the round parameter chain

; Stage a dig entity for spawn.
spawnDigEntity:
28AB: DD 2A 6E 80     LD      IX,($806E)          ; {ram.playerCellPtr} point at the actor's map cell
28AF: DD 22 BA 80     LD      ($80BA),IX          ; {ram.stagedCellPtr} save the cell pointer for the commit
...
28C0: 20 22           JR      NZ,$28E4            ; non-fill cell - the channel-cap branch
28C2: 3E C1           LD      A,$C1
28C4: BB              CP      E                   ; neighbour opens the channel
28C5: 28 12           JR      Z,$28D9             ; channel tile - check two cells back
28C7: 3E 95           LD      A,$95
28C9: BB              CP      E                   ; neighbour opens the channel
28CA: 28 0D           JR      Z,$28D9             ; channel tile - check two cells back
28CC: 3E C5           LD      A,$C5
...
28ED: 20 04           JR      NZ,$28F3
28EF: 3E 9D           LD      A,$9D               ; crystal-cap sprite id
28F1: 18 07           JR      $28FA               ; stage this sprite id

loc_28f3:
28F3: 3E 2A           LD      A,$2A
28F5: BB              CP      E                   ; neighbour is the jewel tile
28F6: 28 02           JR      Z,$28FA             ; stage the jewel sprite id

loc_28f8:
28F8: 3E 70           LD      A,$70               ; default fill sprite id

loc_28fa:
28FA: 32 BF 80        LD      ($80BF),A           ; {ram.stagedDigSpriteId} stage the entity sprite id
28FD: 7D              LD      A,L
28FE: 32 C0 80        LD      ($80C0),A           ; {ram.digObjSubtype} stage the entity sub-type
2901: 3A 94 80        LD      A,($8094)           ; {ram.reactionObjX} read the reaction object column
2904: D6 04           SUB     $04                 ; column a few pixels left of the object
2906: 32 B6 80        LD      ($80B6),A           ; {ram.stagedTargetX} stage the placement column
2909: 3A A2 80        LD      A,($80A2)           ; {ram.reactionState}
290C: FE 04           CP      $04                 ; the 4th reaction phase
290E: 3A 6B 80        LD      A,($806B)           ; {ram.playerX} read the object X
2911: 20 01           JR      NZ,$2914
...
2919: 32 B9 80        LD      ($80B9),A           ; {ram.stagedTargetY} stage the placement row
291C: 3A A3 80        LD      A,($80A3)           ; read the reaction period byte
291F: CB 27           SLA     A                   ; double it
2921: 32 BC 80        LD      ($80BC),A           ; {ram.stagedDigTimer} stage the entity attribute
2924: 3A BD 80        LD      A,($80BD)           ; {ram.hazardActiveCount} read the spawn counter
2927: 3C              INC     A
2928: 32 BD 80        LD      ($80BD),A           ; {ram.hazardActiveCount} bump the spawn counter
292B: 3D              DEC     A
292C: 28 06           JR      Z,$2934             ; {code.commitDigEntity} the idle pass commits the entity
292E: 3E 08           LD      A,$08
2930: 32 B1 80        LD      ($80B1),A           ; {ram.digObjTimer} later passes just keep the dig timer armed
2933: C9              RET

; Commit the staged dig entity into the live carve object.
commitDigEntity:
2934: 3E 30           LD      A,$30
2936: 32 AA 80        LD      ($80AA),A           ; {ram.hazardState} arm the dig object into its carving phase
2939: 3E 07           LD      A,$07
293B: 32 AB 80        LD      ($80AB),A           ; {ram.hazardType} set the entity's arrow-type attribute
293E: DD 2A BA 80     LD      IX,($80BA)          ; {ram.stagedCellPtr} reload the saved tilemap cell as the carve cursor
2942: DD 22 AF 80     LD      ($80AF),IX          ; publish it as the live carve cursor
2946: 3A B6 80        LD      A,($80B6)           ; {ram.stagedTargetX} read the staged dig X
2949: 32 A9 80        LD      ($80A9),A           ; {ram.hazardX} commit the staged dig X into the record
294C: 32 BE 80        LD      ($80BE),A           ; mirror the target dig X
294F: 3A B9 80        LD      A,($80B9)           ; {ram.stagedTargetY} read the staged dig Y
2952: 32 AC 80        LD      ($80AC),A           ; {ram.hazardY} commit the staged dig Y into the record
2955: 3A BC 80        LD      A,($80BC)           ; {ram.stagedDigTimer} read the staged dig timer
2958: 32 B1 80        LD      ($80B1),A           ; {ram.digObjTimer} commit the initial carve countdown
295B: DD 5E FF        LD      E,(IX-$01)          ; capture the tile just before the cursor
295E: 3A BF 80        LD      A,($80BF)           ; {ram.stagedDigSpriteId} read the staged sprite id
...
296C: 28 1C           JR      Z,$298A             ; seam wall -> defer the patch to the sub-type
296E: FE 95           CP      $95                 ; seam neighbor?
2970: 28 18           JR      Z,$298A             ; seam -> defer the patch to the sub-type
2972: FE C5           CP      $C5                 ; seam neighbor?
2974: 28 14           JR      Z,$298A             ; seam -> defer the patch to the sub-type
...
loc_298a:
298A: 3A C0 80        LD      A,($80C0)           ; {ram.digObjSubtype} read the entity sub-type
298D: B7              OR      A
298E: C8              RET     Z                   ; sub-type 0 -> leave the cell two back alone
298F: FE 02           CP      $02                 ; sub-type 2?
2991: 20 09           JR      NZ,$299C            ; other sub-type -> remap the cell two back
2993: 3E 10           LD      A,$10
2995: 32 B1 80        LD      ($80B1),A           ; {ram.digObjTimer} sub-type 2 -> re-arm the carve countdown
...
29AD: 3E 00           LD      A,$00
29AF: 32 80 80        LD      ($8080),A           ; {ram.moveBlockFlag} clear the movement-block flag for this frame
29B2: 32 7F 80        LD      ($807F),A           ; {ram.carveSeamRight} clear the right carve-seam flag
29B5: 32 7E 80        LD      ($807E),A           ; {ram.carveSeamLeft} clear the left carve-seam flag
29B8: 3A 78 80        LD      A,($8078)           ; {ram.treasureCollected} read the treasure-collected latch
29BB: B7              OR      A
29BC: 28 15           JR      Z,$29D3             ; no treasure yet -> skip the spawn/capture gate
29BE: 3A 76 80        LD      A,($8076)           ; {ram.prizeGate} read the prize gate
29C1: B7              OR      A
29C2: 28 0F           JR      Z,$29D3             ; prize gate closed -> skip
29C4: 3A BD 80        LD      A,($80BD)           ; {ram.hazardActiveCount} read the active-hazard count
29C7: B7              OR      A
29C8: CA F2 2B        JP      Z,$2BF2             ; {code.startNextDigSpawn} nothing spawning -> start the next queued spawn
29CB: 3A AA 80        LD      A,($80AA)           ; {ram.hazardState} read the hazard state
29CE: FE 30           CP      $30
29D0: C2 B7 2C        JP      NZ,$2CB7            ; {code.captureTargetOnOverlap} not mid-carve -> hand to the capture handler

loc_29d3:
29D3: 3A BD 80        LD      A,($80BD)           ; {ram.hazardActiveCount} read the active-hazard count
29D6: B7              OR      A
...
29DC: 20 25           JR      NZ,$2A03            ; not a fresh target -> run the carve countdown
29DE: 16 00           LD      D,$00
29E0: 3A 6B 80        LD      A,($806B)           ; {ram.playerX} read player X
29E3: 47              LD      B,A
29E4: 3A B9 80        LD      A,($80B9)           ; {ram.stagedTargetY} align the staged target Y against player X
29E7: C6 0C           ADD     A,$0C
29E9: B8              CP      B
29EA: 20 13           JR      NZ,$29FF            ; rows don't align -> no overlap
29EC: 3A 68 80        LD      A,($8068)           ; {ram.playerY} read player Y
29EF: 4F              LD      C,A
29F0: 3A B6 80        LD      A,($80B6)           ; {ram.stagedTargetX} read the staged target X
29F3: E6 FE           AND     $FE                 ; align the band to an even pixel
29F5: B9              CP      C
29F6: 30 07           JR      NC,$29FF            ; player left of the target box -> no overlap
29F8: C6 08           ADD     A,$08
29FA: B9              CP      C
29FB: 38 02           JR      C,$29FF             ; player past the target box -> no overlap
29FD: 16 01           LD      D,$01               ; mark overlap with the staged target box

loc_29ff:
29FF: 7A              LD      A,D
2A00: 32 80 80        LD      ($8080),A           ; {ram.moveBlockFlag} publish the target-overlap flag

loc_2a03:
2A03: 3A B1 80        LD      A,($80B1)           ; {ram.digObjTimer} read the carve countdown
2A06: A7              AND     A
2A07: CA B1 2A        JP      Z,$2AB1             ; idle -> probe / carve straight away
2A0A: 3D              DEC     A                   ; tick the carve countdown down
2A0B: 32 B1 80        LD      ($80B1),A           ; {ram.digObjTimer}
2A0E: 20 42           JR      NZ,$2A52            ; still running -> step the dig animation
2A10: 3A A9 80        LD      A,($80A9)           ; {ram.hazardX} countdown expired: read hazard X
2A13: 3D              DEC     A
2A14: 32 A9 80        LD      ($80A9),A           ; {ram.hazardX} pull hazard X back one
2A17: 3A C1 80        LD      A,($80C1)           ; {ram.digCollisionState} read the dig-collision state
2A1A: A7              AND     A
2A1B: CA B1 2A        JP      Z,$2AB1             ; not armed -> probe / carve
2A1E: 3A AC 80        LD      A,($80AC)           ; {ram.hazardY} armed: read hazard Y
2A21: C6 08           ADD     A,$08
2A23: 32 AC 80        LD      ($80AC),A           ; {ram.hazardY} advance hazard Y to the next dig column
2A26: CD 77 4C        CALL    $4C77               ; {code.requestSound10} request the column-complete sound
2A29: 3E 09           LD      A,$09
2A2B: 32 69 80        LD      ($8069),A           ; {ram.playerFacing} set the object to its done sprite frame
2A2E: CD 5B 1B        CALL    $1B5B               ; {code.stageObjectSpriteRecord} publish the object's sprite record
2A31: 3E 00           LD      A,$00
2A33: 32 BD 80        LD      ($80BD),A           ; {ram.hazardActiveCount} clear the active-hazard count
2A36: 3E B4           LD      A,$B4
2A38: 32 7C 80        LD      ($807C),A           ; {ram.transitionTimer} hold the object for the transition time
2A3B: 3A C0 80        LD      A,($80C0)           ; {ram.digObjSubtype} read the entity sub-type
2A3E: FE 02           CP      $02
2A40: C2 D3 2B        JP      NZ,$2BD3            ; {code.stageDigObjectSpriteRecord} ordinary sub-type -> publish the record
2A43: DD 2A 6E 80     LD      IX,($806E)          ; {ram.playerCellPtr} sub-type 2: load the object's display cell
...
2A54: 28 0F           JR      Z,$2A65
2A56: E6 03           AND     $03                 ; mid-phase tick?
2A58: 20 2D           JR      NZ,$2A87            ; mid-phase tick -> no dig-row move
2A5A: 3A A9 80        LD      A,($80A9)           ; {ram.hazardX}
2A5D: 3C              INC     A
2A5E: 32 A9 80        LD      ($80A9),A           ; {ram.hazardX} advance hazard X (dig-down step)
...
2A68: 3D              DEC     A
2A69: 32 A9 80        LD      ($80A9),A           ; {ram.hazardX} retreat hazard X (dig-up step)
2A6C: 06 37           LD      B,$37               ; digging-up sprite frame

loc_2a6e:
2A6E: 3A C1 80        LD      A,($80C1)           ; {ram.digCollisionState} read the dig-collision state
2A71: B7              OR      A
2A72: 28 13           JR      Z,$2A87             ; not armed -> just re-check overlap
2A74: 78              LD      A,B
2A75: 32 69 80        LD      ($8069),A           ; {ram.playerFacing} publish the step's dig sprite frame
2A78: 3A C0 80        LD      A,($80C0)           ; {ram.digObjSubtype} read the entity sub-type
2A7B: FE 02           CP      $02
2A7D: 20 08           JR      NZ,$2A87            ; ordinary sub-type -> re-check overlap
2A7F: DD 2A 6E 80     LD      IX,($806E)          ; {ram.playerCellPtr} sub-type 2: load the object's display cell
2A83: DD 36 FD C1     LD      (IX-$03),$C1        ; cap the cell above with the wall tile

loc_2a87:
2A87: 3A 80 80        LD      A,($8080)           ; {ram.moveBlockFlag} read the current overlap flag
2A8A: 57              LD      D,A
2A8B: 3A 6B 80        LD      A,($806B)           ; {ram.playerX} read player X
2A8E: 47              LD      B,A
2A8F: 3A AC 80        LD      A,($80AC)           ; {ram.hazardY} test player X against the hazard box
2A92: C6 0C           ADD     A,$0C
2A94: B8              CP      B
2A95: 20 13           JR      NZ,$2AAA            ; rows don't align -> keep the flag
2A97: 3A 68 80        LD      A,($8068)           ; {ram.playerY} read player Y
2A9A: 4F              LD      C,A
2A9B: 3A A9 80        LD      A,($80A9)           ; {ram.hazardX} read hazard X
2A9E: E6 FE           AND     $FE                 ; align the band to an even pixel
2AA0: B9              CP      C
2AA1: 30 07           JR      NC,$2AAA            ; player left of the hazard box -> keep the flag
2AA3: C6 08           ADD     A,$08
2AA5: B9              CP      C
2AA6: 38 02           JR      C,$2AAA             ; player past the hazard box -> keep the flag
2AA8: 16 01           LD      D,$01               ; mark overlap with the hazard box

loc_2aaa:
2AAA: 7A              LD      A,D
2AAB: 32 80 80        LD      ($8080),A           ; {ram.moveBlockFlag} publish the overlap flag
2AAE: C3 D3 2B        JP      $2BD3               ; {code.stageDigObjectSpriteRecord} publish the object's sprite record

loc_2ab1:
2AB1: 3A C1 80        LD      A,($80C1)           ; {ram.digCollisionState} read the dig-collision state
2AB4: A7              AND     A
2AB5: 20 2F           JR      NZ,$2AE6            ; already armed -> skip the capture probe
2AB7: 3A 6B 80        LD      A,($806B)           ; {ram.playerX} read player X
2ABA: 47              LD      B,A
2ABB: 3A AC 80        LD      A,($80AC)           ; {ram.hazardY} test player X against the carve box near edge
2ABE: C6 0A           ADD     A,$0A
2AC0: B8              CP      B
2AC1: 30 23           JR      NC,$2AE6            ; player above the carve box -> skip
2AC3: C6 03           ADD     A,$03
2AC5: B8              CP      B
2AC6: 38 1E           JR      C,$2AE6             ; player below the carve box -> skip
2AC8: 3A 68 80        LD      A,($8068)           ; {ram.playerY} read player Y
2ACB: 4F              LD      C,A
2ACC: 3A A9 80        LD      A,($80A9)           ; {ram.hazardX} test player Y against the carve box
2ACF: D6 03           SUB     $03
2AD1: B9              CP      C
2AD2: 30 12           JR      NC,$2AE6            ; player left of the carve box -> skip
2AD4: C6 0B           ADD     A,$0B
2AD6: B9              CP      C
2AD7: 38 0D           JR      C,$2AE6             ; player right of the carve box -> skip
2AD9: D6 04           SUB     $04
2ADB: 32 68 80        LD      ($8068),A           ; {ram.playerY} snap the player onto the carve box edge
2ADE: 3E 01           LD      A,$01
2AE0: 32 C1 80        LD      ($80C1),A           ; {ram.digCollisionState} arm the dig object (collision captured)
2AE3: C3 87 2A        JP      $2A87               ; re-check overlap and publish

loc_2ae6:
2AE6: 3A 6B 80        LD      A,($806B)           ; {ram.playerX} read player X
2AE9: 47              LD      B,A
2AEA: 3A AC 80        LD      A,($80AC)           ; {ram.hazardY} probe the new dig cell against the player row
2AED: D6 05           SUB     $05
2AEF: B8              CP      B
2AF0: 30 24           JR      NC,$2B16            ; above the player's row -> carve now
2AF2: C6 11           ADD     A,$11
2AF4: 38 20           JR      C,$2B16             ; wrapped past the row band -> carve now
2AF6: 3A 68 80        LD      A,($8068)           ; {ram.playerY}
2AF9: C6 03           ADD     A,$03
2AFB: E6 F8           AND     $F8                 ; snap to the player's tile-column boundary
2AFD: 4F              LD      C,A
2AFE: 3A A9 80        LD      A,($80A9)           ; {ram.hazardX} probe one cell before the dig X
2B01: 3D              DEC     A
2B02: B9              CP      C
2B03: 28 0C           JR      Z,$2B11             ; new cell butts the player's right edge
2B05: C6 10           ADD     A,$10
2B07: B9              CP      C
2B08: 20 0C           JR      NZ,$2B16            ; no seam against the player -> carve
2B0A: 3E 01           LD      A,$01
2B0C: 32 7E 80        LD      ($807E),A           ; {ram.carveSeamLeft} raise the left carve-seam flag
2B0F: 18 05           JR      $2B16

loc_2b11:
2B11: 3E 01           LD      A,$01
2B13: 32 7F 80        LD      ($807F),A           ; {ram.carveSeamRight} raise the right carve-seam flag

loc_2b16:
2B16: 3A A9 80        LD      A,($80A9)           ; {ram.hazardX} read hazard X
2B19: C6 07           ADD     A,$07
2B1B: CB 3F           SRL     A
2B1D: CB 3F           SRL     A
2B1F: CB 3F           SRL     A
...
2B29: C6 01           ADD     A,$01
2B2B: 32 AC 80        LD      ($80AC),A           ; {ram.hazardY} advance hazard Y one dig step
2B2E: C6 09           ADD     A,$09
2B30: 5F              LD      E,A
...
2B46: 01 00 90        LD      BC,$9000            ; {hard.videoRam} tilemap base
2B49: 09              ADD     HL,BC               ; form the carve cell pointer
2B4A: 22 AF 80        LD      ($80AF),HL          ; store as the live carve cursor
...
2B56: FE 2A           CP      $2A
2B58: 28 52           JR      Z,$2BAC             ; already-solid tile -> stamp the wall
2B5A: FE 2B           CP      $2B
2B5C: 28 4E           JR      Z,$2BAC             ; already-solid tile -> stamp the wall
2B5E: FE C1           CP      $C1
2B60: 28 4A           JR      Z,$2BAC             ; already carved wall -> re-stamp the wall
2B62: FE 95           CP      $95
2B64: 28 46           JR      Z,$2BAC             ; solid seam tile -> stamp the wall
2B66: FE C4           CP      $C4
2B68: 20 04           JR      NZ,$2B6E            ; not a channel edge -> test the diggable band
2B6A: CB 53           BIT     2,E                 ; sub-column faces the channel?
2B6C: 20 36           JR      NZ,$2BA4            ; faces in -> rewrite the channel edge to wall
...
2B8D: 7A              LD      A,D
2B8E: A7              AND     A
2B8F: 20 0E           JR      NZ,$2B9F            ; remap present -> apply it
2B91: 7B              LD      A,E
2B92: E6 07           AND     $07
...
2B9F: 7B              LD      A,E
2BA0: E6 07           AND     $07
2BA2: 28 08           JR      Z,$2BAC             ; first sub-column -> stamp the wall
...
2BB4: 3A BD 80        LD      A,($80BD)           ; {ram.hazardActiveCount} read the active-hazard count
2BB7: 3D              DEC     A
2BB8: 32 BD 80        LD      ($80BD),A           ; {ram.hazardActiveCount} one entity of the run committed
2BBB: C2 34 29        JP      NZ,$2934            ; {code.commitDigEntity} more pending -> commit the next entity
2BBE: 3E 00           LD      A,$00
2BC0: 32 A9 80        LD      ($80A9),A           ; {ram.hazardX} last entity -> reset hazard X
2BC3: 3E 09           LD      A,$09
2BC5: 32 AA 80        LD      ($80AA),A           ; {ram.hazardState} mark the object done
2BC8: 3A C0 80        LD      A,($80C0)           ; {ram.digObjSubtype} read the entity sub-type
2BCB: FE 02           CP      $02
...
2BD6: 3A 51 80        LD      A,($8051)           ; {ram.spriteCoordBias} read the cabinet coordinate bias
2BD9: 47              LD      B,A
2BDA: 3A A9 80        LD      A,($80A9)           ; {ram.hazardX} read hazard X
2BDD: 90              SUB     B
2BDE: 77              LD      (HL),A              ; write the leading coordinate (bias removed)
2BDF: 23              INC     HL
2BE0: 3A AA 80        LD      A,($80AA)           ; {ram.hazardState} read the hazard state (sprite shape)
2BE3: 77              LD      (HL),A              ; write the sprite shape from the hazard state
2BE4: 23              INC     HL
2BE5: 3A AB 80        LD      A,($80AB)           ; {ram.hazardType} read the hazard type (color)
2BE8: 77              LD      (HL),A              ; write the color/attribute from the hazard type
2BE9: 23              INC     HL
2BEA: 3A AC 80        LD      A,($80AC)           ; {ram.hazardY} read hazard Y
2BED: 80              ADD     A,B
...
startNextDigSpawn:
2BF2: 21 C3 80        LD      HL,$80C3            ; {ram.dropQueue} base of the 24-slot pending drop queue
...
2BFB: 23              INC     HL
2BFC: 10 F9           DJNZ    $2BF7               ; scan the next slot
2BFE: 32 BD 80        LD      ($80BD),A           ; {ram.hazardActiveCount} queue empty -> clear the spawn-active flag
...
2C04: 3E 01           LD      A,$01
2C06: 32 BD 80        LD      ($80BD),A           ; {ram.hazardActiveCount} raise the spawn-active flag
2C09: CD 97 4C        CALL    $4C97               ; {code.requestSound18} play the spawn sound
2C0C: 3E 10           LD      A,$10
2C0E: 32 AA 80        LD      ($80AA),A           ; {ram.hazardState} set the hazard's spawn-phase state
2C11: 3E 06           LD      A,$06
2C13: 32 AB 80        LD      ($80AB),A           ; {ram.hazardType} set the hazard color to rock
2C16: 3A C2 80        LD      A,($80C2)
2C19: 32 B1 80        LD      ($80B1),A           ; {ram.digObjTimer} seed the hazard lifetime timer

loc_2c1c:
2C1C: CD 1A 4B        CALL    $4B1A               ; {code.advanceRandom} draw the next random value
2C1F: E6 1F           AND     $1F                 ; keep the low 5 bits (0..31)
2C21: FE 18           CP      $18
2C23: 30 F7           JR      NC,$2C1C            ; reject values 24..31 and redraw
2C25: 47              LD      B,A
2C26: 5F              LD      E,A
2C27: 16 00           LD      D,$00
2C29: 21 C3 80        LD      HL,$80C3            ; {ram.dropQueue} drop-queue base
2C2C: 19              ADD     HL,DE
2C2D: 7E              LD      A,(HL)              ; read the drawn queue slot
2C2E: A7              AND     A
2C2F: 28 EB           JR      Z,$2C1C             ; empty slot -> redraw
2C31: 4F              LD      C,A                 ; hold the slot's stored value
2C32: 7B              LD      A,E
2C33: FE 0C           CP      $0C                 ; right-half column?
2C35: 30 12           JR      NC,$2C49            ; right-half column -> use it directly
2C37: 1E 0C           LD      E,$0C
2C39: 19              ADD     HL,DE               ; step to the paired right-half slot
2C3A: 7E              LD      A,(HL)
2C3B: A7              AND     A
2C3C: 20 06           JR      NZ,$2C44            ; paired slot also queued -> switch to it
...
2C4C: 79              LD      A,C
2C4D: C6 01           ADD     A,$01
2C4F: 32 A9 80        LD      ($80A9),A           ; {ram.hazardX} set the hazard X coordinate
2C52: 78              LD      A,B
2C53: FE 0C           CP      $0C                 ; left-half column?
2C55: 3E B7           LD      A,$B7
2C57: 38 02           JR      C,$2C5B             ; left-half -> low column-base coordinate
2C59: 3E BF           LD      A,$BF               ; right-half -> high column-base coordinate

loc_2c5b:
2C5B: 32 AC 80        LD      ($80AC),A           ; {ram.hazardY} set the hazard Y coordinate
...
2C86: 01 00 90        LD      BC,$9000            ; {hard.videoRam} tilemap base
...
2C91: 16 00           LD      D,$00
2C93: 3A 6B 80        LD      A,($806B)           ; {ram.playerX} read player X
2C96: 47              LD      B,A
2C97: 3A AC 80        LD      A,($80AC)           ; {ram.hazardY} test the cell row against player X
2C9A: C6 0C           ADD     A,$0C
2C9C: B8              CP      B
2C9D: 20 11           JR      NZ,$2CB0            ; rows don't align -> no overlap
2C9F: 3A 68 80        LD      A,($8068)           ; {ram.playerY} read player Y
2CA2: 4F              LD      C,A
2CA3: 3A A9 80        LD      A,($80A9)           ; {ram.hazardX} read the cell's dig X
2CA6: B9              CP      C
2CA7: 30 07           JR      NC,$2CB0            ; cell not left of the player -> no overlap
2CA9: C6 08           ADD     A,$08
2CAB: B9              CP      C
2CAC: 38 02           JR      C,$2CB0             ; player beyond the 8px band -> no overlap
...
2CB7: 3E 00           LD      A,$00
2CB9: 32 80 80        LD      ($8080),A           ; {ram.moveBlockFlag} clear the overlap gate for this tick
2CBC: 3A B1 80        LD      A,($80B1)           ; {ram.digObjTimer} read the target countdown
2CBF: FE 40           CP      $40
2CC1: CA 6B 2D        JP      Z,$2D6B             ; {code.stampGlyphColumn} at the reload sentinel -> stamp the ZONK glyph
2CC4: 3D              DEC     A
2CC5: 32 B1 80        LD      ($80B1),A           ; {ram.digObjTimer} tick the target countdown down
2CC8: C2 91 2C        JP      NZ,$2C91            ; {code.flagObjectTargetOverlap} still running -> refresh the overlap record
2CCB: 3E 01           LD      A,$01
2CCD: 32 B1 80        LD      ($80B1),A           ; {ram.digObjTimer} re-arm the countdown for next frame
2CD0: 3A C1 80        LD      A,($80C1)           ; {ram.digCollisionState} read the captured flag
2CD3: A7              AND     A
2CD4: 20 30           JR      NZ,$2D06            ; {code.advanceDigTarget} already captured -> advance the target
2CD6: 3A 6B 80        LD      A,($806B)           ; {ram.playerX} read player X
2CD9: 47              LD      B,A
2CDA: 3A AC 80        LD      A,($80AC)           ; {ram.hazardY} test player X against the capture box
2CDD: C6 0A           ADD     A,$0A
2CDF: B8              CP      B
...
2CE7: 3A 68 80        LD      A,($8068)           ; {ram.playerY} read player Y
2CEA: 4F              LD      C,A
2CEB: 3A A9 80        LD      A,($80A9)           ; {ram.hazardX} test player Y against the capture band
2CEE: D6 04           SUB     $04
2CF0: B9              CP      C
...
2CF8: 32 68 80        LD      ($8068),A           ; {ram.playerY} snap the player onto the target's near edge
2CFB: 3E 01           LD      A,$01
2CFD: 32 C1 80        LD      ($80C1),A           ; {ram.digCollisionState} mark the target captured
...
advanceDigTarget:
2D06: 3A A9 80        LD      A,($80A9)           ; {ram.hazardX} read the target's cross-axis X
2D09: CB 3F           SRL     A
2D0B: CB 3F           SRL     A
2D0D: CB 3F           SRL     A
2D0F: ED 44           NEG
...
2D13: 67              LD      H,A
2D14: 3A AC 80        LD      A,($80AC)           ; {ram.hazardY}
2D17: C6 01           ADD     A,$01
2D19: 32 AC 80        LD      ($80AC),A           ; {ram.hazardY} advance the target one step along its axis
2D1C: 3C              INC     A
2D1D: 5F              LD      E,A
2D1E: CB 3F           SRL     A
2D20: CB 3F           SRL     A
...
2D33: 01 00 90        LD      BC,$9000            ; {hard.videoRam} tilemap base
2D36: 09              ADD     HL,BC               ; form the target's cell pointer
2D37: 22 AF 80        LD      ($80AF),HL          ; store as the live carve cursor
2D3A: DD 2A AF 80     LD      IX,($80AF)
...
2D56: 3E 00           LD      A,$00
2D58: 32 BD 80        LD      ($80BD),A           ; {ram.hazardActiveCount} reopen the spawn gate so a fresh target may seed
2D5B: 32 A9 80        LD      ($80A9),A           ; {ram.hazardX} clear the landed target X
2D5E: 3E 09           LD      A,$09
2D60: 32 AA 80        LD      ($80AA),A           ; {ram.hazardState} mark the target settled/done
2D63: 3E 07           LD      A,$07
2D65: 32 AB 80        LD      ($80AB),A           ; {ram.hazardType} set the settled target fixed color
...
stampGlyphColumn:
2D6B: DD 2A 6E 80     LD      IX,($806E)          ; {ram.playerCellPtr} take the object display cell to stamp the ZONK glyph
2D6F: 3E 23           LD      A,$23
...
2D88: 2A 6E 80        LD      HL,($806E)          ; {ram.playerCellPtr} reload the cell to paint the glyph color column
...
2D9C: 10 FC           DJNZ    $2D9A               ; loop the five-cell color column
2D9E: 3E 00           LD      A,$00
2DA0: 32 78 80        LD      ($8078),A           ; {ram.treasureCollected} clear the per-event treasure latch
2DA3: 3E B4           LD      A,$B4
2DA5: 32 7C 80        LD      ($807C),A           ; {ram.transitionTimer} arm the board-transition timer (180 frames)
...
seedChamberCreature:
2F2F: 3E 39           LD      A,$39
2F31: 32 DC 80        LD      ($80DC),A           ; {ram.chamberCreatureFrame} seed the chamber creature start frame
2F34: 3E 28           LD      A,$28
2F36: 32 DB 80        LD      ($80DB),A           ; {ram.chamberCreatureX} seed the creature start X
2F39: 3E 78           LD      A,$78
2F3B: 32 DE 80        LD      ($80DE),A           ; {ram.chamberCreatureFallY} seed the creature start fall-Y
2F3E: 3E C0           LD      A,$C0
2F40: 32 DD 80        LD      ($80DD),A           ; {ram.chamberCreatureAttr} seed the creature color
2F43: 3E 01           LD      A,$01
2F45: 32 DF 80        LD      ($80DF),A           ; seed the bounce velocity (rightward)
2F48: 3E FC           LD      A,$FC
2F4A: 32 E0 80        LD      ($80E0),A           ; seed the fall step
2F4D: 3E 01           LD      A,$01
2F4F: 32 E3 80        LD      ($80E3),A           ; {ram.chamberCreatureAnimPhase} seed the sprite-flip phase clock
2F52: 32 E5 80        LD      ($80E5),A           ; {ram.pitFloorRevealGate} seed the Pit floor-reveal gate
2F55: 3E 00           LD      A,$00
2F57: 32 E7 80        LD      ($80E7),A           ; {ram.goalTileLatch} clear the goal-zone latch
2F5A: 3E 96           LD      A,$96
2F5C: 32 E6 80        LD      ($80E6),A           ; {ram.pitFloorRevealCursor} seed the floor-reveal table cursor
2F5F: 3A 28 80        LD      A,($8028)           ; {ram.level} read the level/difficulty counter
2F62: 3C              INC     A
2F63: FE 04           CP      $04                 ; cap the level at 4
2F65: 38 02           JR      C,$2F69
2F67: 3E 04           LD      A,$04               ; hold at the ceiling of 4

loc_2f69:
2F69: EE 07           XOR     $07                 ; derive the reveal period, shorter at higher levels
2F6B: 32 E4 80        LD      ($80E4),A           ; {ram.pitFloorRevealPeriod} store the floor-reveal period
...
2F71: 3A E7 80        LD      A,($80E7)           ; {ram.goalTileLatch} check the goal-zone latch
2F74: A7              AND     A
2F75: CA C0 2F        JP      Z,$2FC0             ; {code.advanceChamberCreatureAnimation} goal not reached yet: skip the floor reveal
2F78: 3A 77 80        LD      A,($8077)           ; {ram.pitCrossActive} is the player crossing the Pit?
2F7B: A7              AND     A
2F7C: 28 0A           JR      Z,$2F88             ; {code.revealTerrainColumn} not crossing: skip the reveal sound
2F7E: 3A 6B 80        LD      A,($806B)           ; {ram.playerX} read the player column
...
revealTerrainColumn:
2F88: 3A E5 80        LD      A,($80E5)           ; {ram.pitFloorRevealGate} read the floor-reveal gate
2F8B: 3D              DEC     A                   ; tick the reveal gate down
2F8C: 32 E5 80        LD      ($80E5),A           ; {ram.pitFloorRevealGate}
2F8F: 20 2F           JR      NZ,$2FC0            ; {code.advanceChamberCreatureAnimation} not a reveal frame: on to the animation clock
2F91: 3A E4 80        LD      A,($80E4)           ; {ram.pitFloorRevealPeriod} reload the gate from the reveal period
2F94: 32 E5 80        LD      ($80E5),A           ; {ram.pitFloorRevealGate}
2F97: 3A E6 80        LD      A,($80E6)           ; {ram.pitFloorRevealCursor} read the pattern-table cursor
...
2F9E: 32 E6 80        LD      ($80E6),A           ; {ram.pitFloorRevealCursor} store the stepped cursor
2FA1: 5F              LD      E,A
2FA2: 16 00           LD      D,$00
2FA4: 21 48 30        LD      HL,$3048            ; base of the terrain tile-pattern table
2FA7: 19              ADD     HL,DE               ; point at this column six tiles
2FA8: 22 E1 80        LD      ($80E1),HL          ; stash the pattern pointer
2FAB: DD 2A E1 80     LD      IX,($80E1)
2FAF: 21 8C 93        LD      HL,$938C            ; {hard.videoRam} destination: the column bottom video cell
...
2FC0: 3A E3 80        LD      A,($80E3)           ; {ram.chamberCreatureAnimPhase} read the creature sprite-flip phase clock
2FC3: 3D              DEC     A                   ; tick the phase countdown
2FC4: 32 E3 80        LD      ($80E3),A           ; {ram.chamberCreatureAnimPhase}
2FC7: 20 15           JR      NZ,$2FDE            ; still running: go to the position step
2FC9: 3E 08           LD      A,$08
2FCB: 32 E3 80        LD      ($80E3),A           ; {ram.chamberCreatureAnimPhase} reload the phase clock to eight
2FCE: 3A DC 80        LD      A,($80DC)           ; {ram.chamberCreatureFrame} read the current flip tile
2FD1: 47              LD      B,A
2FD2: 3E 38           LD      A,$38
...
2FD9: 32 DC 80        LD      ($80DC),A           ; {ram.chamberCreatureFrame} commit the chosen creature frame
2FDC: 18 05           JR      $2FE3               ; into the position step

loc_2fde:
2FDE: E6 03           AND     $03                 ; act only on every 4th frame
2FE0: C2 29 30        JP      NZ,$3029            ; off-beat frame: just republish the sprite

loc_2fe3:
2FE3: 3A DF 80        LD      A,($80DF)           ; read the bounce velocity
2FE6: 4F              LD      C,A
2FE7: 3A DB 80        LD      A,($80DB)           ; {ram.chamberCreatureX} read the creature X
...
2FF0: 38 04           JR      C,$2FF6
2FF2: 3E FF           LD      A,$FF               ; reverse to leftward
2FF4: 18 06           JR      $2FFC

loc_2ff6:
2FF6: FE 19           CP      $19                 ; below the left wall?
2FF8: 30 05           JR      NC,$2FFF
2FFA: 3E 01           LD      A,$01               ; reverse to rightward

loc_2ffc:
2FFC: 32 DF 80        LD      ($80DF),A           ; store the bounce velocity

loc_2fff:
2FFF: 3A E0 80        LD      A,($80E0)           ; read the fall step
3002: 3C              INC     A                   ; accelerate the fall
3003: 32 E0 80        LD      ($80E0),A
3006: 47              LD      B,A
3007: 3A DE 80        LD      A,($80DE)           ; {ram.chamberCreatureFallY} read the creature fall-Y
...
3010: 38 17           JR      C,$3029
3012: 3E 86           LD      A,$86
3014: 32 DE 80        LD      ($80DE),A           ; {ram.chamberCreatureFallY} clamp the creature at the floor
...
301C: 3D              DEC     A
301D: 32 E0 80        LD      ($80E0),A           ; store the new fall step
3020: 3A DD 80        LD      A,($80DD)           ; {ram.chamberCreatureAttr} read the creature color
3023: 3C              INC     A                   ; advance the color
3024: E6 F7           AND     $F7                 ; hold the priority bit clear
3026: 32 DD 80        LD      ($80DD),A           ; {ram.chamberCreatureAttr} store the creature color

loc_3029:
3029: 21 2C 82        LD      HL,$822C            ; point at the creature sprite slot
302C: 3A 51 80        LD      A,($8051)           ; {ram.spriteCoordBias} read the cabinet coordinate bias
302F: 47              LD      B,A
3030: 3A DB 80        LD      A,($80DB)           ; {ram.chamberCreatureX} read the creature X
3033: 90              SUB     B                   ; make X screen-relative
3034: 77              LD      (HL),A              ; publish sprite X
3035: 23              INC     HL
3036: 3A DC 80        LD      A,($80DC)           ; {ram.chamberCreatureFrame} read the creature frame
3039: 77              LD      (HL),A              ; publish sprite tile
303A: 23              INC     HL
303B: 3A DD 80        LD      A,($80DD)           ; {ram.chamberCreatureAttr} read the creature color
303E: 77              LD      (HL),A              ; publish sprite color
303F: 23              INC     HL
3040: 3A DE 80        LD      A,($80DE)           ; {ram.chamberCreatureFallY} read the creature fall-Y
...
seedEnemyRecords:
30DE: 3E 09           LD      A,$09
30E0: 32 E9 80        LD      ($80E9),A           ; {ram.enemy1Sprite} seed enemy 1 sprite
30E3: 3E EC           LD      A,$EC
30E5: 32 E8 80        LD      ($80E8),A           ; {ram.enemy1X} seed enemy 1 start X
30E8: 3E 23           LD      A,$23
30EA: 32 EB 80        LD      ($80EB),A           ; seed enemy 1 start Y
30ED: 3E 04           LD      A,$04
30EF: 32 EA 80        LD      ($80EA),A           ; {ram.enemy1Attr} seed enemy 1 color
30F2: 3E 01           LD      A,$01
30F4: 32 F5 80        LD      ($80F5),A           ; {ram.enemy1State} set enemy 1 active
30F7: 32 F0 80        LD      ($80F0),A           ; {ram.enemy1Timer} seed enemy 1 action timer
30FA: 3E 04           LD      A,$04
30FC: 32 F8 80        LD      ($80F8),A           ; {ram.enemy1TargetCol} seed enemy 1 target column
30FF: 3A 28 80        LD      A,($8028)           ; {ram.level} read the level/difficulty counter
3102: E6 06           AND     $06                 ; keep the two speed-selector bits
3104: 47              LD      B,A
3105: 3E 07           LD      A,$07
3107: 90              SUB     B                   ; derive enemy speed (7,5,3,1 as level climbs)
3108: 32 F6 80        LD      ($80F6),A           ; {ram.enemy1MovePeriod} set enemy 1 move period
310B: 32 07 81        LD      ($8107),A           ; {ram.enemy2MovePeriod} set enemy 2 move period (same as enemy 1)
310E: 3E 09           LD      A,$09
3110: 32 FA 80        LD      ($80FA),A           ; {ram.enemy2Sprite} seed enemy 2 sprite
3113: 3E 04           LD      A,$04
3115: 32 FB 80        LD      ($80FB),A           ; {ram.enemy2Attr} seed enemy 2 color
3118: 3E 00           LD      A,$00
311A: 32 F9 80        LD      ($80F9),A           ; {ram.enemy2X} seed enemy 2 start X
311D: 32 06 81        LD      ($8106),A           ; {ram.enemy2State} set enemy 2 dormant
3120: 3E 01           LD      A,$01
3122: 32 01 81        LD      ($8101),A           ; {ram.enemy2Timer} seed enemy 2 action timer
3125: 3E 05           LD      A,$05
3127: 32 09 81        LD      ($8109),A           ; {ram.enemy2TargetCol} seed enemy 2 target column
...
updateEnemy1:
312D: 3A 10 80        LD      A,($8010)           ; {ram.playPhaseCounter} read the board-startup ramp
...
3135: 21 E8 80        LD      HL,$80E8            ; {ram.enemy1X} load enemy 1 record
...
3159: 3A 51 80        LD      A,($8051)           ; {ram.spriteCoordBias} read the coordinate bias
315C: 47              LD      B,A
315D: 7E              LD      A,(HL)
315E: 80              ADD     A,B
315F: 12              LD      (DE),A              ; publish enemy 1 sprite Y
3160: 3A 01 80        LD      A,($8001)           ; {ram.gameState} read the game mode
3163: FE 04           CP      $04                 ; attract demo?
3165: 20 08           JR      NZ,$316F            ; {code.updateEnemy2} live play: run enemy 2 too
3167: 3A 10 80        LD      A,($8010)           ; {ram.playPhaseCounter} read the startup ramp again
...
updateEnemy2:
316F: 21 F9 80        LD      HL,$80F9            ; {ram.enemy2X} load enemy 2 record
...
3180: 11 F9 80        LD      DE,$80F9            ; {ram.enemy2X}
...
318B: 21 F9 80        LD      HL,$80F9            ; {ram.enemy2X}
318E: 01 03 00        LD      BC,$0003
3191: ED B0           LDIR                        ; stage enemy 2 position, tile, color
3193: 3A 51 80        LD      A,($8051)           ; {ram.spriteCoordBias} read the coordinate bias
3196: 47              LD      B,A
3197: 7E              LD      A,(HL)
3198: 80              ADD     A,B
...
stepEnemyMover:
319D: 3A 93 80        LD      A,($8093)           ; {ram.enemyWorkTargetCol} read the mover target column
31A0: 47              LD      B,A
31A1: 3A 7A 80        LD      A,($807A)           ; read the mover locked column
...
31A8: 3A 90 80        LD      A,($8090)           ; {ram.enemyWorkState} read the mover state byte
31AB: B7              OR      A
31AC: FA DA 34        JP      M,$34DA             ; {code.advanceDormantMover} negative state: dormant handling
31AF: 20 1F           JR      NZ,$31D0            ; positive state: run the active step
31B1: 3A 8B 80        LD      A,($808B)           ; {ram.enemyActionTimer} zero state: read the respawn delay
...
31B9: 3E 01           LD      A,$01
31BB: 32 90 80        LD      ($8090),A           ; {ram.enemyWorkState} set the mover active again
31BE: 32 8B 80        LD      ($808B),A           ; {ram.enemyActionTimer} re-arm its action timer
31C1: 3E E4           LD      A,$E4
31C3: 32 83 80        LD      ($8083),A           ; drop the mover back at its start X
31C6: 3E 23           LD      A,$23
31C8: 32 86 80        LD      ($8086),A           ; put it back on the top row
31CB: 3E EC           LD      A,$EC
31CD: 32 E8 80        LD      ($80E8),A           ; {ram.enemy1X} reset enemy 1 record X

loc_31d0:
31D0: 3A A1 80        LD      A,($80A1)           ; {ram.laserState} is the laser box live?
31D3: B7              OR      A
31D4: 28 2D           JR      Z,$3203             ; no live laser: skip the laser-hit test
31D6: 3A 83 80        LD      A,($8083)           ; read the mover X
31D9: 67              LD      H,A
31DA: 3A 94 80        LD      A,($8094)           ; {ram.reactionObjX} read the laser box X
31DD: C6 04           ADD     A,$04               ; box leading edge
31DF: BC              CP      H
31E0: 38 21           JR      C,$3203             ; mover beyond the laser box: no hit
31E2: D6 0C           SUB     $0C                 ; box trailing edge
31E4: BC              CP      H
31E5: 30 1C           JR      NC,$3203            ; mover before the box: no hit
31E7: 3A 86 80        LD      A,($8086)           ; read the mover Y
31EA: 6F              LD      L,A
31EB: 3A 97 80        LD      A,($8097)           ; {ram.reactionObjY} read the laser box Y
31EE: C6 03           ADD     A,$03
31F0: BD              CP      L
31F1: 38 10           JR      C,$3203             ; mover below the box: no hit
31F3: D6 07           SUB     $07
31F5: BD              CP      L
31F6: 30 0B           JR      NC,$3203            ; mover above the box: no hit
31F8: CD 73 46        CALL    $4673               ; {code.awardOnePoint} laser hit: score the enemy kill
31FB: 3E C0           LD      A,$C0
31FD: 32 90 80        LD      ($8090),A           ; {ram.enemyWorkState} park the enemy in the death state
3200: C3 DA 34        JP      $34DA               ; {code.advanceDormantMover} run the dormant/death tick

loc_3203:
3203: 3A 7A 80        LD      A,($807A)           ; read the mover locked column
3206: B7              OR      A
3207: 20 4F           JR      NZ,$3258            ; column-locked mover: skip the player-catch test
3209: 3A C1 80        LD      A,($80C1)           ; {ram.digCollisionState} is a dig reaction active?
320C: B7              OR      A
320D: 20 49           JR      NZ,$3258            ; dig reaction owns the mover: skip the catch test
320F: 3A 83 80        LD      A,($8083)           ; read the mover X
3212: 67              LD      H,A
3213: 3A 68 80        LD      A,($8068)           ; {ram.playerY} read the player box (work-Y)
3216: C6 08           ADD     A,$08               ; box leading edge
3218: BC              CP      H
3219: 38 3D           JR      C,$3258             ; mover beyond the player box: no catch
321B: D6 12           SUB     $12                 ; box trailing edge
321D: BC              CP      H
321E: 30 38           JR      NC,$3258            ; mover before the box: no catch
3220: 3A 86 80        LD      A,($8086)           ; read the mover Y
3223: 6F              LD      L,A
3224: 3A 6B 80        LD      A,($806B)           ; {ram.playerX} read the player box (work-X)
3227: C6 07           ADD     A,$07
3229: BD              CP      L
322A: 38 2C           JR      C,$3258             ; mover below the player: no catch
322C: D6 0F           SUB     $0F
322E: BD              CP      L
322F: 30 27           JR      NC,$3258            ; mover above the player: no catch
3231: 3A 93 80        LD      A,($8093)           ; {ram.enemyWorkTargetCol}
3234: 32 7A 80        LD      ($807A),A           ; lock the mover onto the caught column
3237: 3A 68 80        LD      A,($8068)           ; {ram.playerY}
323A: 32 83 80        LD      ($8083),A           ; snap the mover onto the player
323D: 3A 6B 80        LD      A,($806B)           ; {ram.playerX}
3240: 32 86 80        LD      ($8086),A
3243: 3E 81           LD      A,$81
3245: 32 8B 80        LD      ($808B),A           ; {ram.enemyActionTimer} arm the catch linger countdown
3248: 3E 17           LD      A,$17
324A: 32 84 80        LD      ($8084),A           ; {ram.enemyWorkSprite} set the capture-pose sprite
324D: 3E 35           LD      A,$35
324F: 32 69 80        LD      ($8069),A           ; {ram.playerFacing} set the player caught pose
...
loc_3258:
3258: 3A 86 80        LD      A,($8086)           ; read the mover Y
325B: FE 23           CP      $23                 ; on the top row?
325D: 20 18           JR      NZ,$3277            ; not top row: check the far edge
325F: 3A 93 80        LD      A,($8093)           ; {ram.enemyWorkTargetCol}
3262: FE 04           CP      $04                 ; target column 4?
3264: 3A 83 80        LD      A,($8083)           ; read the mover X
3267: 20 06           JR      NZ,$326F
...
loc_3277:
3277: 3A 83 80        LD      A,($8083)           ; read the mover X
327A: FE DC           CP      $DC                 ; far-edge column?
327C: 20 0B           JR      NZ,$3289            ; not the far edge: decode the cell
327E: 3A 86 80        LD      A,($8086)           ; read the mover Y
3281: FE 33           CP      $33
...
loc_3289:
3289: 3A 83 80        LD      A,($8083)           ; read the mover X
...
32AD: 78              LD      A,B
32AE: 32 8D 80        LD      ($808D),A           ; {ram.subtilePhase} store the sub-tile phase selector
32B1: 3E 00           LD      A,$00
32B3: 47              LD      B,A
32B4: CB 3C           SRL     H
32B6: 1F              RRA
...
32BD: 6F              LD      L,A
32BE: 09              ADD     HL,BC
32BF: 01 00 90        LD      BC,$9000            ; {hard.videoRam} tilemap base
32C2: 09              ADD     HL,BC               ; form the probe-cell pointer
32C3: 22 89 80        LD      ($8089),HL          ; {ram.probeCellPtr} store the probe-cell pointer
32C6: 3A 93 80        LD      A,($8093)           ; {ram.enemyWorkTargetCol} read the target column
32C9: FE 05           CP      $05                 ; target column 5?
32CB: CA 45 33        JP      Z,$3345             ; steer the column-5 probe table
32CE: 3A 92 80        LD      A,($8092)           ; {ram.enemyWorkDir} read the travel direction
32D1: 3D              DEC     A
32D2: CA F2 32        JP      Z,$32F2             ; direction 1
32D5: 3D              DEC     A
32D6: CA 11 33        JP      Z,$3311             ; direction 2
32D9: 3D              DEC     A
32DA: CA 26 33        JP      Z,$3326             ; direction 3
...
loc_32f2:
32F2: 3A 83 80        LD      A,($8083)           ; read the mover X
32F5: C6 04           ADD     A,$04
...
loc_3326:
3326: 3A 83 80        LD      A,($8083)           ; read the mover X
3329: C6 04           ADD     A,$04
...
loc_3345:
3345: 3A 92 80        LD      A,($8092)           ; {ram.enemyWorkDir} column 5: read the travel direction
3348: 3D              DEC     A
3349: CA 69 33        JP      Z,$3369             ; direction 1
334C: 3D              DEC     A
334D: CA 88 33        JP      Z,$3388             ; direction 2
3350: 3D              DEC     A
3351: CA 9D 33        JP      Z,$339D             ; direction 3
...
loc_3369:
3369: 3A 83 80        LD      A,($8083)           ; read the mover X
336C: C6 04           ADD     A,$04
...
loc_339d:
339D: 3A 83 80        LD      A,($8083)           ; read the mover X
33A0: C6 04           ADD     A,$04
...
tileInProbeRow:
33BC: 3A 8D 80        LD      A,($808D)           ; {ram.subtilePhase} read the sub-tile phase (row selector)
33BF: 5F              LD      E,A
33C0: 16 00           LD      D,$00
33C2: 2A 89 80        LD      HL,($8089)          ; {ram.probeCellPtr} point at the probe cell
33C5: 3A 86 80        LD      A,($8086)           ; read the mover Y
33C8: C6 05           ADD     A,$05
33CA: E6 07           AND     $07                 ; straddling a cell boundary?
33CC: 20 01           JR      NZ,$33CF
...
33DA: 3A 8D 80        LD      A,($808D)           ; {ram.subtilePhase} read the sub-tile phase
33DD: C6 20           ADD     A,$20               ; select table A phase row (phase+32)
33DF: 5F              LD      E,A
33E0: 16 00           LD      D,$00
33E2: 2A 89 80        LD      HL,($8089)          ; {ram.probeCellPtr} point at the probe cell
33E5: 01 E0 FF        LD      BC,$FFE0            ; offset one map row back
33E8: 09              ADD     HL,BC               ; point one row back
33E9: 22 34 81        LD      ($8134),HL          ; {ram.savedCellPtr} stash the one-row-back cell
...
33F7: 3A 8D 80        LD      A,($808D)           ; {ram.subtilePhase} read the sub-tile phase again
33FA: A7              AND     A
33FB: C8              RET     Z                   ; phase 0: the table-A hit is final
33FC: D6 20           SUB     $20                 ; select table B phase row (phase-32)
33FE: 5F              LD      E,A
33FF: DD 2A 34 81     LD      IX,($8134)          ; {ram.savedCellPtr} reload the stashed one-row-back cell
...
nextTileInProbeRow:
3410: 3A 8D 80        LD      A,($808D)           ; {ram.subtilePhase} read the mover's sub-tile phase (which row to scan)
3413: 5F              LD      E,A
3414: 16 00           LD      D,$00
3416: 2A 89 80        LD      HL,($8089)          ; {ram.probeCellPtr} load the enemy's current display-cell pointer
...
3425: 3A 8D 80        LD      A,($808D)           ; {ram.subtilePhase} read the mover's sub-tile phase
3428: C6 20           ADD     A,$20               ; shift to the first table's row for this phase
342A: 5F              LD      E,A
342B: 16 00           LD      D,$00
342D: 2A 89 80        LD      HL,($8089)          ; {ram.probeCellPtr} the enemy's current cell pointer
3430: 01 20 00        LD      BC,$0020
3433: 09              ADD     HL,BC               ; advance the pointer one memory-row ahead
3434: 22 34 81        LD      ($8134),HL          ; {ram.savedCellPtr} stash the advanced pointer for the second probe
...
343F: 3A 8D 80        LD      A,($808D)           ; {ram.subtilePhase} reread the sub-tile phase
3442: A7              AND     A
3443: C8              RET     Z                   ; phase 0: accept the first match, done
3444: D6 20           SUB     $20                 ; shift the phase the other way for the second table
3446: 5F              LD      E,A
3447: DD 2A 34 81     LD      IX,($8134)          ; {ram.savedCellPtr} reload the advanced cell pointer
...
3458: 3A 8B 80        LD      A,($808B)           ; {ram.enemyActionTimer} read the enemy-catch hold countdown
...
3464: C0              RET     NZ
3465: 3A 84 80        LD      A,($8084)           ; {ram.enemyWorkSprite} read the catch sprite
3468: EE 80           XOR     $80                 ; flip its frame/mirror bit
346A: 32 84 80        LD      ($8084),A           ; {ram.enemyWorkSprite}
346D: 3A 69 80        LD      A,($8069)           ; {ram.playerFacing} read the actor facing
...
347B: 18 13           JR      $3490               ; run the shared mover step
...
loc_3490:
3490: 3A 8B 80        LD      A,($808B)           ; {ram.enemyActionTimer} tick the enemy's per-step move counter
3493: 3D              DEC     A                   ; count it down
3494: 32 8B 80        LD      ($808B),A           ; {ram.enemyActionTimer}
3497: 20 39           JR      NZ,$34D2            ; still counting: no step this frame
3499: 3A 91 80        LD      A,($8091)           ; {ram.enemyWorkMovePeriod} reload the move counter from the enemy's period
349C: 32 8B 80        LD      ($808B),A           ; {ram.enemyActionTimer}
349F: 7A              LD      A,D
34A0: 32 92 80        LD      ($8092),A           ; {ram.enemyWorkDir} publish this preset's travel direction
34A3: CB 40           BIT     0,B                 ; does this preset move the horizontal axis?
34A5: 28 2B           JR      Z,$34D2             ; no horizontal step: jump to the vertical step
34A7: 3A 83 80        LD      A,($8083)           ; the enemy's horizontal position
...
34B0: E6 06           AND     $06
34B2: 20 02           JR      NZ,$34B6
34B4: 1E 17           LD      E,$17               ; walk frame 0

loc_34b6:
34B6: FE 02           CP      $02
34B8: 20 02           JR      NZ,$34BC
34BA: 1E 14           LD      E,$14               ; walk frame 1

loc_34bc:
34BC: FE 04           CP      $04
34BE: 20 02           JR      NZ,$34C2
34C0: 1E 15           LD      E,$15               ; walk frame 2

loc_34c2:
34C2: FE 06           CP      $06
34C4: 20 02           JR      NZ,$34C8
34C6: 1E 16           LD      E,$16               ; walk frame 3

loc_34c8:
34C8: 7B              LD      A,E
34C9: CB 78           BIT     7,B                 ; moving left or right?
34CB: 20 02           JR      NZ,$34CF
34CD: EE 80           XOR     $80                 ; mirror the walk sprite for the other direction

loc_34cf:
34CF: 32 84 80        LD      ($8084),A           ; {ram.enemyWorkSprite} store the chosen walk-frame sprite

loc_34d2:
34D2: 3A 86 80        LD      A,($8086)           ; the enemy's vertical position
34D5: 81              ADD     A,C                 ; step it by the preset's vertical delta
34D6: 32 86 80        LD      ($8086),A           ; store the new vertical position
34D9: C9              RET

; Tick a dead / dormant enemy toward respawn.
advanceDormantMover:
34DA: 3A 90 80        LD      A,($8090)           ; {ram.enemyWorkState} read the free-running tick counter
...
34E5: C0              RET     NZ
34E6: 3A 85 80        LD      A,($8085)           ; read the slow secondary counter
34E9: 3C              INC     A                   ; advance it
34EA: E6 F7           AND     $F7                 ; holding its bit 3 clear
34EC: 32 85 80        LD      ($8085),A           ; store the secondary counter
34EF: C9              RET
...
34F5: 32 8B 80        LD      ($808B),A           ; {ram.enemyActionTimer} seed the enemy's cadence/animation byte
34F8: 3E 09           LD      A,$09               ; re-arm the actor state to its restart value
34FA: 32 84 80        LD      ($8084),A           ; {ram.enemyWorkSprite} store the re-armed state
34FD: C9              RET
...
3700: 32 0B 81        LD      ($810B),A           ; {ram.enemy3Tile} seed the primary tile
3703: 3E 24           LD      A,$24
3705: 32 0A 81        LD      ($810A),A           ; {ram.enemy3X} primary start column
3708: 3E 00           LD      A,$00
370A: 32 0D 81        LD      ($810D),A           ; {ram.enemy3Y} primary start row (top of the lane)
370D: 3E 97           LD      A,$97
370F: 32 0C 81        LD      ($810C),A           ; {ram.enemy3Attr} primary paired-display byte
3712: 3E 00           LD      A,$00
3714: 32 0E 81        LD      ($810E),A           ; {ram.enemy3StepX} no horizontal drift
3717: 3E 01           LD      A,$01
3719: 32 0F 81        LD      ($810F),A           ; {ram.enemy3StepY} step down one per beat
371C: 3E 01           LD      A,$01
371E: 32 12 81        LD      ($8112),A           ; {ram.enemy3Timer} arm the cadence timer
3721: 3E 00           LD      A,$00
3723: 32 7B 80        LD      ($807B),A           ; {ram.boardEndPhase} drop back to the un-spawned phase
3726: 3E 2F           LD      A,$2F
3728: 32 1C 81        LD      ($811C),A           ; {ram.enemy3TwinTile} twin body start tile
372B: 3E 34           LD      A,$34
372D: 32 1B 81        LD      ($811B),A           ; {ram.enemy3TwinX} twin start column (primary + 16)
3730: 3E 00           LD      A,$00
3732: 32 1E 81        LD      ($811E),A           ; {ram.enemy3TwinY} twin start row
3735: 3E 97           LD      A,$97
3737: 32 1D 81        LD      ($811D),A           ; {ram.enemy3TwinAttr} twin paired-display byte
373A: 3E 00           LD      A,$00
373C: 32 1F 81        LD      ($811F),A           ; twin move vector low byte
373F: 32 20 81        LD      ($8120),A           ; twin move vector high byte
3742: 3E 01           LD      A,$01
3744: 32 23 81        LD      ($8123),A           ; {ram.enemy3TwinTimer} arm the twin cadence timer
3747: C9              RET
...
3748: 3A 7B 80        LD      A,($807B)           ; {ram.boardEndPhase} read the board-end/spawn phase
374B: B7              OR      A
374C: C2 CF 37        JP      NZ,$37CF            ; {code.spawnAltPhaseActor} still mid-spawn: hand to the spawn handler
374F: 3A 10 80        LD      A,($8010)           ; {ram.playPhaseCounter} read the board-startup phase counter
3752: FE 0A           CP      $0A
3754: D2 13 3A        JP      NC,$3A13            ; {code.advanceActorMovers} phase 10+: run the live enemy-3 mover
3757: FE 03           CP      $03
3759: 38 23           JR      C,$377E             ; phases 0-2: run the inline march below
375B: FE 06           CP      $06
375D: 38 08           JR      C,$3767             ; phases 3-5: seed the actor on its first live frame
375F: FE 09           CP      $09
...
loc_3767:
3767: 3A 79 80        LD      A,($8079)           ; {ram.playerActive} read the actor-active flag
376A: A7              AND     A
376B: 20 11           JR      NZ,$377E            ; already present: skip the one-shot seed
376D: 3E 00           LD      A,$00
376F: 32 0F 81        LD      ($810F),A           ; {ram.enemy3StepY} no vertical drift
3772: 3D              DEC     A
3773: 32 0E 81        LD      ($810E),A           ; {ram.enemy3StepX} march one cell left each beat
3776: 32 79 80        LD      ($8079),A           ; {ram.playerActive} mark the actor present
3779: 3E 2D           LD      A,$2D
377B: 32 68 80        LD      ($8068),A           ; {ram.playerY} park the actor's start cell

loc_377e:
377E: 3A 0E 81        LD      A,($810E)           ; {ram.enemy3StepX} read the step vector low byte
3781: 6F              LD      L,A
3782: 3A 0F 81        LD      A,($810F)           ; {ram.enemy3StepY} and the high byte
3785: 67              LD      H,A
3786: 3A 12 81        LD      A,($8112)           ; {ram.enemy3Timer} tick the cadence timer
3789: 3D              DEC     A                   ; count it down
378A: 32 12 81        LD      ($8112),A           ; {ram.enemy3Timer}
378D: 20 18           JR      NZ,$37A7            ; still counting: skip the walk-frame flip
378F: 3E 08           LD      A,$08
3791: 32 12 81        LD      ($8112),A           ; {ram.enemy3Timer} reload the cadence timer
3794: 3A 0B 81        LD      A,($810B)           ; {ram.enemy3Tile} read the current walk tile
3797: 47              LD      B,A
3798: 3E 2E           LD      A,$2E
379A: B8              CP      B                   ; toggle the walk tile to its other frame
379B: 20 02           JR      NZ,$379F
379D: 3E AF           LD      A,$AF

loc_379f:
379F: 32 0B 81        LD      ($810B),A           ; {ram.enemy3Tile} store the walk tile
37A2: EE 01           XOR     $01                 ; twin shows the paired frame
37A4: 32 1C 81        LD      ($811C),A           ; {ram.enemy3TwinTile}

loc_37a7:
37A7: 3A 12 81        LD      A,($8112)           ; {ram.enemy3Timer}
37AA: E6 03           AND     $03                 ; advance only on every 4th tick
37AC: 20 1E           JR      NZ,$37CC
37AE: 3A 0A 81        LD      A,($810A)           ; {ram.enemy3X} read the actor's X
37B1: FE 11           CP      $11
37B3: 38 17           JR      C,$37CC             ; hold until past the left margin
37B5: 85              ADD     A,L                 ; march the actor along X
37B6: 32 0A 81        LD      ($810A),A           ; {ram.enemy3X}
37B9: C6 10           ADD     A,$10
37BB: 32 1B 81        LD      ($811B),A           ; {ram.enemy3TwinX} place the twin 16 cells ahead
37BE: 3A 0D 81        LD      A,($810D)           ; {ram.enemy3Y} read the actor's Y
37C1: FE 17           CP      $17
37C3: 30 07           JR      NC,$37CC            ; stop descending once at the floor
37C5: 84              ADD     A,H                 ; descend the actor one row
37C6: 32 0D 81        LD      ($810D),A           ; {ram.enemy3Y}
37C9: 32 1E 81        LD      ($811E),A           ; {ram.enemy3TwinY} mirror the row into the twin
...
spawnAltPhaseActor:
37CF: 3A 7B 80        LD      A,($807B)           ; {ram.boardEndPhase} read the board-end/spawn phase
37D2: 3C              INC     A
...
37D9: 28 01           JR      Z,$37DC
37DB: 3C              INC     A                   ; ...otherwise start row 23

loc_37dc:
37DC: 32 0D 81        LD      ($810D),A           ; {ram.enemy3Y} set the actor's start row
37DF: 32 1E 81        LD      ($811E),A           ; {ram.enemy3TwinY} twin mirrors the row
37E2: 3E FF           LD      A,$FF
37E4: 32 7B 80        LD      ($807B),A           ; {ram.boardEndPhase} mark the actor live
37E7: CD 6B 4C        CALL    $4C6B               ; {code.requestSound7} play the ship-arrival spawn sound
37EA: 3E 10           LD      A,$10
37EC: 32 0A 81        LD      ($810A),A           ; {ram.enemy3X} park the primary at its start column
37EF: C6 10           ADD     A,$10
37F1: 32 1B 81        LD      ($811B),A           ; {ram.enemy3TwinX} twin trailing 16 columns to the right
37F4: 3E 2E           LD      A,$2E
37F6: 32 0B 81        LD      ($810B),A           ; {ram.enemy3Tile} primary spawn tile
37F9: 3E 2F           LD      A,$2F
37FB: 32 1C 81        LD      ($811C),A           ; {ram.enemy3TwinTile} twin spawn tile
37FE: 3E 01           LD      A,$01
3800: 32 12 81        LD      ($8112),A           ; {ram.enemy3Timer} arm the cadence timer
3803: 3E 97           LD      A,$97
3805: 32 0C 81        LD      ($810C),A           ; {ram.enemy3Attr} primary paired-display byte
3808: 32 1D 81        LD      ($811D),A           ; {ram.enemy3TwinAttr} twin paired-display byte
380B: DD 21 A3 93     LD      IX,$93A3            ; {hard.videoRam} figure anchor cell in the tilemap
...
384A: 3A 12 81        LD      A,($8112)           ; {ram.enemy3Timer} tick the ship's cadence timer
384D: 3D              DEC     A                   ; count it down
384E: 32 12 81        LD      ($8112),A           ; {ram.enemy3Timer}
3851: 20 18           JR      NZ,$386B            ; still counting: skip the walk-tile flip
3853: 3E 08           LD      A,$08
3855: 32 12 81        LD      ($8112),A           ; {ram.enemy3Timer} reload the cadence timer
3858: 3A 0B 81        LD      A,($810B)           ; {ram.enemy3Tile} read the current walk tile
385B: 47              LD      B,A
385C: 3E 2E           LD      A,$2E
385E: B8              CP      B                   ; toggle the walk tile to its other frame
385F: 20 02           JR      NZ,$3863
3861: 3E AF           LD      A,$AF

loc_3863:
3863: 32 0B 81        LD      ($810B),A           ; {ram.enemy3Tile} store the walk tile
3866: EE 01           XOR     $01                 ; twin shows the paired frame
3868: 32 1C 81        LD      ($811C),A           ; {ram.enemy3TwinTile}
...
3873: 3A 0D 81        LD      A,($810D)           ; {ram.enemy3Y} read the ship's Y
3876: FE 17           CP      $17
3878: 38 20           JR      C,$389A             ; below the travel row: go descend
387A: 3A 0A 81        LD      A,($810A)           ; {ram.enemy3X} read the ship's X
387D: FE 24           CP      $24
387F: 38 3B           JR      C,$38BC             ; not yet at the far column: keep marching right
3881: 3A 0D 81        LD      A,($810D)           ; {ram.enemy3Y}
3884: FE 17           CP      $17                 ; at the travel row and far column: it has landed
3886: 20 12           JR      NZ,$389A
3888: 3E 00           LD      A,$00
388A: 32 79 80        LD      ($8079),A           ; {ram.playerActive} clear the arrival flag
388D: 32 68 80        LD      ($8068),A           ; {ram.playerY}
3890: 3C              INC     A
3891: 32 7D 80        LD      ($807D),A           ; {ram.postTransitionMode} arm the level-advance transition
3894: CD 5B 1B        CALL    $1B5B               ; {code.stageObjectSpriteRecord} build the deferral sprite record before landing
3897: 3A 0D 81        LD      A,($810D)           ; {ram.enemy3Y}

loc_389a:
389A: A7              AND     A
389B: 20 15           JR      NZ,$38B2            ; above the floor: descend one row
389D: 3A 7C 80        LD      A,($807C)           ; {ram.transitionTimer} read the landing hold timer
38A0: A7              AND     A
38A1: C0              RET     NZ                  ; hold still running: keep waiting
38A2: 3E 78           LD      A,$78
38A4: 32 7C 80        LD      ($807C),A           ; {ram.transitionTimer} re-arm the 120-frame landing hold
38A7: 3E 09           LD      A,$09
38A9: 32 0B 81        LD      ($810B),A           ; {ram.enemy3Tile} drop the ship to its idle tile
38AC: 32 1C 81        LD      ($811C),A           ; {ram.enemy3TwinTile} twin idle tile too
38AF: C3 4C 3A        JP      $3A4C               ; {code.stageActorSpriteRecords} stage the sprite records

loc_38b2:
38B2: 3D              DEC     A
38B3: 32 0D 81        LD      ($810D),A           ; {ram.enemy3Y} step the ship down one row
38B6: 32 1E 81        LD      ($811E),A           ; {ram.enemy3TwinY} mirror into the twin
38B9: C3 4C 3A        JP      $3A4C               ; {code.stageActorSpriteRecords} stage the sprite records

loc_38bc:
38BC: 3C              INC     A
38BD: 32 0A 81        LD      ($810A),A           ; {ram.enemy3X} step the ship right one column
38C0: C6 10           ADD     A,$10
38C2: 32 1B 81        LD      ($811B),A           ; {ram.enemy3TwinX} twin trails 16 columns
...
38C8: 3A 0A 81        LD      A,($810A)           ; {ram.enemy3X} read the actor's X
38CB: FE 80           CP      $80
38CD: D2 45 39        JP      NC,$3945            ; {code.paceActorCadence} still high in the field: keep it moving
38D0: 3E F0           LD      A,$F0
38D2: 32 0A 81        LD      ($810A),A           ; {ram.enemy3X} ran off the edge: park X back at the start edge
38D5: C6 10           ADD     A,$10
38D7: 32 1B 81        LD      ($811B),A           ; {ram.enemy3TwinX} twin trails 16 ahead
38DA: 3E 1F           LD      A,$1F
38DC: 32 0D 81        LD      ($810D),A           ; {ram.enemy3Y} reset the primary row
38DF: 32 1E 81        LD      ($811E),A           ; {ram.enemy3TwinY} twin row too
38E2: 3E 2A           LD      A,$2A
38E4: 32 1C 81        LD      ($811C),A           ; {ram.enemy3TwinTile} twin tile
38E7: 3E 2B           LD      A,$2B
38E9: 32 0B 81        LD      ($810B),A           ; {ram.enemy3Tile} primary tile
38EC: 3E 00           LD      A,$00
38EE: 32 0E 81        LD      ($810E),A           ; {ram.enemy3StepX} no horizontal drift
38F1: 3E 01           LD      A,$01
38F3: 32 0F 81        LD      ($810F),A           ; {ram.enemy3StepY} step down one per beat
38F6: 32 12 81        LD      ($8112),A           ; {ram.enemy3Timer} arm the cadence timer
38F9: 3E 93           LD      A,$93
38FB: 32 0C 81        LD      ($810C),A           ; {ram.enemy3Attr} primary paired-display byte
38FE: 32 1D 81        LD      ($811D),A           ; {ram.enemy3TwinAttr} twin paired-display byte
3901: DD 21 A3 93     LD      IX,$93A3            ; {hard.videoRam} figure anchor cell in the tilemap
...
paceActorCadence:
3945: 3A 12 81        LD      A,($8112)           ; {ram.enemy3Timer} tick the period-8 cadence timer
...
394E: 3E 08           LD      A,$08
3950: 32 12 81        LD      ($8112),A           ; {ram.enemy3Timer} reload the cadence timer to 8
...
easeActorToRest:
3968: 3A 12 81        LD      A,($8112)           ; {ram.enemy3Timer} read the cadence timer
396B: E6 03           AND     $03
396D: C2 4C 3A        JP      NZ,$3A4C            ; {code.stageActorSpriteRecords} act only every 4th tick, else just redraw
3970: 3A 0A 81        LD      A,($810A)           ; {ram.enemy3X} read the actor's coordinate
3973: FE C1           CP      $C1
...
3979: 32 0A 81        LD      ($810A),A           ; {ram.enemy3X}
397C: C6 10           ADD     A,$10
397E: 32 1B 81        LD      ($811B),A           ; {ram.enemy3TwinX} twin trails a constant 16
3981: C3 4C 3A        JP      $3A4C               ; {code.stageActorSpriteRecords} stage the sprite records

; Spawn the actor's twin sprite.
spawnTwinActor:
3984: 3A 0D 81        LD      A,($810D)           ; {ram.enemy3Y} read the spawn-request byte
3987: A7              AND     A
3988: C8              RET     Z                   ; nothing pending: return without spawning
3989: 3E 00           LD      A,$00
398B: 32 0D 81        LD      ($810D),A           ; {ram.enemy3Y} consume the spawn request
398E: 32 1E 81        LD      ($811E),A           ; {ram.enemy3TwinY} twin mirror too
3991: DD 21 E4 90     LD      IX,$90E4            ; {hard.videoRam} figure anchor cell in the tilemap
...
39D4: 3E 09           LD      A,$09
39D6: 32 0B 81        LD      ($810B),A           ; {ram.enemy3Tile} seed the primary tile
39D9: 32 1C 81        LD      ($811C),A           ; {ram.enemy3TwinTile} twin tile
39DC: 3E 00           LD      A,$00
39DE: 32 0A 81        LD      ($810A),A           ; {ram.enemy3X} primary start column
39E1: 32 1B 81        LD      ($811B),A           ; {ram.enemy3TwinX} twin start column
39E4: 32 0C 81        LD      ($810C),A           ; {ram.enemy3Attr} primary state byte
39E7: 32 1D 81        LD      ($811D),A           ; {ram.enemy3TwinAttr} twin state byte
39EA: 32 17 81        LD      ($8117),A           ; primary sub-state
39ED: 32 28 81        LD      ($8128),A           ; twin sub-state
39F0: 3E B4           LD      A,$B4
39F2: 32 12 81        LD      ($8112),A           ; {ram.enemy3Timer} arm the primary ~3-second countdown
39F5: 32 23 81        LD      ($8123),A           ; {ram.enemy3TwinTimer} twin countdown too
39F8: 3E 06           LD      A,$06
39FA: 32 1A 81        LD      ($811A),A           ; primary per-record constant
39FD: 3C              INC     A
39FE: 32 2B 81        LD      ($812B),A           ; twin per-record constant (one higher)
3A01: 3A 28 80        LD      A,($8028)           ; {ram.level} read the level counter
3A04: E6 06           AND     $06                 ; derive a level-staggered start phase
3A06: 47              LD      B,A
3A07: 3E 07           LD      A,$07
3A09: 90              SUB     B
3A0A: 32 18 81        LD      ($8118),A           ; primary start phase
3A0D: 32 29 81        LD      ($8129),A           ; twin start phase
...
advanceActorMovers:
3A13: 21 0A 81        LD      HL,$810A            ; {ram.enemy3X} point at the primary enemy-3 record
...
3A2C: 3A 78 80        LD      A,($8078)           ; {ram.treasureCollected} read the diamond-collected latch (twin gate)
3A2F: B7              OR      A
...
3A4C: 11 38 82        LD      DE,$8238            ; {ram.enemy3SpriteSlot} destination: enemy-3 sprite slot
3A4F: 21 0A 81        LD      HL,$810A            ; {ram.enemy3X} primary record start
3A52: 01 03 00        LD      BC,$0003
3A55: ED B0           LDIR                        ; copy the first three record bytes verbatim
3A57: 3A 51 80        LD      A,($8051)           ; {ram.spriteCoordBias} read the shared vertical sprite offset
3A5A: 47              LD      B,A
3A5B: 7E              LD      A,(HL)              ; the record's Y
3A5C: 80              ADD     A,B
3A5D: 12              LD      (DE),A              ; add the offset and store the sprite Y
3A5E: 78              LD      A,B
3A5F: 11 3C 82        LD      DE,$823C            ; {ram.enemy3TwinSpriteSlot} destination: enemy-3 twin sprite slot
3A62: 21 1B 81        LD      HL,$811B            ; {ram.enemy3TwinX} twin record start
...
3A8E: DD 21 8C 92     LD      IX,$928C            ; {hard.videoRam} write into video RAM (tilemap)
3A92: DD 36 00 01     LD      (IX+$00),$01        ; stamp the first marker cell
3A96: 3E 0C           LD      A,$0C
3A98: 32 58 80        LD      ($8058),A           ; {ram.tileCol} target column 12
3A9B: 3E 0D           LD      A,$0D
3A9D: 32 59 80        LD      ($8059),A           ; {ram.tileRow} target row 13
...
3AA6: 3E 06           LD      A,$06
3AA8: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} run of 6 marker glyphs
...
3AB9: DD 21 8E 92     LD      IX,$928E            ; {hard.videoRam} write into video RAM (tilemap)
3ABD: 3A 4C 80        LD      A,($804C)           ; {ram.coinsPerCreditA} read the coins-per-credit A setting
3AC0: DD 77 00        LD      (IX+$00),A          ; show its digit tile
3AC3: 3E 0E           LD      A,$0E
3AC5: 32 58 80        LD      ($8058),A           ; {ram.tileCol} target column 14
3AC8: 3E 0C           LD      A,$0C
3ACA: 32 59 80        LD      ($8059),A           ; {ram.tileRow} target row 12
...
3AD3: 3A 4C 80        LD      A,($804C)           ; {ram.coinsPerCreditA} reread the coins-per-credit A count
3AD6: A7              AND     A
3AD7: 28 08           JR      Z,$3AE1             ; zero count uses the singular label
...
loc_3ae7:
3AE7: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} set the label run length
3AEA: CD EA 3D        CALL    $3DEA               ; {code.copyTileColumn} copy the chosen label down the column
3AED: 3A 4C 80        LD      A,($804C)           ; {ram.coinsPerCreditA} reread the count
3AF0: 3D              DEC     A
3AF1: 20 08           JR      NZ,$3AFB            ; count exactly one?
3AF3: DD 21 8E 91     LD      IX,$918E            ; {hard.videoRam} write into video RAM (tilemap)
...
3B02: DD 21 92 92     LD      IX,$9292            ; {hard.videoRam} write into video RAM (tilemap)
3B06: DD 36 00 02     LD      (IX+$00),$02        ; stamp the second marker cell
3B0A: 3E 12           LD      A,$12
3B0C: 32 58 80        LD      ($8058),A           ; {ram.tileCol} target column 18
3B0F: 3E 0C           LD      A,$0C
3B11: 32 59 80        LD      ($8059),A           ; {ram.tileRow} target row 12
...
3B1A: 3E 07           LD      A,$07
3B1C: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} run of 7 marker glyphs
...
3B2D: DD 21 94 92     LD      IX,$9294            ; {hard.videoRam} write into video RAM (tilemap)
3B31: 3A 4D 80        LD      A,($804D)           ; {ram.coinsPerCreditB} read the coins-per-credit B setting
3B34: DD 77 00        LD      (IX+$00),A          ; show its digit tile
3B37: 3E 14           LD      A,$14
3B39: 32 58 80        LD      ($8058),A           ; {ram.tileCol} target column 20
3B3C: 3E 0C           LD      A,$0C
3B3E: 32 59 80        LD      ($8059),A           ; {ram.tileRow} target row 12
...
3B47: 3A 4D 80        LD      A,($804D)           ; {ram.coinsPerCreditB} reread the coins-per-credit B count
3B4A: A7              AND     A
3B4B: 28 08           JR      Z,$3B55             ; zero count uses the singular label
...
loc_3b5b:
3B5B: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} set the label run length
...
3B68: 3E 1E           LD      A,$1E
3B6A: 32 0A 80        LD      ($800A),A           ; {ram.loopCounter} hold the setup screen for 30 passes
...
3B77: 3A 0A 80        LD      A,($800A)           ; {ram.loopCounter} read the hold count
3B7A: 3D              DEC     A
3B7B: 32 0A 80        LD      ($800A),A           ; {ram.loopCounter} count the hold down
3B7E: 20 ED           JR      NZ,$3B6D            ; keep going until the hold expires
...
3B89: 11 00 90        LD      DE,$9000            ; {hard.videoRam} aim at the tilemap
...
3B9D: 13              INC     DE
3B9E: 10 FC           DJNZ    $3B9C               ; loop across the row
3BA0: 0D              DEC     C
3BA1: 20 F9           JR      NZ,$3B9C            ; repeat until the whole screen is tinted
...
3BAD: 11 00 90        LD      DE,$9000            ; {hard.videoRam} aim at the tilemap
...
3BC1: 13              INC     DE
3BC2: 10 FC           DJNZ    $3BC0               ; loop across the row
3BC4: 0D              DEC     C
3BC5: 20 F9           JR      NZ,$3BC0            ; repeat until the whole screen is tinted
3BC7: 0E 07           LD      C,$07
3BC9: 3E 12           LD      A,$12
...
3BEA: 18 F3           JR      $3BDF               ; loop forever holding this screen
...
3BEE: 32 0A 80        LD      ($800A),A           ; {ram.loopCounter} seed the tier counter
3BF1: 3A 81 80        LD      A,($8081)           ; {ram.crystalCount} read crystals collected this board
3BF4: FE 04           CP      $04                 ; every crystal grabbed?
3BF6: 20 08           JR      NZ,$3C00            ; if not, skip the crystal bonus tier
3BF8: 3A 0A 80        LD      A,($800A)           ; {ram.loopCounter}
3BFB: C6 05           ADD     A,$05               ; add a tier for a full crystal set
3BFD: 32 0A 80        LD      ($800A),A           ; {ram.loopCounter} store the bumped tier

loc_3c00:
3C00: 3A 82 80        LD      A,($8082)           ; {ram.diamondCount} read diamonds collected this board
3C03: FE 03           CP      $03                 ; all three diamonds grabbed?
3C05: 20 08           JR      NZ,$3C0F            ; if not, skip the treasure bonus tier
3C07: 3A 0A 80        LD      A,($800A)           ; {ram.loopCounter}
3C0A: C6 05           ADD     A,$05               ; add a tier for the full treasure
3C0C: 32 0A 80        LD      ($800A),A           ; {ram.loopCounter} store the bumped tier

loc_3c0f:
3C0F: CD C1 3C        CALL    $3CC1               ; {code.drawSharedPanel} paint the shared panel skeleton
3C12: 3E 0F           LD      A,$0F
3C14: 32 58 80        LD      ($8058),A           ; {ram.tileCol} seat the first text row at column 15
3C17: 3E 0B           LD      A,$0B
3C19: 32 59 80        LD      ($8059),A           ; {ram.tileRow} row 11
...
3C22: 3E 0C           LD      A,$0C
3C24: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} 12 glyphs tall
3C27: 3A 0A 80        LD      A,($800A)           ; {ram.loopCounter} read the tier
3C2A: FE 0F           CP      $0F                 ; tier 15?
3C2C: 28 10           JR      Z,$3C3E             ; yes: use the full-treasure strip
3C2E: FE 0A           CP      $0A                 ; tier 10?
3C30: 28 06           JR      Z,$3C38             ; yes: use the all-crystals strip
...
3C45: 3E 11           LD      A,$11
3C47: 32 58 80        LD      ($8058),A           ; {ram.tileCol} seat the second text row at column 17
3C4A: 3E 0B           LD      A,$0B
3C4C: 32 59 80        LD      ($8059),A           ; {ram.tileRow} row 11
...
3C55: 3E 0C           LD      A,$0C
3C57: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} 12 glyphs tall
3C5A: 3A 0A 80        LD      A,($800A)           ; {ram.loopCounter} read the tier
3C5D: FE 0F           CP      $0F                 ; tier 15?
3C5F: CA 73 3C        JP      Z,$3C73
3C62: FE 0A           CP      $0A                 ; tier 10?
3C64: CA 6D 3C        JP      Z,$3C6D
...
3C81: 3E 15           LD      A,$15
3C83: 32 58 80        LD      ($8058),A           ; {ram.tileCol} seat the third text row at column 21
3C86: 3E 09           LD      A,$09
3C88: 32 59 80        LD      ($8059),A           ; {ram.tileRow} row 9
...
3C91: 3E 0F           LD      A,$0F
3C93: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} 15 glyphs tall
...
3CB7: 3A 0A 80        LD      A,($800A)           ; {ram.loopCounter} read the tier count
3CBA: 3D              DEC     A                   ; one pass done
3CBB: 32 0A 80        LD      ($800A),A           ; {ram.loopCounter} store the counter
3CBE: 20 E4           JR      NZ,$3CA4            ; loop until the whole bonus is tallied
3CC0: C9              RET
...
3CC7: 3E 07           LD      A,$07
3CC9: 32 58 80        LD      ($8058),A           ; {ram.tileCol} seat the first label run at column 7
3CCC: 3E 09           LD      A,$09
3CCE: 32 59 80        LD      ($8059),A           ; {ram.tileRow} row 9
...
3CD7: 3E A5           LD      A,$A5
3CD9: 32 57 80        LD      ($8057),A           ; {ram.boardMode} color attribute for this run
3CDC: 3E 0F           LD      A,$0F
3CDE: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} 15 glyphs tall
...
3CEB: 3E 09           LD      A,$09
3CED: 32 58 80        LD      ($8058),A           ; {ram.tileCol} seat the second run at column 9
3CF0: 3E 0D           LD      A,$0D
3CF2: 32 59 80        LD      ($8059),A           ; {ram.tileRow} row 13
...
3CFB: 3E A5           LD      A,$A5
3CFD: 32 57 80        LD      ($8057),A           ; {ram.boardMode} color attribute for this run
3D00: 3E 01           LD      A,$01
3D02: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} one glyph
3D05: DD 21 02 80     LD      IX,$8002            ; {ram.activePlayer} the live player-number glyph
3D09: CD EA 3D        CALL    $3DEA               ; {code.copyTileColumn} stamp the player-number indicator
3D0C: 3E 07           LD      A,$07
3D0E: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} seven more cells
...
3D18: 3E 08           LD      A,$08
3D1A: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} eight cells
3D1D: CD 01 3E        CALL    $3E01               ; {code.fillColourColumn} tint the eight cells
3D20: 3E 0D           LD      A,$0D
3D22: 32 58 80        LD      ($8058),A           ; {ram.tileCol} seat the third run at column 13
3D25: 3E 09           LD      A,$09
3D27: 32 59 80        LD      ($8059),A           ; {ram.tileRow} row 9
...
3D30: 3E 0F           LD      A,$0F
3D32: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} 15 glyphs tall
...
3D49: 3E 01           LD      A,$01
3D4B: 32 58 80        LD      ($8058),A           ; {ram.tileCol} seat the panel at column 1
3D4E: 3E 0C           LD      A,$0C
3D50: 32 59 80        LD      ($8059),A           ; {ram.tileRow} row 12
...
3D59: 3E 06           LD      A,$06
3D5B: 32 57 80        LD      ($8057),A           ; {ram.boardMode} color attribute for the panel
3D5E: 3E 01           LD      A,$01
3D60: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} one glyph
3D63: DD 21 00 80     LD      IX,$8000            ; {ram.creditCount} the live credit-count glyph
3D67: CD EA 3D        CALL    $3DEA               ; {code.copyTileColumn} stamp the credit count
3D6A: 3E 08           LD      A,$08
3D6C: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} eight cells
...
3D76: 3E 09           LD      A,$09
3D78: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} nine cells
...
3D7E: 3A 57 80        LD      A,($8057)           ; {ram.boardMode} read the current color attribute
3D81: 3C              INC     A                   ; advance to the next shade
3D82: E6 F7           AND     $F7                 ; keep the palette bit clear
3D84: 32 57 80        LD      ($8057),A           ; {ram.boardMode} store the new color
3D87: C3 01 3E        JP      $3E01               ; {code.fillColourColumn} repaint the column in the new shade

; Draw the GAME OVER text.
drawGameOverText:
3D8A: 3E 06           LD      A,$06
3D8C: 32 58 80        LD      ($8058),A           ; {ram.tileCol} seat the text at column 6
3D8F: 3E 0C           LD      A,$0C
3D91: 32 59 80        LD      ($8059),A           ; {ram.tileRow} row 12
...
3D9A: 3E 06           LD      A,$06
3D9C: 32 57 80        LD      ($8057),A           ; {ram.boardMode} color attribute for the text
3D9F: 3E 09           LD      A,$09
3DA1: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} nine glyphs tall
...
rowColToTileOffset:
3DAE: 3A 59 80        LD      A,($8059)           ; {ram.tileRow} read the tile row
3DB1: 67              LD      H,A
3DB2: 3E 00           LD      A,$00
...
3DBC: 1F              RRA
3DBD: 6F              LD      L,A
3DBE: 3A 58 80        LD      A,($8058)           ; {ram.tileCol} read the tile column
3DC1: 4F              LD      C,A
3DC2: 06 00           LD      B,$00
3DC4: 09              ADD     HL,BC               ; offset = row times 32 plus column
3DC5: 22 5A 80        LD      ($805A),HL          ; {ram.tilemapOffset} store the tilemap offset
3DC8: C9              RET

; Derive the colour-RAM and video-RAM write cursors from a tilemap offset.
deriveTileWriteCursors:
3DC9: 2A 5A 80        LD      HL,($805A)          ; {ram.tilemapOffset} start from the tilemap offset
3DCC: 11 00 88        LD      DE,$8800
3DCF: 19              ADD     HL,DE               ; point into color RAM
3DD0: 22 5E 80        LD      ($805E),HL          ; {ram.colourRamCursor} store the color-RAM write cursor
3DD3: 11 00 08        LD      DE,$0800
3DD6: 19              ADD     HL,DE               ; point into video RAM
3DD7: 22 60 80        LD      ($8060),HL          ; store the video-RAM write cursor
3DDA: C9              RET

; Copy a capped run of tiles down a map column.
copyCappedTileColumn:
3DDB: 3A 55 80        LD      A,($8055)           ; {ram.plotRunLength} how many cells to write
3DDE: 47              LD      B,A
3DDF: 2A 60 80        LD      HL,($8060)          ; start at the video-RAM cursor
3DE2: 11 20 00        LD      DE,$0020            ; step one row down per cell
3DE5: 3A 0F 4B        LD      A,($4B0F)           ; load the fixed cap tile for the top cell
3DE8: 18 0D           JR      $3DF7               ; write the cap, then copy the rest of the run

; Copy a run of tiles down a map column.
copyTileColumn:
3DEA: 3A 55 80        LD      A,($8055)           ; {ram.plotRunLength} how many tiles to copy
3DED: 47              LD      B,A
3DEE: 2A 60 80        LD      HL,($8060)          ; start at the video-RAM cursor
...
3DFB: 10 F7           DJNZ    $3DF4               ; loop down the column
3DFD: 22 60 80        LD      ($8060),HL          ; save the advanced cursor
3E00: C9              RET

; Fill a colour-RAM column.
fillColourColumn:
3E01: 2A 5E 80        LD      HL,($805E)          ; {ram.colourRamCursor} start at the color-RAM cursor
3E04: 11 20 00        LD      DE,$0020            ; step one row down
3E07: 3A 55 80        LD      A,($8055)           ; {ram.plotRunLength} cell count
3E0A: 47              LD      B,A
3E0B: 3A 57 80        LD      A,($8057)           ; {ram.boardMode} the color attribute to paint

loc_3e0e:
3E0E: 77              LD      (HL),A              ; paint a color cell
3E0F: 19              ADD     HL,DE               ; move down one row
3E10: 10 FC           DJNZ    $3E0E               ; loop down the column
3E12: C9              RET

; Colour-cycle a column.
cycleColumnColour:
3E13: 5F              LD      E,A                 ; target column
3E14: 3A 57 80        LD      A,($8057)           ; {ram.boardMode} read the color attribute
3E17: 3C              INC     A                   ; advance to the next shade
3E18: E6 F7           AND     $F7                 ; keep the palette bit clear
3E1A: 4F              LD      C,A
3E1B: 18 01           JR      $3E1E               ; repaint the column in the new shade
...
3E24: 79              LD      A,C
3E25: 32 57 80        LD      ($8057),A           ; {ram.boardMode} remember the color attribute
...
3E2F: 10 FC           DJNZ    $3E2D               ; loop down the full column
3E31: C9              RET
...
4632: FD 21 28 80     LD      IY,$8028            ; {ram.level} point at the live game record
4636: DD 21 29 80     LD      IX,$8029            ; point at player 1's backup slot
463A: 3A 02 80        LD      A,($8002)           ; {ram.activePlayer} whose turn is it?
463D: 3D              DEC     A
463E: 28 14           JR      Z,$4654             ; player 1: use the first backup slot
4640: DD 23           INC     IX                  ; player 2: use the second backup slot
4642: 18 10           JR      $4654               ; copy the record into the backup

; Load the active player's saved record.
loadPlayerState:
4644: DD 21 28 80     LD      IX,$8028            ; {ram.level} point at the live game record
4648: FD 21 29 80     LD      IY,$8029            ; point at player 1's saved slot
464C: 3A 02 80        LD      A,($8002)           ; {ram.activePlayer} whose turn is it?
464F: 3D              DEC     A
4650: 28 02           JR      Z,$4654             ; player 1: use the first saved slot
...
addScore:
4689: 3A 01 80        LD      A,($8001)           ; {ram.gameState} read the game state
468C: 3D              DEC     A
468D: FE 02           CP      $02                 ; only score during play states 1 or 2
468F: 30 E1           JR      NC,$4672            ; if not in play, skip scoring
4691: 3A 31 80        LD      A,($8031)           ; {ram.scoreLo} read the low score pair
4694: 81              ADD     A,C                 ; add the low increment
4695: 27              DAA                         ; keep it decimal
4696: 32 31 80        LD      ($8031),A           ; {ram.scoreLo} store the low pair
4699: 3A 34 80        LD      A,($8034)           ; {ram.scoreHi} read the high score pair
469C: 88              ADC     A,B                 ; add the high increment with carry
469D: 27              DAA                         ; keep it decimal
469E: 32 34 80        LD      ($8034),A           ; {ram.scoreHi} store the high pair
...
drawScoreDigits:
46AF: 3A 02 80        LD      A,($8002)           ; {ram.activePlayer} which player's score?
46B2: 3D              DEC     A
46B3: 20 06           JR      NZ,$46BB            ; player 2 uses the other column
46B5: DD 21 01 93     LD      IX,$9301            ; {hard.videoRam} player 1's score column
46B9: 18 04           JR      $46BF

loc_46bb:
46BB: DD 21 C1 90     LD      IX,$90C1            ; {hard.videoRam} the other player's score column

loc_46bf:
46BF: 3A 31 80        LD      A,($8031)           ; {ram.scoreLo} read the low score pair
46C2: 4F              LD      C,A
...
46D4: 3A 34 80        LD      A,($8034)           ; {ram.scoreHi} read the high score pair
46D7: 4F              LD      C,A
46D8: 06 00           LD      B,$00
...
46DE: CB 3F           SRL     A
46E0: CB 3F           SRL     A
46E2: 20 03           JR      NZ,$46E7            ; leading digit present?
...
46ED: 20 01           JR      NZ,$46F0            ; shown leading digit means this zero is real
...
46F8: 21 E0 93        LD      HL,$93E0            ; {hard.videoRam} bottom of the leftmost tile column
...
4705: DD 23           INC     IX
4707: 10 F7           DJNZ    $4700               ; loop up the whole column
...
4714: 19              ADD     HL,DE
4715: 10 FC           DJNZ    $4713               ; loop up the segment
...
471D: 19              ADD     HL,DE
471E: 10 FC           DJNZ    $471C               ; loop up the segment
...
4728: 19              ADD     HL,DE
4729: 10 FC           DJNZ    $4727               ; loop up the segment
472B: C9              RET

; Redraw the score HUD.
redrawScoreHud:
472C: 3A 02 80        LD      A,($8002)           ; {ram.activePlayer} remember the active player
472F: 5F              LD      E,A
4730: 3E 01           LD      A,$01
...
4756: 7B              LD      A,E
4757: 32 02 80        LD      ($8002),A           ; {ram.activePlayer} restore the active player
475A: CD 44 46        CALL    $4644               ; {code.loadPlayerState} reload the live player's state
475D: 3A 01 80        LD      A,($8001)           ; {ram.gameState} read the game state
4760: 3D              DEC     A
4761: FE 02           CP      $02                 ; one or two players in play?
4763: 30 05           JR      NC,$476A            ; otherwise draw GAME OVER
...
4778: 19              ADD     HL,DE
4779: 10 FC           DJNZ    $4777               ; loop up the column
...
4795: 19              ADD     HL,DE
4796: DD 23           INC     IX
4798: 10 F7           DJNZ    $4791               ; loop up the whole column
479A: 0E 01           LD      C,$01
479C: 3E 1E           LD      A,$1E
...
47A5: 21 BF 93        LD      HL,$93BF            ; {hard.videoRam} bottom of the rightmost tile column
...
47B4: 10 F7           DJNZ    $47AD               ; loop up the whole column
47B6: 0E 02           LD      C,$02
47B8: 3E 1F           LD      A,$1F
...
drawPlayerLabel:
47E1: 3E 01           LD      A,$01
47E3: 32 58 80        LD      ($8058),A           ; {ram.tileCol} seat the label at column 1
47E6: 3E 0C           LD      A,$0C
47E8: 32 59 80        LD      ($8059),A           ; {ram.tileRow} row 12
...
47F1: 3E 07           LD      A,$07
47F3: 32 57 80        LD      ($8057),A           ; {ram.boardMode} color attribute for the label
47F6: 3E 01           LD      A,$01
47F8: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} one glyph
47FB: DD 21 02 80     LD      IX,$8002            ; {ram.activePlayer} the live player-number glyph
47FF: CD EA 3D        CALL    $3DEA               ; {code.copyTileColumn} stamp the player number
4802: 3E 07           LD      A,$07
4804: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} seven cells
...
480E: 3E 09           LD      A,$09
4810: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} nine cells
4813: C3 01 3E        JP      $3E01               ; {code.fillColourColumn} tint the label and return

; Paint a playfield strip.
paintPlayfieldStripCol1Row11:
4816: 3E 01           LD      A,$01
4818: 32 58 80        LD      ($8058),A           ; {ram.tileCol} seat the strip at column 1
481B: 3E 0B           LD      A,$0B
481D: 32 59 80        LD      ($8059),A           ; {ram.tileRow} row 11
...
4826: 3E 00           LD      A,$00
4828: 32 57 80        LD      ($8057),A           ; {ram.boardMode} color attribute for the strip
482B: 3E 0A           LD      A,$0A
482D: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} ten cells
...
drawMenLeftPanel:
483A: 3E 05           LD      A,$05
483C: 32 58 80        LD      ($8058),A           ; {ram.tileCol} aim the lives-remaining panel at column 5
483F: 3A 2B 80        LD      A,($802B)           ; {ram.menLeft} read the lives-remaining count
4842: 3D              DEC     A                   ; one life left?
4843: 28 30           JR      Z,$4875             ; if exactly one life, use the alternate label
4845: 3E 0B           LD      A,$0B
4847: 32 59 80        LD      ($8059),A           ; {ram.tileRow} place the label at row 11
...
4850: 3E 97           LD      A,$97
4852: 32 57 80        LD      ($8057),A           ; {ram.boardMode} set the panel colour attribute
4855: 3E 09           LD      A,$09
4857: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} nine glyphs in the label field
...
4861: 3E 01           LD      A,$01
4863: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} one more cell for the live value
4866: DD 21 2B 80     LD      IX,$802B            ; {ram.menLeft} point at the lives count byte
486A: CD EA 3D        CALL    $3DEA               ; {code.copyTileColumn} draw the live lives count below the label
486D: 3E 0A           LD      A,$0A
486F: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} the whole ten-cell run
4872: C3 01 3E        JP      $3E01               ; {code.fillColourColumn} colour the panel and return

loc_4875:
4875: 3E 0C           LD      A,$0C
4877: 32 59 80        LD      ($8059),A           ; {ram.tileRow} alternate: place the label at row 12
...
4880: 3E 96           LD      A,$96
4882: 32 57 80        LD      ($8057),A           ; {ram.boardMode} set the alternate panel colour
4885: 3E 08           LD      A,$08
4887: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} eight-glyph label, no value cell
...
drawCreditsDisplay:
4894: 3E 06           LD      A,$06
4896: 32 58 80        LD      ($8058),A           ; {ram.tileCol} aim the credits panel at column 6
4899: 3E 0A           LD      A,$0A
489B: 32 59 80        LD      ($8059),A           ; {ram.tileRow} place it at row 10
...
48A4: 3E 96           LD      A,$96
48A6: 32 57 80        LD      ($8057),A           ; {ram.boardMode} set the panel colour
48A9: 3E 01           LD      A,$01
48AB: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} one cell for the live credits value
48AE: DD 21 00 80     LD      IX,$8000            ; {ram.creditCount} point at the credit count byte
48B2: CD EA 3D        CALL    $3DEA               ; {code.copyTileColumn} draw the live credits count on top
48B5: 3E 08           LD      A,$08
48B7: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} eight cells for the CREDIT label
...
48C4: 3E 09           LD      A,$09
48C6: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} nine-cell column to recolour
48C9: 3A 57 80        LD      A,($8057)           ; {ram.boardMode} read the current panel colour
48CC: 3C              INC     A                   ; advance the colour one step
48CD: E6 F7           AND     $F7                 ; keep the blink bit clear
48CF: 32 57 80        LD      ($8057),A           ; {ram.boardMode} save the advanced colour
48D2: 3E 06           LD      A,$06
48D4: 32 58 80        LD      ($8058),A           ; {ram.tileCol} aim at column 6
48D7: 3E 0A           LD      A,$0A
48D9: 32 59 80        LD      ($8059),A           ; {ram.tileRow} row 10
...
drawGameOverLabel:
48E5: 3E 01           LD      A,$01
48E7: 32 58 80        LD      ($8058),A           ; {ram.tileCol} aim the GAME OVER label at column 1
48EA: 3E 0C           LD      A,$0C
48EC: 32 59 80        LD      ($8059),A           ; {ram.tileRow} place it at row 12
...
48F5: 3E 06           LD      A,$06
48F7: 32 57 80        LD      ($8057),A           ; {ram.boardMode} colour the label red
48FA: 3E 09           LD      A,$09
48FC: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} nine glyphs: GAME OVER
...
492E: 21 F9 93        LD      HL,$93F9            ; {hard.videoRam} bottom cell of the target column
...
493D: 10 F7           DJNZ    $4936               ; loop over all 32 cells
...
4B12: 18 02           JR      $4B16               ; join the latch write with the interrupt disabled
...
loc_4b16:
4B16: 32 00 B0        LD      ($B000),A           ; {hard.mainLatch} write the per-frame interrupt-enable latch
4B19: C9              RET

; Step the 16-bit LFSR pseudo-random generator and return a random byte.
advanceRandom:
4B1A: 3A 0D 80        LD      A,($800D)           ; {ram.prngLow} read the generator low byte
4B1D: 4F              LD      C,A
4B1E: 3A 0E 80        LD      A,($800E)           ; {ram.prngHigh} read the generator high byte
4B21: 47              LD      B,A
4B22: B1              OR      C                   ; test for an all-zero state
4B23: 20 02           JR      NZ,$4B27            ; skip reseed if the state is nonzero
...
4B31: 78              LD      A,B
4B32: 1F              RRA
4B33: 32 0E 80        LD      ($800E),A           ; {ram.prngHigh} store the new high byte
4B36: 79              LD      A,C
4B37: 1F              RRA
4B38: 32 0D 80        LD      ($800D),A           ; {ram.prngLow} store the new low byte (the random draw)
4B3B: C9              RET
...
; Board-display setup.
setupBoardDisplay:
4B46: 32 57 80        LD      ($8057),A           ; {ram.boardMode} record the board-mode / screen colour
...
4B5D: 20 05           JR      NZ,$4B64            ; branch if not free play
...
4B69: 28 05           JR      Z,$4B70
4B6B: 21 02 03        LD      HL,$0302            ; coin cost variant for bit 0
4B6E: 18 07           JR      $4B77

loc_4b70:
4B70: CB 48           BIT     1,B                 ; check coinage bit 1
4B72: 28 03           JR      Z,$4B77
4B74: 21 02 04        LD      HL,$0402            ; coin cost variant for bit 1

loc_4b77:
4B77: 22 4C 80        LD      ($804C),HL          ; {ram.coinsPerCreditA} store the two coin-line costs
4B7A: 3E 0C           LD      A,$0C
4B7C: CB 50           BIT     2,B                 ; check the main-loop pacing dip
4B7E: 20 02           JR      NZ,$4B82
4B80: D6 02           SUB     $02                 ; faster pacing base

loc_4b82:
4B82: 32 4E 80        LD      ($804E),A           ; {ram.loopDelayBase} store the main-loop pacing base
4B85: 3E 37           LD      A,$37
4B87: CB 58           BIT     3,B                 ; check the difficulty dip
4B89: 28 02           JR      Z,$4B8D
4B8B: D6 0A           SUB     $0A                 ; harder: faster step timer

loc_4b8d:
4B8D: 32 4F 80        LD      ($804F),A           ; {ram.stepTimerBase} store the difficulty step-timer base
4B90: 3E 00           LD      A,$00
4B92: CB 60           BIT     4,B                 ; check the flip-invert dip
4B94: 28 01           JR      Z,$4B97
4B96: 3C              INC     A                   ; flag base-orientation invert

loc_4b97:
4B97: 32 50 80        LD      ($8050),A           ; store the flip-invert flag
4B9A: 57              LD      D,A
4B9B: 3E 00           LD      A,$00
4B9D: CB 68           BIT     5,B                 ; check the cocktail dip
4B9F: 28 01           JR      Z,$4BA2
4BA1: 3C              INC     A                   ; flag flip follows the active player

loc_4ba2:
4BA2: 32 52 80        LD      ($8052),A           ; store the cocktail flag
4BA5: 4F              LD      C,A
4BA6: 3A 02 80        LD      A,($8002)           ; {ram.activePlayer} read the active player index
4BA9: 3D              DEC     A
...
4BB4: 32 51 80        LD      ($8051),A           ; {ram.spriteCoordBias} store the flip sprite bias
4BB7: 3E 03           LD      A,$03
4BB9: CB 70           BIT     6,B                 ; check the starting-lives dip
4BBB: 28 01           JR      Z,$4BBE
4BBD: 3C              INC     A                   ; four starting lives

loc_4bbe:
4BBE: 32 53 80        LD      ($8053),A           ; {ram.startingMen} store the starting-lives count
...
initScoreDisplay:
4BC7: 21 80 82        LD      HL,$8280            ; {ram.scoreReadoutStrip} point at the 32-cell readout strip
4BCA: 06 20           LD      B,$20               ; 32 cells to blank

loc_4bcc:
4BCC: 36 24           LD      (HL),$24            ; blank each readout cell
4BCE: 23              INC     HL
4BCF: 10 FB           DJNZ    $4BCC               ; loop over the strip
4BD1: 21 39 80        LD      HL,$8039            ; {ram.highScoreTable} point at the three readout records
...
4BE4: 23              INC     HL
4BE5: 10 EF           DJNZ    $4BD6               ; loop over the three records
...
4BEC: 21 31 80        LD      HL,$8031            ; {ram.scoreLo} point at the score bytes

loc_4bef:
4BEF: 36 00           LD      (HL),$00            ; zero each score byte
4BF1: 23              INC     HL
4BF2: 10 FB           DJNZ    $4BEF               ; loop over the score
4BF4: 06 0A           LD      B,$0A               ; ten sound-queue bytes
4BF6: 21 1E 80        LD      HL,$801E            ; {ram.soundHead} point at the sound queue

loc_4bf9:
4BF9: 36 00           LD      (HL),$00            ; zero each sound-queue byte
4BFB: 23              INC     HL
4BFC: 10 FB           DJNZ    $4BF9               ; loop over the queue
4BFE: C9              RET

; Busy-wait a number of vblank frames.
waitFrames:
4BFF: 32 09 80        LD      ($8009),A           ; {ram.frameWaitCountdown} arm the frame countdown
4C02: 3E 01           LD      A,$01
4C04: 32 00 B0        LD      ($B000),A           ; {hard.mainLatch} enable the per-frame interrupt

loc_4c07:
4C07: 3A 00 B8        LD      A,($B800)           ; {hard.watchdog} kick the watchdog
4C0A: 3A 09 80        LD      A,($8009)           ; {ram.frameWaitCountdown} read the ticking countdown
4C0D: A7              AND     A
4C0E: 20 F7           JR      NZ,$4C07            ; spin until the countdown hits zero
4C10: C9              RET

; Clear sprite and attribute RAM.
clearSpriteAndAttributeRam:
4C11: 06 80           LD      B,$80               ; 128 sprite/attribute bytes to clear
4C13: 21 00 98        LD      HL,$9800            ; {hard.attrRam} point at sprite/attribute RAM

loc_4c16:
4C16: 36 00           LD      (HL),$00            ; zero each sprite/scroll byte
4C18: 2C              INC     L
4C19: 10 FB           DJNZ    $4C16               ; loop over the block
4C1B: C9              RET
...
4C23: 2C              INC     L
4C24: 10 FB           DJNZ    $4C21               ; loop over the block
4C26: C9              RET

; Fill video RAM.
fillVideoRam:
4C27: 06 04           LD      B,$04               ; four 256-byte pages
4C29: 3A 0F 4B        LD      A,($4B0F)           ; load the background tile code
4C2C: 21 00 90        LD      HL,$9000            ; {hard.videoRam} point at the tilemap

loc_4c2f:
4C2F: 77              LD      (HL),A              ; write the tile into each cell
4C30: 2C              INC     L
4C31: 20 FC           JR      NZ,$4C2F            ; fill the page
4C33: 24              INC     H
4C34: 10 F9           DJNZ    $4C2F               ; advance across all four pages
4C36: C9              RET

; Fill colour RAM.
fillColorRam:
4C37: 06 04           LD      B,$04               ; four pages
4C39: 3A 57 80        LD      A,($8057)           ; {ram.boardMode} use the board-mode colour
4C3C: 21 00 88        LD      HL,$8800            ; point at colour RAM

loc_4c3f:
4C3F: 77              LD      (HL),A              ; flood each colour cell
4C40: 2C              INC     L
4C41: 20 FC           JR      NZ,$4C3F            ; fill the page
4C43: 24              INC     H
4C44: 10 F9           DJNZ    $4C3F               ; across all four pages
4C46: C9              RET
...
4CA8: E5              PUSH    HL
4CA9: 57              LD      D,A
4CAA: 3A 1E 80        LD      A,($801E)           ; {ram.soundHead} read the ring write index
4CAD: 5F              LD      E,A
4CAE: 3C              INC     A                   ; advance to the next of eight slots
4CAF: E6 07           AND     $07
4CB1: 32 1E 80        LD      ($801E),A           ; {ram.soundHead} store the wrapped write index
4CB4: 21 20 80        LD      HL,$8020            ; {ram.soundRing} point at the sound ring buffer
4CB7: 7A              LD      A,D
4CB8: 16 00           LD      D,$00
...
4CBF: 3E 00           LD      A,$00
4CC1: 32 48 80        LD      ($8048),A           ; {ram.variant} clear the landed-rank result
...
4CCD: 21 39 80        LD      HL,$8039            ; {ram.highScoreTable} first score record
4CD0: 01 03 00        LD      BC,$0003            ; three label tiles
4CD3: ED B0           LDIR                        ; copy the label into the readout
4CD5: 2A 3C 80        LD      HL,($803C)          ; read the record's score value
4CD8: 22 37 80        LD      ($8037),HL          ; {ram.scoreDisplayLow} stage it for the digit unpacker
...
4CEC: 2A 41 80        LD      HL,($8041)          ; read the second score value
4CEF: 22 37 80        LD      ($8037),HL          ; {ram.scoreDisplayLow} stage it
...
4D03: 2A 46 80        LD      HL,($8046)          ; read the third score value
4D06: 22 37 80        LD      ($8037),HL          ; {ram.scoreDisplayLow} stage it
4D09: 21 98 82        LD      HL,$8298            ; digit cells for the third readout

; Unpack a 16-bit score into digit tiles.
unpackScoreDigits:
4D0C: 3A 38 80        LD      A,($8038)           ; {ram.scoreDisplayHigh} read the score high byte
4D0F: 4F              LD      C,A
4D10: CB 3F           SRL     A                   ; extract the top digit
4D12: CB 3F           SRL     A
4D14: CB 3F           SRL     A
4D16: CB 3F           SRL     A
4D18: 28 02           JR      Z,$4D1C             ; blank a leading-zero top digit
...
4D20: 23              INC     HL
4D21: 3A 37 80        LD      A,($8037)           ; {ram.scoreDisplayLow} read the score low byte
4D24: 4F              LD      C,A
...
insertHighScore:
4D3A: 2A 46 80        LD      HL,($8046)          ; read the lowest table entry (rank 3)
4D3D: 3A 31 80        LD      A,($8031)           ; {ram.scoreLo} load the candidate score low byte
4D40: 5F              LD      E,A
4D41: 3A 34 80        LD      A,($8034)           ; {ram.scoreHi} load the candidate score high byte
4D44: 57              LD      D,A
4D45: BC              CP      H                   ; compare candidate high vs rank 3
4D46: D8              RET     C                   ; below rank 3: it does not place
4D47: 28 02           JR      Z,$4D4B             ; high bytes equal: break the tie
4D49: 30 04           JR      NC,$4D4F            ; beats rank 3
...
loc_4d4f:
4D4F: 2A 41 80        LD      HL,($8041)          ; read rank 2's score
4D52: 7A              LD      A,D
4D53: BC              CP      H                   ; compare candidate vs rank 2 high
4D54: 38 0A           JR      C,$4D60             ; does not beat rank 2: settle at rank 3
4D56: 28 02           JR      Z,$4D5A
4D58: 30 1F           JR      NC,$4D79            ; beats rank 2

loc_4d5a:
4D5A: 7B              LD      A,E
4D5B: BD              CP      L                   ; tie-break vs rank 2 low byte
4D5C: 28 02           JR      Z,$4D60             ; does not beat rank 2
4D5E: 30 19           JR      NC,$4D79            ; beats rank 2

loc_4d60:
4D60: ED 53 46 80     LD      ($8046),DE          ; write the score into rank 3
4D64: 3E 03           LD      A,$03
4D66: 32 48 80        LD      ($8048),A           ; {ram.variant} record it landed at rank 3
...
loc_4d79:
4D79: 22 46 80        LD      ($8046),HL          ; push the old rank 2 down to rank 3
...
4D96: 2A 3C 80        LD      HL,($803C)          ; read rank 1's score
4D99: 7A              LD      A,D
4D9A: BC              CP      H                   ; compare candidate vs rank 1 high
4D9B: 38 0A           JR      C,$4DA7             ; does not beat rank 1: settle at rank 2
4D9D: 28 02           JR      Z,$4DA1
4D9F: 30 20           JR      NC,$4DC1            ; beats rank 1

loc_4da1:
4DA1: 7B              LD      A,E
4DA2: BD              CP      L                   ; tie-break vs rank 1 low byte
4DA3: 28 02           JR      Z,$4DA7
4DA5: 30 1A           JR      NC,$4DC1            ; beats rank 1

loc_4da7:
4DA7: ED 53 41 80     LD      ($8041),DE          ; write the score into rank 2
4DAB: 3E 02           LD      A,$02
4DAD: 32 48 80        LD      ($8048),A           ; {ram.variant} record it landed at rank 2
...
loc_4dc1:
4DC1: 22 41 80        LD      ($8041),HL          ; push the old rank 1 down to rank 2
4DC4: FD 21 39 80     LD      IY,$8039            ; {ram.highScoreTable} rank 1 initials source
...
4DDE: ED 53 3C 80     LD      ($803C),DE          ; write the candidate into rank 1 (new best)
4DE2: 3E 01           LD      A,$01
4DE4: 32 48 80        LD      ($8048),A           ; {ram.variant} record it landed at rank 1
4DE7: DD 21 39 80     LD      IX,$8039            ; {ram.highScoreTable} point at rank 1's initials
...
4DF8: 3E 00           LD      A,$00
4DFA: 32 10 80        LD      ($8010),A           ; {ram.playPhaseCounter} reset the phase timer
...
4E19: 3E 0F           LD      A,$0F
4E1B: 32 58 80        LD      ($8058),A           ; {ram.tileCol} aim the rank label at column 15
4E1E: 3E 08           LD      A,$08
4E20: 32 59 80        LD      ($8059),A           ; {ram.tileRow} row 8
...
4E29: 3E 12           LD      A,$12
4E2B: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} 18-tile rank label
4E2E: 3A 48 80        LD      A,($8048)           ; {ram.variant} read which rank was earned
4E31: FE 03           CP      $03                 ; is it the top rank?
4E33: 28 10           JR      Z,$4E45             ; rank 1 label
4E35: FE 02           CP      $02                 ; is it the second rank?
4E37: 28 06           JR      Z,$4E3F             ; rank 2 label
...
4E53: 3E 16           LD      A,$16
4E55: 32 58 80        LD      ($8058),A           ; {ram.tileCol} aim the prompt strip at column 22
4E58: 3E 03           LD      A,$03
4E5A: 32 59 80        LD      ($8059),A           ; {ram.tileRow} row 3
...
4E63: 3E 1A           LD      A,$1A
4E65: 32 55 80        LD      ($8055),A           ; {ram.plotRunLength} 26-tile prompt strip
...
4E76: 3E 03           LD      A,$03
4E78: 32 4B 80        LD      ($804B),A           ; {ram.initialsRemaining} three initials still to enter
4E7B: 3A 48 80        LD      A,($8048)           ; {ram.variant} read the earned rank again
4E7E: FE 03           CP      $03                 ; is it the top rank?
4E80: 28 20           JR      Z,$4EA2             ; rank 1 display
4E82: FE 02           CP      $02                 ; is it the second rank?
4E84: 28 0E           JR      Z,$4E94             ; rank 2 display
4E86: 06 06           LD      B,$06               ; rank-3 initials colour
4E88: DD 21 39 80     LD      IX,$8039            ; {ram.highScoreTable} fill rank 3's record
4E8C: 21 9F 93        LD      HL,$939F            ; {hard.videoRam} blink cell for rank 3
...
4E9A: 21 7F 92        LD      HL,$927F            ; {hard.videoRam} blink cell for rank 2
...
4EA8: 21 5F 91        LD      HL,$915F            ; {hard.videoRam} blink cell for rank 1
4EAB: 11 5F 89        LD      DE,$895F            ; colour cell for rank 1

loc_4eae:
4EAE: 3E 00           LD      A,$00
4EB0: 32 10 80        LD      ($8010),A           ; {ram.playPhaseCounter} restart the idle timeout
...
4EC7: 3A 4B 80        LD      A,($804B)           ; {ram.initialsRemaining} how many initials remain
4ECA: B7              OR      A
4ECB: 20 15           JR      NZ,$4EE2            ; still entering: keep looping
4ECD: 3E D0           LD      A,$D0
...
4EDA: 3E 00           LD      A,$00
4EDC: 32 48 80        LD      ($8048),A           ; {ram.variant} clear the earned-rank selector
4EDF: C3 CA 4C        JP      $4CCA               ; {code.renderScoreReadouts} draw the final score readouts and return

loc_4ee2:
4EE2: 3A 10 80        LD      A,($8010)           ; {ram.playPhaseCounter} read the idle timer
4EE5: FE 3C           CP      $3C
4EE7: D0              RET     NC                  ; abandon entry after the idle timeout
4EE8: 18 CD           JR      $4EB7               ; otherwise blink the next letter

; Per-frame initials-entry handler: joystick steps the letter, fire commits.
stepHighScoreInitialsEntry:
4EEA: 3A 18 80        LD      A,($8018)           ; {ram.in0Debounced} read the debounced joystick/button input
...
4F11: 47              LD      B,A
4F12: 3A 4B 80        LD      A,($804B)           ; {ram.initialsRemaining} read initials letters still to enter
4F15: 3D              DEC     A                   ; count this committed letter off
4F16: 32 4B 80        LD      ($804B),A           ; {ram.initialsRemaining} store letters remaining
4F19: 3E 00           LD      A,$00
4F1B: 32 10 80        LD      ($8010),A           ; {ram.playPhaseCounter} restart the entry frame counter
...
4F2D: 20 02           JR      NZ,$4F31            ; engaged: keep the stepped letter
...
4F3C: 20 02           JR      NZ,$4F40            ; not rolled off the off-value, keep it
...
4F47: 3E 09           LD      A,$09
4F49: 32 01 80        LD      ($8001),A           ; {ram.gameState} mark the mode as the color-test screen
4F4C: CD 44 4B        CALL    $4B44               ; {code.blankScreen} blank the whole display
4F4F: 3A 18 80        LD      A,($8018)           ; {ram.in0Debounced} read the trigger inputs
4F52: CB 5F           BIT     3,A
...
loc_4f63:
4F63: 32 12 80        LD      ($8012),A           ; store this pass's color byte
4F66: 06 04           LD      B,$04               ; 4 blocks of 256 cells = 1024 cells total
4F68: 0E 00           LD      C,$00               ; rising tile-shape index
4F6A: 21 00 90        LD      HL,$9000            ; {hard.videoRam} tilemap base
...
4F75: 20 F9           JR      NZ,$4F70            ; finish this 256-cell block
4F77: 10 F7           DJNZ    $4F70               ; repeat across all 4 blocks
4F79: 3E 78           LD      A,$78
4F7B: CD FF 4B        CALL    $4BFF               ; {code.waitFrames} hold the pattern 120 frames
4F7E: 3A 12 80        LD      A,($8012)           ; reload the pass color
4F81: 3C              INC     A                   ; step to the next color
4F82: 20 DF           JR      NZ,$4F63            ; repeat until the color rolls past 255
