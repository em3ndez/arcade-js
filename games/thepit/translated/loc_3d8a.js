...
/**
 * loc_3d8a  (ROM 0x3d8a-0x3dad) — draws a 9-cell vertical strip: seeds the
 * col/row/count state bytes, derives the colour- and video-RAM column addresses
 * (via loc_3dae + loc_3dc9), copies a 9-byte tile run out of a descending ROM
 * table at 0x49a5 into the video column (loc_3dea), then TAIL-jumps into loc_3e01
 ...
 *
 * The tail `jp 0x3e01` pushes nothing, so loc_3e01's own `ret` returns to OUR
 ...
 * charge a second ret (same trap the loc_3d7e / loc_3b81 headers call out; both
...
export function loc_3d8a(m) {
  ...
  // 3dab  jp 0x3e01 -- tail-jump; loc_3e01's ret returns to OUR caller.
  m.step(0x3e01, 10);
