...
/**
 * loc_4b46  (ROM 0x4B46-0x4B54, The Pit) — the shared BODY of a three-door helper:
 ...
 * loc_4b3c (a=0xc0, `jr 0x4b46`), loc_4b40 (a=0x90, `jr 0x4b46`), loc_4b44
 * (a=0x00, falls through). A is therefore an input; 0x8057 is the same scratch
 * "attribute" cell loc_483a drives. (Role of the three callees best-effort; the
 ...
 * `m.step(0x4c1c,10); return m.call(0x4c1c)` — 0x4c1c's own `ret` pops loc_4b46's
 ...
 * onto the diffed stack and charge a phantom second ret (see loc_483a / loc_492a).
 */
export function loc_4b46(m) {
  const { regs, mem } = m;
