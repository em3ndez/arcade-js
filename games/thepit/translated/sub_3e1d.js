...
/**
 * sub_3e1d  (ROM 0x3E1D–0x3E31) — fills a colour-RAM column: writes the byte in C
 * down 0x1C (28) rows at stride 0x20, starting at 0x8840 + A (A selects the
 * column), and caches C at 0x8057.
 *
 *   3e1d  5f           ld   e,a           ; sub_3e1d entry: column offset A -> E
 *
 *   3e1e  16 00        ld   d,0x00        ; loc_3e1e (also reached from sub_3e13)
