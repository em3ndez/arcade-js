...
/**
 * loc_4673  (ROM 0x4673-0x467a) -- the "+1 point" score entry (The Pit).
 *
 ...
 *   loc_4673  call 0x4c83 (sfx 0x0D) · BC=0x0001  (+1)
 *   loc_467b  call 0x4c8f (sfx 0x10) · BC=0x0010  (+10, BCD)
 *   loc_4683  call 0x4c8f (sfx 0x10) · BC=0x0020  (+20, BCD)
 ...
 * routine loc_4689 -- nothing is pushed for it, so it is modelled
 * `m.step(0x4689,12); return m.call(0x4689)`. loc_4689 runs its own `ret`, which
