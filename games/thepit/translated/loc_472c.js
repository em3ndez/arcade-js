...
/**
 * loc_472c  (ROM 0x472C-0x4784, The Pit) -- redraws both players' HUD score
 ...
 * loc_46f4's sibling loops -- the flags at `ret` are the last `add hl,de`'s. One
 * unconditional `ret`, stack balanced.
 */
export function loc_472c(m) {
  const { regs, mem } = m;
