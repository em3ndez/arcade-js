...
//
// Drafter test for the translated loc_3dea (ROM 0x3dea-0x3e00), The Pit.
//
// Runs the routine on a lightweight machine built from the REAL thepit address
// space (boards/thepit/memory.js) + Io + the shared Z80 Regs. loc_3dea copies
...
test("loc_3dea: copies N bytes down a column (stride 0x20), IX descending; 304 T", () => {
  checkSpec(run(loc_3dea));
});
