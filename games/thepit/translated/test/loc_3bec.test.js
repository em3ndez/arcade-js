...
//
// Drafter test for the translated loc_3bec (ROM 0x3bec-0x3cc0), The Pit.
//
...
// registers, so the asserted T-state total and register values are loc_3bec's
...
test("loc_3bec: count=0x0f, selects 0x4a2e/0x4a55/0x4a07, loops 15x; 2671 T", () => {
  checkSpec(run(loc_3bec));
});
