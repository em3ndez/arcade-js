...
//
// Drafter test for the translated sub_46f4 (ROM 0x46F4-0x472B), The Pit.
//
...
// ROM (the copyrighted image is never committed). sub_46f4 makes no calls, so its
...
import { sub_46f4 } from "../sub_46f4.js";
...
test("sub_46f4: draws the left column + three colour fills, 2894 T", () => {
  checkSpec(run(sub_46f4));
});
...
test("sub_46f4: column is walked UP (stride -0x20), first tile at 0x9000", () => {
  const res = run(sub_46f4);
