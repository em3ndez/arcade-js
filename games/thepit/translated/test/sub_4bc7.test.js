...
/**
 * Drafter test for the translated sub_4bc7 (ROM 0x4BC7, The Pit).
 *
 ...
 *
 * Run: node --test games/thepit/translated/test/sub_4bc7.test.js
 */
import test from "node:test";
import assert from "node:assert/strict";

import { Regs, F_S, F_C } from "../../../../core/cpu/z80.js";
import { sub_4bc7 } from "../sub_4bc7.js";

// Minimal machine matching the surface sub_4bc7 uses: regs, mem, step, call, ret,
...
test("sub_4bc7: fills both tables, tail-jumps to 0x4cca, 1241 T", () => {
  const m = makeMachine();
  run(m);
  assertGolden(m);
});

test("sub_4bc7 touches no flags: F residue is the caller's", () => {
...
test("sub_4bc7 MUTATION: ld b,0x1F (fill 31 not 32) is caught", () => {
