...
//
// Drafter test for sub_13c9 (ROM 0x13c9-0x13db): the per-frame countdown gate
...
import { sub_13c9 } from "../sub_13c9.js";

// Minimal leaf-routine machine double: exactly the surface sub_13c9 touches
...
test("mutation: a corrupted tail-jump target is caught", () => {
  // Byte-identical to sub_13c9 except the mode-0 vector jumps to 0x0280 instead
