...
//
// Drafter test for the translated sub_47a1 (ROM 0x47A1-0x47E0), The Pit.
//
...
// sub_47a1's OWN cost/effect. The stub records {addr, a, c, ix} at entry, which
...
import { sub_47a1 } from "../sub_47a1.js";
...
function checkSpec(res) {
  ...
  // -- control flow: the single call to sub_3e1d, with its setup snapshot ----
...
test("sub_47a1: copies the column, calls 0x3e1d, paints 06/04/07 trim; 1965 T", () => {
  checkSpec(run(sub_47a1));
});
...
test("sub_47a1: column walked UP (stride -0x20)", () => {
  const res = run(sub_47a1);
