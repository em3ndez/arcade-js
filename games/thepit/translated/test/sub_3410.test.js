...
//
// Drafter test for sub_3410 (ROM 0x3410-0x3424): a 32-byte table search via
...
import { sub_3410 } from "../sub_3410.js";

// Leaf-routine machine double: exactly the surface sub_3410 touches (regs, mem,
...
test("mutation: wrong table base (0x34fe, the sibling's) is caught", () => {
  // Byte-identical to sub_3410 except `ld hl,0x35fe` -> `ld hl,0x34fe`. The row
