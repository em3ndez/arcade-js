...
//
// Drafter test for sub_3dae (ROM 0x3dae-0x3dc8): converts the row byte at 0x8059
...
import { sub_3dae } from "../sub_3dae.js";

// Leaf-routine machine double: exactly the surface sub_3dae touches (regs, mem,
...
test("mutation: srl h -> sra h (sign-extending shift) is caught", () => {
  // Byte-identical to sub_3dae except the three `srl h` become `sra h`, which
