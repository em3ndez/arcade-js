...
/**
 * Drafter test for the translated sub_4b40 (ROM 0x4b40, The Pit).
 *
 ...
 *
 * Run: node --test games/thepit/translated/test/sub_4b40.test.js
 */
import test from "node:test";
import assert from "node:assert/strict";

import { Regs } from "../../../../core/cpu/z80.js";
import { sub_4b40 } from "../sub_4b40.js";
...
test("sub_4b40: A=0x90 -> 0x8057, three calls, tail-jump to 0x4c1c, 93 T", () => {
  const m = makeMachine();
  run(m);
  assertGolden(m);
});
...
// The convention (entry_0066 header) warns the tail `jp 0x4c1c` is NOT
...
test("sub_4b40 MUTATION: tail-jump mis-modelled as call+ret is caught", () => {
  const m = makeMachine();
