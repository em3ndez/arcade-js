...
//
// Drafter test for sub_3425 (ROM 0x3425-0x3457). Asserts the T-state total and
...
import { sub_3425 } from "../sub_3425.js";
...
// the routine returned). sub_3425 makes no m.call. The cpir tables live in ROM,
...
test("sub_3425 full path: pointer saved, both cpir rows hit, ret at 0x3457", () => {
...
test("sub_3425 first-scan miss: ret nz taken, no 0x35fe scan, ix untouched", () => {
  const m = new MockMachine();
...
test("sub_3425 zero index: first scan hits, ret z taken, no 0x35fe scan", () => {
  const m = new MockMachine();
