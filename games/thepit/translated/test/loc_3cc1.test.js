...
//
// Drafter test for the translated loc_3cc1 (ROM 0x3cc1-0x3d48), The Pit.
//
// Runs the routine on a lightweight machine built from the REAL thepit address
// space (boards/thepit/memory.js) + Io + the shared Z80 Regs. loc_3cc1 is a
...
// asserted T-state total is loc_3cc1's OWN instruction cost (612 T).
//
...
test("loc_3cc1: stages helper cells, drives draws, tail-jumps 0x47a1; 612 T", () => {
...
// adds 4 T" slip. Injected at the machine seam so the REAL loc_3cc1 runs: the
