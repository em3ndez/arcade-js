...
//
// Drafter test for sub_23e8 (ROM 0x23E8-0x241B). Asserts the T-state total and
...
import { sub_23e8 } from "../sub_23e8.js";
...
test("sub_23e8 full path: pointer/countdown seeded, 0x4ca3 called, cells patched", () => {
...
test("sub_23e8 early return: call z skipped, ret nz taken leaves VRAM untouched", () => {
  const m = new MockMachine();
