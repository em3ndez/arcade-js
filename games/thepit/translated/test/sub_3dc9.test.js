...
//
// Drafter test for sub_3dc9 (ROM 0x3dc9-0x3dda): from the tile offset word at
...
import { sub_3dc9 } from "../sub_3dc9.js";

// Leaf-routine machine double: exactly the surface sub_3dc9 touches (regs, mem,
...
test("mutation: swapping the two store addresses is caught", () => {
  // Byte-identical to sub_3dc9 except the two `ld (nn),hl` targets are swapped —
