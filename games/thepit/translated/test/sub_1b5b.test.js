...
//
// Drafter test for sub_1b5b (ROM 0x1b5b-0x1b77): build the 4-byte record at
...
import { sub_1b5b } from "../sub_1b5b.js";
...
// Minimal leaf-routine machine double: exactly the surface sub_1b5b touches
...
function makeMachine() {
  ...
  const m = {
    ...
    call() {
      throw new Error("sub_1b5b makes no calls");
    },
  };
...
test("sub_1b5b builds the biased 4-byte record with exact values, cycles and control flow", () => {
  const m = makeMachine();
