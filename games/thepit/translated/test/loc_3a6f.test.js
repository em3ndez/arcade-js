...
//
// Drafter test for loc_3a6f (ROM 0x3A6F-0x3B80): the HUD / status-row builder.
...
test("loc_3a6f path A: jr-z-not-taken + 0x918e poke + jr-z-taken", () => {
...
test("loc_3a6f path B: jr-z-taken + poke skipped + jr-z-not-taken", () => {
  const m = new MockMachine();
  seed(m, 0x00, 0x05);
  loc_3a6f(m);
