...
/**
 * Drafter test for the translated loc_4673 (ROM 0x4673, The Pit) -- the "+1 point"
 * score entry.
 *
 ...
 * the routine in isolation without a ROM image. loc_4673 is straight-line (no
 ...
 *
 * Run: node --test games/thepit/translated/test/loc_4673.test.js
 */
...
// Minimal machine matching the surface loc_4673 uses: regs, mem, step, call, ret,
...
// target WITHOUT invoking a real routine (sub_4c83 / loc_4689 are separate units),
...
// exactly as it would after a real `call loc_4673`.
...
test("mutation: a corrupted BC increment (+0x10 instead of +1) is caught", () => {
  // Byte-identical to loc_4673 except `ld bc,0x0001` becomes `ld bc,0x0010` -- the
