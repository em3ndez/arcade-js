...
//
// Drafter test for loc_0000 (The Pit reset vector, ROM 0x0000):
//
...
//     the target's result propagates back as loc_0000's return value;
...
function checkContract(rec) {
  ...
  assert.equal(rec.cycles, 10, "loc_0000 must charge exactly 10 T-states (jp nn)");
...
test("loc_0000 matches the disassembly contract", () => {
  checkContract(recordRun(loc_0000));
});
