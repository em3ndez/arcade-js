...
/**
 * sub_4b55  (ROM 0x4b55–0x4bc6, The Pit) — reads the DSW byte at 0xb000 and
 ...
 * TAIL-jump: taken, loc_4f47's own `ret` unwinds to sub_4b55's caller, so it is
...
export function sub_4b55(m) {
  ...
  if (regs.fNZ) {
    ...
    return m.call(0x4f47); // loc_4f47's ret unwinds to sub_4b55's caller
  }
