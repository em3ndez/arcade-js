...
/**
 * sub_4b3c  (ROM 0x4b3c–0x4b3f, The Pit) — loads A=0xC0 and tail-jumps into the
 * shared control-latch setup at sub_4b46. It is the A=0xC0 door of a three-entry
 * fan-in: sub_4b40 loads A=0x90 and sub_4b44 loads A=0x00, and all three converge
 * on sub_4b46, which stashes A at 0x8057 and drives the LS259 latch setup
 ...
 *
 * Modelled as a tail-jump: sub_4b46's own `ret` (reached down its jp 0x4c1c chain)
 ...
 */
export function sub_4b3c(m) {
  const { regs } = m;

  regs.a = 0xc0; // ld a,0xc0 -- the datum sub_4b46 stashes at 0x8057
  m.step(0x4b3e, 7);
