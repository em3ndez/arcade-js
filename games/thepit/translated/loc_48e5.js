...
/**
 * loc_48e5  (ROM 0x48E5–0x4908, The Pit) — draws one text/attribute column: seats
 ...
 * double-pop the stack (same convention as the sibling loc_241c tail-jumps).
 */
export function loc_48e5(m) {
  const { regs, mem } = m;
