...
/**
 * sub_483a  (ROM 0x483A-0x4893, The Pit) — lays out one HUD/text panel, choosing
 ...
 * our caller) and charge a phantom 10 T. Same tail-jump convention as sub_3d49.
 */
export function sub_483a(m) {
  const { regs, mem } = m;
