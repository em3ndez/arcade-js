...
/**
 * loc_47e1  (ROM 0x47E1-0x4815, The Pit) — composes one HUD/status panel by
 * seeding the shared tile-plotter parameters at 0x8055-0x8059 and driving the
 * plot helpers. Sets column 0x8058=1 and row 0x8059=0x0c, then loc_3dae turns
 * the row into a tilemap offset (0x805a) and loc_3dc9 derives the colour-RAM
 ...
 * one cell down via loc_3dea; count 0x8055=7 with table ix=0x49b1 filled via
 * loc_3ddb; finally count 0x8055=9 and a TAIL-jump into loc_3e01, which paints a
 ...
 *   4813  c3 01 3e     jp   0x3e01          ; TAIL into loc_3e01 (paint colour col)
 *
 * One exit: the closing `jp 0x3e01` is an unconditional tail-jump. It pushes
 * nothing, so loc_3e01's own `ret` returns to whoever called loc_47e1 — hence
...
export function loc_47e1(m) {
  ...
  // 4813  jp 0x3e01 -- TAIL into loc_3e01; it pushes nothing, so loc_3e01's own
