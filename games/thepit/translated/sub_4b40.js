...
/**
 * sub_4b40  (ROM 0x4b40–0x4b55, The Pit) — the A=0x90 entry of a two-door helper
 * that stores a control byte to 0x8057 and then runs a fixed three-call setup
 * chain, TAIL-JUMPING into 0x4c1c to finish. The sibling entry sub_4b44 loads
 * A=0x00 and falls into the SAME store; sub_4b40 reaches it via an UNCONDITIONAL
 ...
 *
 *   4b44  3e 00        ld   a,0x00      ; sub_4b44 entry (NOT reached from 0x4b40)
 *
 *   4b46  32 57 80     ld   (0x8057),a  ; sub_4b46 shared tail -- store the byte
 ...
 * and its `ret` returns to whoever called sub_4b40. Modelled per the thepit
 * convention (entry_0066) as `m.step(target, T); return m.call(target)` with NO
...
export function sub_4b40(m) {
  ...
  // sub_4b46 (shared tail with sub_4b44): store A, then the setup chain.
