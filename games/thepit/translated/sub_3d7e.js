...
/**
 * sub_3d7e  (ROM 0x3d7e-0x3d89) — bumps the counter byte at 0x8057 by one while
 * MASKING BIT 3 OFF each bump (`and 0xf7`), then TAIL-jumps into sub_3e01, which
 ...
 *
 * `jp 0x3e01` is a TAIL-JUMP: an unconditional JP pushes nothing, so sub_3e01's
 ...
 * word off the stack and charge a second ret (see sub_3b81's header).
 */
export function sub_3d7e(m) {
  const { regs, mem } = m;
  ...
  // 3d87  jp 0x3e01 -- tail-jump; sub_3e01's ret returns to OUR caller.
  m.step(0x3e01, 10);
