...
/**
 * loc_6018 — the advance-and-loop latch of the six-slot overlap scan. It steps the record-index
...
export function loc_6018(m, index = m.regs.ix, geom = m.regs.hl, slots = m.regs.b) {
