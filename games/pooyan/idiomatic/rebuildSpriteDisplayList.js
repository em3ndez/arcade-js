...
/**
 * rebuildSpriteDisplayList — rebuild the sprite display list from the object-record banks each frame.
 *
...
export function rebuildSpriteDisplayList(m) {
  ...
  tickCounterAndMirrorIfFlipped(m, SPRITE_DISPLAY_LIST + ARROW_SPRITE_Y_B); // drop the second, then flip-mirror if armed
}
