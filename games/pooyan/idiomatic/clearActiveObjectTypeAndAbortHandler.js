...
/**
 * clearActiveObjectTypeAndAbortHandler — the shared "give up on this object" exit for the actor / collision handlers.
 *
 ...
 */
export function clearActiveObjectTypeAndAbortHandler(m) {
