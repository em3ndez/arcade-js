...
export function dispatchActiveEnemyActorState(m, rec = m.regs.ix) {
  ...
  switch (state) {
    case 0x00: return advanceEnemyState0AndArmFlapReset(m, rec);
    case 0x01: return dispatchActorState1MovementByMode(m, rec);
    ...
    case 0x07: return spawnFormationChildIntoFreeSlotOnTimer(m, rec);
    ...
    case 0x0e: return advanceObjectStateOnFrameTimerExpiry(m, rec);
