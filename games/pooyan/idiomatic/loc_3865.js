...
/**
 * loc_3865 — actor state handler (dispatch target) with an embedded tamper check.
 *
...
export function loc_3865(m, ix = m.regs.ix) {
  const { mem8 } = m;

  loc_4006(m, ix); // run the animation player for this record
