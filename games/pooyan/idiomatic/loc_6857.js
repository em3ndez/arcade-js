...
/**
 * loc_6857 — object ascent step. Runs the object animation sequencer, then subtracts (rec+9) from
 ...
 */
export function loc_6857(m, rec = m.regs.ix) {
  const { mem8 } = m;
  ...
  if (u8(mem8[de] + c) !== 0) return loc_08b3(m); // checksum mismatch -> re-enter
