...
/**
 * queueSirenSoundRun — draw the warning-siren tile run while the siren gate is clear.
 *
...
export function queueSirenSoundRun(m) {
  ...
  appendSoundCommandGated(m, tile); // append the tile; the chain leaves the advanced cursor in A
