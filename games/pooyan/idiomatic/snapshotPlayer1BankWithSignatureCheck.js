...
/**
 * snapshotPlayer1BankWithSignatureCheck — park the live actor page into player 1's saved bank, then run an anti-tamper
...
export function snapshotPlayer1BankWithSignatureCheck(m) {
  const { mem8 } = m;
