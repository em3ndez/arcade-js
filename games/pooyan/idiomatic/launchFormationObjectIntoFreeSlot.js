...
/**
 * launchFormationObjectIntoFreeSlot — the formation-slot launcher: try to bring ONE formation object to life.
 *
 * WHAT IT IS
...
export function launchFormationObjectIntoFreeSlot(m, rec = m.regs.ix) {
  const { mem8 } = m;
