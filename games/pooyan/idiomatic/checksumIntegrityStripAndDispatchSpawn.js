...
/**
 * checksumIntegrityStripAndDispatchSpawn — integrity-strip reset scan.
 *
...
export function checksumIntegrityStripAndDispatchSpawn(m) {
  ...
  if (mem8[TWO_PLAYER_FLAG] === 0) return paintReadySpriteFromStackAdjustEntry(m); // single player -> ready-sprite painter
  ...
  return runSpawnTickAndHunterSweep(m); // shared spawn epilogue
}
