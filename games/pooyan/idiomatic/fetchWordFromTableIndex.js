...
/**
 * fetchWordFromTableIndex — little-endian word lookup: fetch table[index] from a word table. [seen] ·
 * ROM 0x0c45–0x0c4d.
 *
 ...
 */
export function fetchWordFromTableIndex(m, index = m.regs.a, base = m.regs.hl) {
  const { mem8 } = m;
