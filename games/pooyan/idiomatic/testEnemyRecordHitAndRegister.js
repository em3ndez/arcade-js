...
/**
 * testEnemyRecordHitAndRegister — per-record proximity/collision test against the enemy-target pair, with hit
 * registration.
 *
 * WHAT IT IS
...
export function testEnemyRecordHitAndRegister(m, rec = m.regs.ix) {
  const { mem8 } = m;
