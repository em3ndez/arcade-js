...
/**
 * loc_0f97 — queue the round-derived display-command run. A second entry into the display
 * trampoline: it picks one of four command bytes from the round counter (bits 1..2 + base,
 * i.e. (v >> 1) & 3) and tail-delegates to the shared command-ring appender.
 *
