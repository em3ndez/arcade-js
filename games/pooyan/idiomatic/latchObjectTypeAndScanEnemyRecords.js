...
/**
 * latchObjectTypeAndScanEnemyRecords — arm and enter the enemy-record overlap scan for one interrupt-parity slot.
...
export function latchObjectTypeAndScanEnemyRecords(m, slot = m.regs.i, target = m.regs.iy) {
  const { mem8 } = m;
