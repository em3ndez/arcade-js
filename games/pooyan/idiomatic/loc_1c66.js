...
/**
 * loc_1c66 — round-clear / game-over / player-swap master of the play-state dispatch handler.
 *
...
export function loc_1c66(m) {
  ...
  if (mem8[TWO_PLAYER_FLAG] === 0) return loc_1d15(m);
  if (mem8[ACTIVE_PLAYER] === 0) return loc_1cf6(m);
  if (mem8[PLAYER0_LIVES] === 0) return loc_1d15(m);
