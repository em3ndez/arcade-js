...
/**
 * loc_118d — the enemy-spawn slot sweep: walk up to `count` actor records (from `rec`, stride 24)
...
export function loc_118d(m, count = m.regs.b, rec = m.regs.ix, activationIndex = m.regs.c) {
