...
/**
 * loc_60bc — tail of the hit handler: resolve a landed shot against the enemy pool and either
 * engage the struck target pair or seed a fresh actor record and re-scan.
 *
 * WHAT IT IS
 *   Control reaches here from the proximity gate (loc_6080) the moment a projectile is found to
