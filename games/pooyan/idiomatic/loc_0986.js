...
/**
 * loc_0986 — attract sub-state 3: a per-frame countdown gate.
 *
...
export function loc_0986(m) {
  ...
  loc_02b9(m); // zero the sprite display list + actor/object arena
  loc_02e3(m); // re-arm the row-by-row tile fill
