...
/**
 * tickEnemyAnimAndReseedPoolAtCycleEnd — animation-tick state 0: step one enemy record's animation cadence, and once its
 ...
 */
export function tickEnemyAnimAndReseedPoolAtCycleEnd(m, ix = m.regs.ix) {
  const { mem8 } = m;
