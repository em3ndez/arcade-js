...
/**
 * loc_7442 — attract/self-test state dispatcher. Tail-hands the low two bits of the self-test state to
...
export function loc_7442(m) {
  switch (m.mem8[SELFTEST_DISPATCH_STATE] & 0x03) {
    ...
    default:
      throw new Error("loc_7442: self-test state 3 has no handler (guard-slack)");
  }
}
