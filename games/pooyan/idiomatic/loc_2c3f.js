...
/**
 * loc_2c3f — per-hunter-record state dispatcher for the hunter attack wave.
 *
 * WHAT IT IS
 ...
 *   0x11 → loc_2c58              — climb the freshly-seeded hunter up its column at a fixed step; the
 ...
 *   0x13 → loc_2d24             — climb one vertical step and, at the top row, retire the record and
 *                                  caller-skip (false).
 *   0x14 → loc_2d4a            — collapse the inter-wave hold countdown so the next attack wave can
 ...
 *   return before it exits, unwinding a level so the walk does not resume). loc_2c3f is transparent to
