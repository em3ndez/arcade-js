...
/**
 * loc_6a7f — per-frame object driver with a one-shot tilemap integrity check.
 *
...
export function loc_6a7f(m) {
  ...
  if (sumLo !== SUM_LOW_OK) {
    throw new Error("loc_6a7f: tilemap integrity checksum low byte mismatch -- unreachable with a valid tilemap, indicates corrupted work RAM");
  }
  if (sumHi !== SUM_HIGH_OK) {
    throw new Error("loc_6a7f: tilemap integrity checksum high byte mismatch -- unreachable with a valid tilemap, indicates corrupted work RAM");
  }
}
