...
/**
 * loc_107d — a main-loop sub-state handler, gated on the stage countdown.
 *
...
export function loc_107d(m) {
  ...
  loc_0038(m, PHASE1_COMPLETE_DISPLAY_CMD); // enqueue the phase-1-complete display command
