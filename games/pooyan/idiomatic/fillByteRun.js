...
/**
 * fillByteRun — fill a run of bytes with a constant, advancing the pointer as it goes.
 ...
 */
export function fillByteRun(m, start = m.regs.hl, fill = m.regs.a, len = m.regs.b) {
  const { mem8 } = m;
