...
/**
 * Memory-equivalence test for loc_540d (ROM 0x540d) — the enemy-formation spawn driver.
 *
 ...
 * RAM (dumpState) minus STACK_SCRATCH. loc_540d is a void driver — no register survives — so the
...
test("EQUAL: gate open (odd) + gate closed (even) — loc_540d == oracle in RAM (−stack)", () => {
