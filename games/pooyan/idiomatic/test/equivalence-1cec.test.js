 ...
 * loc_1d0d ret into loc_1d15, which reads elsewhere), so the contract is memory only.
 *
 * The two real entry HL values are 0x84e0 (from loc_1ce7) and 0x8740 (from loc_1d0d); both are
