...
/**
 * Memory-equivalence test for loc_0e53 (ROM 0x0e53, Pooyan) — a PHANTOM NO-OP: the frozen routine
 ...
 *
 * Jobs:
 *   1. NO-OP EQUAL — over boot-state clones, oracle == loc_0e53 in RAM(−stack).
...
test("NO-OP EQUAL: oracle == loc_0e53 in RAM(−stack) across clones", () => {
  for (let i = 0; i < 4; i++) {
    const o = craft();
    const c = craft();
    oracle(o);
