...
/**
 * Memory-equivalence test for loc_0dab (ROM 0x0dab, Pooyan) — start-of-life setup for a new game.
 *
 ...
 * their own gates, so this gate proves loc_0dab's own writes and branch. The display-command ring is
...
test("EQUAL: 1P (early return) and 2P (full path) — loc_0dab == oracle in RAM (−stack)", () => {
