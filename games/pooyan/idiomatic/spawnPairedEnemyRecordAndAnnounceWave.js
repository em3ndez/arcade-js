...
/**
 * spawnPairedEnemyRecordAndAnnounceWave — per-record spawn/init for ONE enemy record pair. ROM 0x6931-0x69ac.
 * Grounding: [seen].
 *
 * WHAT IT IS
 ...
 * and WAVE_NUMBER.
 */
export function spawnPairedEnemyRecordAndAnnounceWave(m, ix = m.regs.ix, iy = m.regs.iy) {
  const { mem8 } = m;
