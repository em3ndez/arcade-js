...
/**
 * seedFreeEnemyRecordFromRoundTables — the per-record ENEMY-SPAWN INITIALISER. (ROM 0x119a-0x11f8. Grounding: [seen].)
 *
 * WHAT IT IS
 * ----------
...
export function seedFreeEnemyRecordFromRoundTables(m, rec = m.regs.ix, posSeed = m.regs.e) {
  const { mem8 } = m;
