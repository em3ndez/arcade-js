...
/**
 * stageFormationReadyMarkersOrSkipTick — the formation "ready-sprite" staging helper (boolean caller-skip).
 *
 * WHAT IT IS
...
export function stageFormationReadyMarkersOrSkipTick(m, a = m.regs.a) {
  const { mem8 } = m;
