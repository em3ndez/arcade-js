...
/**
 * climbHunterToLaunchRowThenPromoteGroup — hunter attacker, "climb to the launch row" state (record state 0x11).
 *
 * WHAT IT IS
...
export function climbHunterToLaunchRowThenPromoteGroup(m, rec = m.regs.ix) {
  const { mem8 } = m;
