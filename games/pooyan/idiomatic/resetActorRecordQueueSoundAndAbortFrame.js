...
/**
 * resetActorRecordQueueSoundAndAbortFrame — reset an actor record and queue the matching sound, then abort the frame.
 *
...
export function resetActorRecordQueueSoundAndAbortFrame(m, iy = m.regs.iy) {
  ...
  if (mem8[ACTIVE_OBJECT_TYPE] !== 0x03) queueSoundCommand05(m);
  else queueSoundCommand08(m);
