...
/**
 * loc_3278 — board tile-region tamper checksum, run at most once per arm.
 * ROM 0x3278. [seen]
 *
 * WHAT IT IS. An anti-tamper guard over the playfield's on-screen tile map. It is reached from the
 * per-slot hunter-return tick (loc_324d) when that path decides the board has settled, and it
 ...
 * loc_30f1 reads back, which is why they overlap a header here — a byte the CPU treats as an
