...
/**
 * drainPhaseCountdownAndReseedWave — enemy-actor animation tick, STATE 1: "wait out the phase, then reseed the wave".
 *
 * WHAT IT IS
 ...
 */
export function drainPhaseCountdownAndReseedWave(m, ix = m.regs.ix) {
  const { mem8 } = m;
