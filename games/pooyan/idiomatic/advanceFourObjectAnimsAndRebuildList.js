...
/**
 * advanceFourObjectAnimsAndRebuildList — advance four object records' animations, then rebuild the sprite display list.
 *
...
export function advanceFourObjectAnimsAndRebuildList(m) {
  ...
  for (let n = 0; n < RECORD_COUNT; n++) {
    advanceObjectAnimationFrame(m, rec); // advance this record's animation
