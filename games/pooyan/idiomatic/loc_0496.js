...
/**
 * loc_0496 — accrue the active player's score and keep the high score in step.
 *
...
export function loc_0496(m, index = m.regs.a) {
  const { mem8 } = m;
  ...
  loc_056b(m, active & 0x01 ? 0x01 : active >> 1);
