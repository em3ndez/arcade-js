...
/**
 * holdEnemyAnimGatedByDrawnFlag — animation-tick state 2 (the "drawn / steady" state).  ROM 0x76a6.  [seen]
 *
 * WHAT IT IS
 ...
 */
export function holdEnemyAnimGatedByDrawnFlag(m, ix = m.regs.ix) {
  const { mem8 } = m;
