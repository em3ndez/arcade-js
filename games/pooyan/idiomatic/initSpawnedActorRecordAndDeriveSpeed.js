...
/**
 * initSpawnedActorRecordAndDeriveSpeed — bring a fresh actor to life: seed its opening record fields, give it a look, and derive
 * its starting speed.
 *
...
export function initSpawnedActorRecordAndDeriveSpeed(m, rec = m.regs.ix, spawnField = m.regs.b) {
  const { mem8 } = m;
