...
/**
 * loc_0714 — the scroll-column rebuild loop: fan four source bytes per pass into the sprite
 * attribute area and the position cursor. [seen] · ROM 0x0714–0x0727.
 *
 * Each per-frame heartbeat (the vblank NMI service loc_066d, ROM 0x066d) rebuilds the sprite
