...
/**
 * loc_7638 — per-record animation-tick dispatcher for the enemy-actor pool.  ROM 0x7638-0x7643.
 *
 * WHAT IT IS
 ...
 *     - state 0 (loc_7644) advances a record's animation cadence and, when the cycle completes,
 *       kicks the whole run of records over into state 1;
 *     - state 1 (loc_7675) paces out the shared phase countdown (0x892e) and, at zero, reseeds
 *       the pool into its hold state and hands off to the next stretch of the sequence;
 *     - state 2 (loc_76a6) is the settled/hold state: it gates on the pool-wide drawn flag
 ...
 *   (loc_7644 / loc_7675 / loc_76a6) carry the [seen] tag; every tick reaches its handler
 *   through this node.
 *
