...
// Equivalence test for loc_28c5. Run: node --test .../loc_28c5.test.js
...
test("loc_28c5: bare ret; 10 T", () => {
  const m = mk(); loc_28c5(m); assert.equal(m.tstates, 10); assert.equal(m.pc, CR); assert.equal(m.regs.sp, 0x8780);
});