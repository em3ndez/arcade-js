...
export default {
  ...
  inputs: {
    ...
    trackball: { xPort: 1, invertX: true }, // the SPINNER (a 1-axis rotary): analog on IN1/pokey1, driven via io.applyTrackball; invertX maps mouse-right to the rim direction a player expects
