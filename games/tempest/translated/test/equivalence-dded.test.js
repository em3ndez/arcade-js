...
// Equivalence test for loc_dded (ROM 0xdded-0xddf0) -- lda #$03; bne $ddf3 (always taken, A!=0).
// Run: node --test games/tempest/translated/test/equivalence-dded.test.js
...
test("loc_dded: A=$03, bne taken -> tail-call $ddf3 (loc_ddf1 Y=$ff entry)", () => {
  const m = makeMachine();
