...
export function loc_dbf7(m) {
  ...
  loc_dd0d(m);
  loc_dd2b(m, mem8[INPUT_DEBOUNCED], 0xd0, 0xf0); // (m, y=INPUT_DEBOUNCED, a=0xd0, x=0xf0)
  ...
  return loc_df73(m, 0xc0, aFin, xFin); // (m, y=0xc0, a=colour_hi[SPINNER_ACCUM], x=colour_lo[SPINNER_ACCUM])
}
