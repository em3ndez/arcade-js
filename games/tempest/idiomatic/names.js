...
export const ROUTINES = {
  ...
  0xaf71: { name: "emitCappedCount", role: "[code] clamp the incoming byte to a max of 0x63 (99), then pack-and-emit it via loc_af77.", cert: "code" },
  ...
  0xdf6a: { name: "emitBlankVectorWordTag70", role: "[code] Emits a 0x70-tagged vector word with a zero data byte through the draw cursor loc_74.", cert: "code" },
