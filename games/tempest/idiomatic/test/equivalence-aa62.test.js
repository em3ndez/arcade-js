...
// Run: node --test games/tempest/idiomatic/test/equivalence-aa62.test.js
...
test("TEETH: a twin that omits the ab17/aa92 prep and only runs the driver MUST diverge", () => {
