...
// Memory-equivalence for loc_ccf6 (ROM 0xccf6-0xccf9) -- seeds the fixed sound id 0x9f then BNE-delegates
...
test("CAPTURE: real 0xccf6 dispatches -- loc_ccf6 == oracle in RAM (-stack)", () => {
...
test("SP-TOOTH: the omitted-ret leaf (moved 0) is seam-placeable", () => {
  ...
  const r = seamPlaceable(withOmittedRet, loc_ccf6, TARGET, m);
  assert.equal(r.placeable, true, `loc_ccf6 must be seam-placeable; got: ${r.error}`);
