...
// Run: node --test games/tempest/idiomatic/test/equivalence-aa6f.test.js
...
test("CRAFTED: idle and active prep states == oracle (RAM)", () => {
  const cases = [
    { tag: "idle: $00==4, $05 clear", c00: 0x04, c05: 0x00 },
...
test("TEETH: a twin that omits the a8b4 prep and only primes the slot MUST diverge", () => {
