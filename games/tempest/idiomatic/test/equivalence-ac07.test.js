...
// Memory-equivalence for loc_ac07 (ROM 0xac07) -- a bare RTS leaf / dispatch stub. No RAM write, no
...
test("CAPTURE: real 0xac07 dispatches -- loc_ac07 == oracle in RAM (-stack)", () => {
...
test("SP-TOOTH: the omitted-ret leaf (moved 0) is seam-placeable", () => {
  ...
  const r = seamPlaceable(withOmittedRet, loc_ac07, TARGET, m);
  assert.equal(r.placeable, true, `loc_ac07 must be seam-placeable; got: ${r.error}`);
