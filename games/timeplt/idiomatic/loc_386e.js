...
/** loc_386e — spawn a wave across a fixed bank of object slots. A count is read (the configured
 * wave size, or five when a mode cell is set); the bank is then walked that many times and every
...
export function loc_386e(m) {
  ...
  const count = mem8[MODE_CELL] === 0 ? configuredCount : DEFAULT_COUNT;
