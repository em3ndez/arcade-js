 ...
 *      nothing outside it may move, and a rewrite that clobbers fewer of them stays green. The
 *      set includes the index register the oracle loads and never reads, which the rewrite drops.
