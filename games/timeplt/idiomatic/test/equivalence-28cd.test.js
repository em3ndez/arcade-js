 ...
 *   recorded below rather than summed away.
 *
 ...
 *
 * Run: node --test games/timeplt/idiomatic/test/equivalence-28cd.test.js
 */
 ...
 */
const TWINS = [
  ["no-op", brokenNoOp, [276, 1899, 814], true],
  ["arm-not-run", brokenArmNotRun, [276, 1899, 814], true],
  ["pointers-not-set", brokenPointersNotSet, [276, 2207, 814], true],
  ["record-only", aimedAt(CRAFT_RECORD, undefined), [276, 1835, 814], true],
  ["entry-only", aimedAt(undefined, DISPLAY_ENTRY), [276, 2207, 814], true],
  ["record-one-slot-on", aimedAt(CRAFT_RECORD + RECORD_STRIDE, DISPLAY_ENTRY), [366, 2786, 1007], true],
  ["entry-one-on", aimedAt(CRAFT_RECORD, DISPLAY_ENTRY + ENTRY_STRIDE), [276, 1829, 810], true],
  ["guarded", brokenGuarded, [0, 330, 0], false],
  ["first-arm-always", brokenFirstArmAlways, [0, 1378, 164], false],
  ["neighbour-28b7", aimedAt(0xa850, 0xaa1a), [276, 2206, 814], true],
  ["neighbour-28c2", aimedAt(0xa860, 0xaa1c), [276, 2207, 814], true],
  ["neighbour-28d8", aimedAt(0xa880, 0xaa20), [366, 2786, 1007], true],
];
