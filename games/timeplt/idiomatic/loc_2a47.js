...
/** loc_2a47 — show an object pointing the way it is heading, in this family's own shape bank and
...
export function loc_2a47(m, object = m.regs.ix, sprite = m.regs.iy) {
  const { mem8, regs } = m;
