...
/** loc_596e — turn an object's heading into the pair of numbers that will move it. The heading
...
export function loc_596e(m, table = m.regs.hl, heading = m.mem8[m.regs.ix + HEADING_OFFSET]) {
  const { regs } = m;
