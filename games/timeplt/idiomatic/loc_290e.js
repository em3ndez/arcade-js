...
/** loc_290e — run the arm the low three bits of the era index select out of a word table laid down inline just behind
...
export function loc_290e(m) {
  const arm = m.mem16[ARM_TABLE + ENTRY_WIDTH * (m.mem8[ERA_INDEX] & ARM_MASK)];
  return m.call(arm);
}
