...
export const ROUTINES = {
  0x1199: { name: "loc_1199", role: "the round engine's per-frame service list: run each subsystem service in fixed order, then read the player-state byte at 0xa800 and advance the round when it is 0xff, hand a life over when it is 0, else return", cert: "code" },
