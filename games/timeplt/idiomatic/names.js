...
export const ROUTINES = {
  0x43b7: { name: "loc_43b7", role: "once-in-eight-frames gate for the era's special object: while the wave-hold flag is clear, defer to the deep-state stepper if a special is already live, else -- only when both records of its two-slot bank read empty -- mark the special active, arm the lead record's fire byte and retire the matching entry pair into cooldown to spawn it", cert: "code" },
