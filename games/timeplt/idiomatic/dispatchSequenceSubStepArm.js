...
import { SEQUENCE_SUBSTEP, advanceAttractTowardGameStart_ADDR, PHASE3_SUBSTEP_DISPATCH_TABLE } from "./names.js";
import { advanceAttractTowardGameStart } from "./advanceAttractTowardGameStart.js";

const ARM_MASK = 0x0f;

export function dispatchSequenceSubStepArm(m) {
  const arm = m.mem16[PHASE3_SUBSTEP_DISPATCH_TABLE + 2 * (m.mem8[SEQUENCE_SUBSTEP] & ARM_MASK)];
