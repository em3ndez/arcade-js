...
/** loc_1f55 — point the world the opposite way to the ship. Two velocity components arrive, each is
...
export function loc_1f55(m, alongY = m.regs.de, alongX = m.regs.bc) {
  const { mem16 } = m;
